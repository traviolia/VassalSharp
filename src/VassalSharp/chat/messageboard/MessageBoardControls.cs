...
namespace VassalSharp.chat.messageboard
{
	...
	/// <summary> UI controls for posting and retrieving messages from a
	/// message board.
	/// </summary>
	public class MessageBoardControls
	{
		...
		private SupportClass.ActionSupport checkMessagesAction;
		private SupportClass.ActionSupport postMessageAction;
		private MessageViewer viewer;
		private System.Windows.Forms.Form msgFrame;
		private System.Windows.Forms.Form msgComposer;
		...
		public virtual void  setServer(MessageBoard msgSvr, System.String name)
		{
			server = msgSvr;
			serverName = name;
		...
		public virtual void  showMessages(Message[] m)
		{
			...
			viewer.setMessages(new System.Collections.ArrayList((System.Collections.IList) System.Collections.ArrayList.ReadOnly(new System.Collections.ArrayList((new System.Collections.ArrayList(m))))).GetEnumerator());
		}
		...
		private void  initComponents()
		{
			...
			msgFrame = SupportClass.FormSupport.CreateForm(Resources.getString("Chat.message_board")); //$NON-NLS-1$
			msgFrame.Closing += new System.ComponentModel.CancelEventHandler(this.MessageBoardControls_Closing_HIDE_ON_CLOSE);
			...
			msgFrame.setLayout(new BoxLayout(((System.Windows.Forms.ContainerControl) msgFrame), BoxLayout.Y_AXIS));
			msgFrame.Menu = MenuManager.Instance.getMenuBarFor(msgFrame);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			msgFrame.Controls.Add(viewer);
			...
			System.Windows.Forms.Button refresh = SupportClass.ButtonSupport.CreateStandardButton(Resources.getString("Chat.refresh")); //$NON-NLS-1$
		}
		private void  MessageBoardControls_Closing_HIDE_ON_CLOSE(System.Object sender, System.ComponentModel.CancelEventArgs  e)
		{
			e.Cancel = true;
	...
	Resources.getString(Chat.check_messages))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ //$NON-NLS-1$
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	Resources.getString(Chat.post_message))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ //$NON-NLS-1$
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	private static final long serialVersionUID = 1L;
	...
	[Serializable]
	private class Comp:System.Windows.Forms.Form
	{
		private const long serialVersionUID = 1L;
		
		private Comp():base()
		{
			this.Text = Resources.getString("Chat.message_composer"); //$NON-NLS-1$
			//UPGRADE_ISSUE: Method 'javax.swing.JFrame.setLayout' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingJFramesetLayout_javaawtLayoutManager'"
			//UPGRADE_ISSUE: Constructor 'javax.swing.BoxLayout.BoxLayout' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBoxLayout'"
			//UPGRADE_TODO: Method 'javax.swing.JFrame.getContentPane' was converted to 'System.Windows.Forms.Form' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaxswingJFramegetContentPane'"
			//UPGRADE_ISSUE: Field 'javax.swing.BoxLayout.Y_AXIS' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBoxLayout'"
			setLayout(new BoxLayout(((System.Windows.Forms.ContainerControl) this), BoxLayout.Y_AXIS));
			Closing += new System.ComponentModel.CancelEventHandler(this.Comp_Closing_HIDE_ON_CLOSE);
			Menu = MenuManager.Instance.getMenuBarFor(this);
			
			//UPGRADE_NOTE: Final was removed from the declaration of 'msgArea '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			...
			System.Windows.Forms.TextBox msgArea = temp_TextBox;
			//UPGRADE_ISSUE: Class 'javax.swing.Box' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBox'"
			//UPGRADE_ISSUE: Method 'javax.swing.Box.createHorizontalBox' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBox'"
			...
			System.Windows.Forms.Button okButton = SupportClass.ButtonSupport.CreateStandardButton(Resources.getString("Chat.send")); //$NON-NLS-1$
		}
		private void  Comp_Closing_HIDE_ON_CLOSE(System.Object sender, System.ComponentModel.CancelEventArgs  e)
		{
			e.Cancel = true;
			SupportClass.CloseOperation((System.Windows.Forms.Form) sender, 1);
		}
