...
namespace VassalSharp.chat.ui
{
	...
	*/
	...
	/// <summary>Interface for user interactions with players in the current room </summary>
	public interface CurrentRoomActions
	{
		...
		System.Windows.Forms.ContextMenu buildPopupForPlayer(SimplePlayer p, System.Windows.Forms.TreeView tree);
	}
}