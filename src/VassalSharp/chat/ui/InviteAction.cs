...
namespace VassalSharp.chat.ui
{
	...
	/// <summary> When invoked, will Kick another player out of his current room back to the
	/// Main Room.
	/// </summary>
	[Serializable]
	public class InviteAction:SupportClass.ActionSupport
	{
		...
		public InviteAction(LockableChatServerConnection client, SimplePlayer target):base(Resources.getString("Chat.invite"))
		{ //$NON-NLS-1$
			this.invitee = target;
			this.client = client;
