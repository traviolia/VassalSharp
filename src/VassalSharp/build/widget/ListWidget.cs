...
namespace VassalSharp.build.widget
{
	...
	/// <summary> A Widget that corresponds to a panel with a {@link JList} sitting
	...
	public class ListWidget:Widget
	{
		...
		override public System.Windows.Forms.Control Component
		{
			get
			{
				if (panel == null)
				{
					...
					split = new SupportClass.SplitterPanelSupport();
					...
					temp_ListBox.Items.AddRange(widgets);
					...
					multiPanel = new System.Windows.Forms.Panel();
					...
					for(Buildable b: getBuildables())
					{
						...
						multiPanel.Controls.Add(w.Component);
					}
					...
					list.Items.AddRange(widgets);
					list.SelectedValueChanged += new System.EventHandler(this.valueChanged);
					...
					//UPGRADE_TODO: Method 'javax.swing.JList.setFixedCellWidth' was converted to 'System.Windows.Forms.ListBox.Width' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaxswingJListsetFixedCellWidth_int'"
					list.Width = 80;
					...
					split.FirstControl = multiPanel;
					split.SecondControl = new ScrollPane(list);
					...
					if (width > 0 && height > 0)
					{
						...
						split.Size = new System.Drawing.Size(width, height);
					}
					if (divider > 0)
					{
						split.SplitterLocation = divider;
					}
				}
				return split;
			}
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, WIDTH, HEIGHT, DIVIDER};
			}
		...
		private SupportClass.SplitterPanelSupport split;
		...
		private System.Windows.Forms.ListBox.ObjectCollection widgets = new System.Windows.Forms.ListBox.ObjectCollection(new System.Windows.Forms.ListBox());
		...
		private const System.String DIVIDER = "divider";
		...
		private System.String getKey(System.Object o)
		{
			System.String s = keys.get_Renamed(o);
			if (s == null)
			{
				s = System.Convert.ToString(count++);
				keys.put(o, s);
			}
			return s;
		}
		...
		{
			System.Object selected = list.SelectedItem;
			if (selected != null)
			{
