...
namespace VassalSharp.build.widget
{
	...
	/// <summary> A Widget that corresponds to a panel with a {@link JComboBox} above
	...
	public class BoxWidget:Widget
	{
		...
		override public System.Windows.Forms.Control Component
		{
			get
			{
				if (panel == null)
				{
					...
					box.SelectedValueChanged += new System.EventHandler(this.itemStateChanged);
					//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
					panel.Controls.Add(box);
					//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
					panel.Controls.Add(multiPanel);
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, WIDTH, HEIGHT};
			}
		...
		private System.Windows.Forms.ComboBox.ObjectCollection widgets = new DefaultComboBoxModel();
		...
		private System.Windows.Forms.Panel multiPanel = new System.Windows.Forms.Panel();
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		{
			if (VassalSharp.build.Configurable_Fields.NAME_PROPERTY.Equals(evt.PropertyName) && box != null)
			{
				box.Invalidate();
			}
		}
		...
		public virtual void  itemStateChanged(System.Object event_sender, System.EventArgs e)
		{
			...
			{
				Widget w = (Widget) box.SelectedItem;
				if (!built.contains(w))
				{
					//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javalangString_javaawtComponent'"
					multiPanel.Controls.Add(w.Component);
		...
		private bool allChildrenBuilt()
		{
			return box != null && box.Items.Count == built.size();
		}
