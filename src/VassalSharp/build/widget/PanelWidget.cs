...
namespace VassalSharp.build.widget
{
	...
	/// <summary> A Widget that corresponds to a JPanel with a
	...
	public class PanelWidget:Widget
	{
			...
			get
			{
				if (panel == null)
				{
					...
					for(Widget w: widgets)
					{
						...
						System.Windows.Forms.Control c = w.Component;
						if (c is System.Windows.Forms.Control)
						{
							...
							((System.Windows.Forms.Control) c).setAlignmentX(0.0F);
							...
							((System.Windows.Forms.Control) c).setAlignmentY(0.0F);
						}
		...
		/// <summary> The attributes of a PanelWidget are:
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, FIXED, COLS, VERTICAL};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name:  ", "Fixed cell size?", "Number of columns:  ", "Vertical layout?"};
			}
		...
		private bool fixed_Renamed = false;
		...
		private LayoutManager getLayout(System.Windows.Forms.Control c)
		{
			if (fixed_Renamed)
			{
				...
				return new System.Drawing.Rectangle(0, nColumns, 0, 0);
			}
			else
			{
		...
		public override void  remove(Buildable b)
		{
			if (b is Widget)
			{
				...
				if (panel != null)
				{
					panel.Controls.Remove(w.Component);
				}
				widgets.remove(w);
			}
			base.remove(b);
		...
		public const System.String FIXED = "fixed";
		public const System.String COLS = "nColumns";
		public const System.String VERTICAL = "vert";
