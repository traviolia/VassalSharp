...
namespace VassalSharp.build.module
{
	...
	public class PrivateMap:Map
	{
		...
		{
			return ArrayUtils.append_Renamed_Field;
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return ArrayUtils.append(new System.String[]{SIDE, VISIBLE, USE_BOARDS}, base.AttributeNames);
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.append(new System.String[]{"Belongs to side", "Visible to all players?", "Use same boards as this map:  "}, base.AttributeDescriptions);
			}
			
		}
		protected internal System.String[] owners = new System.String[0];
		protected internal bool visibleToAll;
		protected internal Map surrogate;
		
		public const System.String VISIBLE = "visible"; //$NON-NLS-1$
		public const System.String SIDE = "side"; //$NON-NLS-1$
		public const System.String USE_BOARDS = "useBoards"; //$NON-NLS-1$
	...
	/// <summary>Return true if the player playing the given side can access this map</summary>
	/// <seealso cref="PlayerRoster">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	{ 
		...
		ConfigureTree.getConfigureName(PlayerRoster.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class), 
	...
	public class View:Map.View
	{
		...
		//UPGRADE_NOTE: Synchronized keyword was removed from method 'setDropTarget'. Lock expression was added. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1027'"
		virtual public DropTarget DropTarget
		{
			set
			{
				lock (this)
		...
		public View(PrivateMap m):base(m)
		{
		}
		...
		//UPGRADE_NOTE: Synchronized keyword was removed from method 'addKeyListener'. Lock expression was added. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1027'"
		...
		//UPGRADE_NOTE: Synchronized keyword was removed from method 'addMouseListener'. Lock expression was added. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1027'"
		...
		//UPGRADE_TODO: Interface 'java.awt.event.MouseMotionListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
		//UPGRADE_NOTE: Synchronized keyword was removed from method 'addMouseMotionListener'. Lock expression was added. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1027'"
		...
		/// <summary> Disable all keyboard and mouse listeners on this component</summary>
		protected internal virtual void  disableListeners()
		{
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			...
			base.DropTarget = null;
			listenersActive = false;
		}
		
		/// <summary> Enable all keyboard and mouse listeners on this component</summary>
		protected internal virtual void  enableListeners()
		{
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			for(KeyListener l: keyListeners)
			{
