...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class TextBoxItemInstance:ItemInstance
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Value:  ", "Text Color:  ", "Background Color:  "};
			}
			
		}
		
		protected internal const System.String VALUE = "value"; //$NON-NLS-1$
		new protected internal const System.String BG_COLOR = "borderColor"; //$NON-NLS-1$
		
		protected internal System.String val = ""; //$NON-NLS-1$
		
		public TextBoxItemInstance():base()
		{
			InitBlock();
		...
		public TextBoxItemInstance(System.String code, GamePieceImage defn):base(defn)
		{
			InitBlock();
			decode(code);
		}
		
		public TextBoxItemInstance(System.String name, System.String type, System.String location):base(name, type, location)
		{
			InitBlock();
			setFgColor(ColorSwatch.getBlack());
			setBgColor(ColorManager.getColorManager().getColorSwatch(Color.LIGHT_GRAY));
	...
	public class WrappingTextConfigurer : ConfigurerFactory
	{
