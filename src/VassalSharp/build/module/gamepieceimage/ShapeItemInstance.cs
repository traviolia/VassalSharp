...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class ShapeItemInstance:ItemInstance
	{
		...
		virtual protected internal ColorSwatch BorderColor
		{
			get
			{
				return borderColor;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Foreground Color:  ", "Border Color:  "};
			}
		...
		public ShapeItemInstance():base()
		{
			InitBlock();
			setFgColor(ColorSwatch.getClear());
		}
		
		public ShapeItemInstance(System.String code, GamePieceImage defn):base(defn)
		{
			InitBlock();
			decode(code);
		}
		...
		public ShapeItemInstance(System.String name, System.String type, System.String location):base(name, type, location)
		{
			InitBlock();
			setFgColor(ColorSwatch.getClear());
		}
