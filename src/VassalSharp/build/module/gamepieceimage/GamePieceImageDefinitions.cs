...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	*/
	...
	/// <summary> Container for definitions of Generic Counter Definitions.
	/// Actual definition is in inner class {@link GamePieceLayout}
	/// </summary>
	public class GamePieceImageDefinitions:AbstractConfigurable
	{
		...
		public static GamePieceImageDefinitions Instance
		{
			get
			{
				return instance;
		...
		protected internal static GamePieceImageDefinitions instance;
		protected internal GamePieceLayoutsContainer definitions;
		protected internal ColorManager colors;
		protected internal FontManager fonts;
		...
		protected internal static readonly System.Drawing.Color DEFAULT_COLOR = Color.WHITE;
