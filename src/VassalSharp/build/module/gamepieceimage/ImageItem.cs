...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class ImageItem:Item
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.insert(base.AttributeDescriptions, 2, "Image:  ", "Image is:  ");
			}
			
		}
		
		new public const System.String TYPE = "Image"; //$NON-NLS-1$
		
		public const System.String SRC_VARIABLE = "Specified in individual images";
		public const System.String SRC_FIXED = "Fixed for this layout";
		
		protected internal const System.String IMAGE = "image"; //$NON-NLS-1$
		public const System.String SOURCE = "source"; //$NON-NLS-1$
		
		protected internal System.String imageSource = SRC_FIXED;
		protected internal System.String imageName = ""; //$NON-NLS-1$
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		Deprecated
		protected internal System.Drawing.Image image = null;
		protected internal ImageOp srcOp;
		protected internal System.Drawing.Rectangle imageBounds = new System.Drawing.Rectangle();
		...
		public ImageItem(GamePieceLayout l):base(l)
		{
			InitBlock();
		}
		
		public ImageItem(GamePieceLayout l, System.String n):this(l)
		{
			setConfigureName(n);
		}
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void loadImage(GamePieceImage defn)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	protected internal sealed class BaseOp:AbstractTileOpImpl
	{
		private void  InitBlock()
		{
		...
		private static readonly BaseOp op = new BaseOp();
		...
		public override System.Drawing.Bitmap eval()
		{
			...
			System.Drawing.Bitmap img = ImageUtils.createCompatibleTranslucentImage(10, 10);
			...
			System.Drawing.Graphics bg = System.Drawing.Graphics.FromImage(img);
			SupportClass.GraphicsManager.manager.SetColor(bg, System.Drawing.Color.Black);
			bg.DrawRectangle(SupportClass.GraphicsManager.manager.GetPen(bg), 0, 0, 9, 9);
			bg.DrawLine(SupportClass.GraphicsManager.manager.GetPen(bg), 0, 0, 9, 9);
			bg.DrawLine(SupportClass.GraphicsManager.manager.GetPen(bg), 0, 9, 9, 0);
			bg.Dispose();
			return img;
		}
