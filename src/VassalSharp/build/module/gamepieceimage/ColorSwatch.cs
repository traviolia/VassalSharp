...
/// <summary> Class tht implements a named Color Swatch</summary>
using System;
...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class ColorSwatch:AbstractConfigurable, System.IComparable
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Color Name:  ", "Color:  "};
			}
		...
		protected internal const System.String COLOR = "color"; //$NON-NLS-1$
		
		public const System.String BLACK = "BLACK"; //$NON-NLS-1$
		public const System.String WHITE = "WHITE"; //$NON-NLS-1$
		public const System.String CLEAR = "CLEAR"; //$NON-NLS-1$
		public const System.String RED = "RED"; //$NON-NLS-1$
		
		protected internal System.Drawing.Color color;
		
		public ColorSwatch():base()
		{
			InitBlock();
			name = ""; //$NON-NLS-1$
		...
		public ColorSwatch(System.String n, ref System.Drawing.Color c):this()
		{
			name = n;
			color = c;
		}
		
		public ColorSwatch(System.String code):this()
		{
			decode(code);
		}
