...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class ImageItemInstance:ItemInstance
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Image:  "};
			}
		...
		public ImageItemInstance():base()
		{
			InitBlock();
		}
		
		public ImageItemInstance(System.String code, GamePieceImage defn):base(defn)
		{
			InitBlock();
			decode(code);
		}
		...
		public ImageItemInstance(System.String name, System.String type, System.String location):base(name, type, location)
		{
			InitBlock();
		}
		
		public ImageItemInstance(System.String nam, System.String typ, System.String loc, System.String iName):base(nam, typ, loc)
		{
			InitBlock();
			imageName = iName;
		}
		...
		public override System.String encode()
		{
			...
			se.append(Type).append(Name).append(Location).append(imageName);
			return se.Value;
		}
