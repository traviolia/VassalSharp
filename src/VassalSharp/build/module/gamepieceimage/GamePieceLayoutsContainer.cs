...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	/// {@link VassalSharp.build.module.gamepieceimage.GamePieceLayout}.
	/// </summary>
	public class GamePieceLayoutsContainer:AbstractConfigurable
	{
		public GamePieceLayoutsContainer()
		{
			InitBlock();
		}
		...
		protected internal virtual GamePieceLayout getDefinition(System.String name)
		{
			return definitions.get_Renamed(name);
		}
