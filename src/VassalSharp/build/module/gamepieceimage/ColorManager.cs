...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	/// <summary> Container for definitions of Generic Color Definitions</summary>
	public class ColorManager:AbstractConfigurable
	{
		...
		/// <summary> Statics - Standard Colors</summary>
		protected internal static ColorManager instance;
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'DEFAULT_COLOR '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly System.Drawing.Color DEFAULT_COLOR = Color.WHITE;
		public const System.String SELECT_COLOR = "Select...";
		
		protected internal static System.Drawing.Color[] standardColors = new System.Drawing.Color[]{Color.WHITE, Color.GRAY, Color.BLACK, null, Color.RED, Color.GREEN, Color.BLUE, Color.ORANGE, Color.PINK, Color.CYAN, Color.MAGENTA, Color.YELLOW, Color.LIGHT_GRAY, Color.DARK_GRAY};
		
		protected internal static System.String[] standardColorNames = new System.String[]{"WHITE", "GRAY", "BLACK", "CLEAR", "RED", "GREEN", "BLUE", "ORANGE", "PINK", "CYAN", "MAGENTA", "YELLOW", "LIGHT GRAY", "DARK GRAY"};
		
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		protected internal static System.String getStandardColorName(ref System.Drawing.Color c)
		{
		...
		protected internal static System.Drawing.Color getStandardColor(System.String name)
		{
			for (int i = 0; i < standardColors.Length; i++)
			{
		...
		/// <summary> User defined Colors</summary>
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		public virtual ColorSwatch getColorSwatch(System.String name)
		{
			ColorSwatch c = userColors.get_Renamed(name);
			if (c == null)
			{
				System.Drawing.Color tempAux = getStandardColor(name);
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				c = new ColorSwatch(name, ref tempAux);
			}
			return c;
		}
		
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public virtual ColorSwatch getColorSwatch(ref System.Drawing.Color color)
		{
			if (color.IsEmpty)
			{
				System.Drawing.Color tempAux = System.Drawing.Color.Empty;
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				return new ColorSwatch("CLEAR", ref tempAux);
			}
			...
			if (swatch == null)
			{
				...
				{
					if (!standardColors[j].IsEmpty && standardColors[j].Equals(color))
					{
						//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
						swatch = new ColorSwatch(standardColorNames[j], ref standardColors[j]);
					}
				}
			}
			...
			{
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				swatch = new ColorSwatch(SELECT_COLOR, ref color);
			}
