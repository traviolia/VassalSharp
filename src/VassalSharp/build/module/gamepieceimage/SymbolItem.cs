...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class SymbolItem:Item
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.insert(base.AttributeDescriptions, 2, "Symbol Set:  ", "Width:  ", "Height:  ", "Line Width:  ");
			}
			
		}
		
		new public const System.String TYPE = "Symbol"; //$NON-NLS-1$
		
		protected internal const System.String SET = "set"; //$NON-NLS-1$
		...
		protected internal const System.String LINE_WIDTH = "linewidth"; //$NON-NLS-1$
		
		protected internal System.String symbolSet = ""; //$NON-NLS-1$
		protected internal int height = 30;
		protected internal int width = 40;
		protected internal double lineWidth = 1.0f;
		...
		public SymbolItem(GamePieceLayout l):base(l)
		{
			InitBlock();
		...
		public SymbolItem(GamePieceLayout l, System.String nam):this(l)
		{
	...
	public class SetConfig:StringEnum
	{
