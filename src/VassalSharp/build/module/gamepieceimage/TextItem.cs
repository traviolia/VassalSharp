...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class TextItem:Item
	{
		...
		{
			return ArrayUtils.insert_Renamed_Field;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.insert(base.AttributeDescriptions, 2, "Font style:  ", "Text is:  ", "Text:  ");
			}
			
		}
		
		new public const System.String TYPE = "Text"; //$NON-NLS-1$
		
		protected internal const System.String FONT = "font"; //$NON-NLS-1$
		protected internal const System.String SOURCE = "source"; //$NON-NLS-1$
		protected internal const System.String TEXT = "text"; //$NON-NLS-1$
		
		protected internal const System.String LEFT = "left"; //$NON-NLS-1$
		protected internal const System.String CENTER = "center"; //$NON-NLS-1$
		protected internal const System.String RIGHT = "right"; //$NON-NLS-1$
		protected internal const System.String TOP = "top"; //$NON-NLS-1$
		protected internal const System.String BOTTOM = "bottom"; //$NON-NLS-1$
		
		public const System.String SRC_VARIABLE = "Specified in individual images"; //$NON-NLS-1$
		public const System.String SRC_FIXED = "Fixed for this layout"; //$NON-NLS-1$
		
		protected internal const System.String PIECE_NAME = "pieceName"; //$NON-NLS-1$
		protected internal const System.String LABEL = "label"; //$NON-NLS-1$
		//UPGRADE_NOTE: Final was removed from the declaration of 'DEFAULT_FORMAT '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal static readonly System.String DEFAULT_FORMAT = "$" + PIECE_NAME + "$"; //$NON-NLS-1$ //$NON-NLS-2$
		
		public const int AL_CENTER = 0;
		public const int AL_RIGHT = 1;
		public const int AL_LEFT = 2;
		public const int AL_TOP = 3;
		public const int AL_BOTTOM = 4;
		
		protected internal System.String fontStyleName = "Default"; //$NON-NLS-1$
		protected internal System.String textSource = SRC_VARIABLE;
		protected internal System.String text = ""; //$NON-NLS-1$
		
		protected internal System.String changeCmd = ""; //$NON-NLS-1$
		protected internal System.Windows.Forms.KeyEventArgs changeKey;
		protected internal bool lockable = false;
		protected internal System.String lockCmd = ""; //$NON-NLS-1$
		protected internal System.Windows.Forms.KeyEventArgs lockKey;
		...
		public TextItem(GamePieceLayout l):base(l)
		{
			InitBlock();
		}
		
		public TextItem(GamePieceLayout l, System.String nam):this(l)
		{
	...
	public class FontStyleConfig : ConfigurerFactory
	{
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void draw(Graphics g, GamePieceImage defn)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public static
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void decode(TextItem item, String s)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public class TextSource:StringEnum
	{
		public override System.String[] getValidValues(AutoConfigurable target)
		{
			return new System.String[]{SRC_VARIABLE, SRC_FIXED};
		}
	}
	
	public class NameFormatConfig : ConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			return new FormattedStringConfigurer(key, name, new System.String[]{PIECE_NAME, LABEL});
		}
	}
	...
	public static
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawLabel(Graphics g, String text, int x, int y, Font f, int hAlign, int vAlign, Color fgColor, Color bgColor, Color borderColor, boolean outline, Color outlineColor)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		g.setFont(f);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
