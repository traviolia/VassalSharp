...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class FontManager:AbstractConfigurable
	{
		...
		protected internal static FontManager instance;
		...
		public const System.String DIALOG = "Dialog"; //$NON-NLS-1$
		public const System.String SERIF = "Serif"; //$NON-NLS-1$
		public const System.String SANS_SERIF = "SanSerif"; //$NON-NLS-1$
		public const System.String DIALOG_INPUT = "DialogInput"; //$NON-NLS-1$
		public const System.String MONOSPACED = "Monospaced"; //$NON-NLS-1$
		
		public const System.String DEFAULT = "Default"; //$NON-NLS-1$
		//UPGRADE_NOTE: Final was removed from the declaration of 'DEFAULT_FONT '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		...
		public static readonly OutlineFont DEFAULT_FONT = new OutlineFont(DIALOG, (int) System.Drawing.FontStyle.Regular, 12, false);
		//UPGRADE_NOTE: Final was removed from the declaration of 'DEFAULT_STYLE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly FontStyle DEFAULT_STYLE = new FontStyle();
		
		//  public static final String[] ALLOWABLE_FONTS = new String[] { DIALOG, DIALOG_INPUT, MONOSPACED, SANS_SERIF, SERIF };
		//UPGRADE_NOTE: Final was removed from the declaration of 'ALLOWABLE_FONTS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		...
		public static readonly System.String[] ALLOWABLE_FONTS = SupportClass.FontNames();
		...
		public override void  build(System.Xml.XmlElement e)
		{
			...
			if (fontStyles.get_Renamed(DEFAULT) == null)
			{
		...
		protected internal virtual FontStyle getFontStyle(System.String name)
		{
			FontStyle fs = fontStyles.get_Renamed(name);
