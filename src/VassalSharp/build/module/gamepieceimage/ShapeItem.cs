...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class ShapeItem:Item
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.insert(base.AttributeDescriptions, 2, "Width:  ", "Height:  ", "Shape:  ", "Bevel:  ");
			}
			
		}
		
		new public const System.String TYPE = "Box"; //$NON-NLS-1$
		...
		protected internal const System.String SHAPE = "shape"; //$NON-NLS-1$
		protected internal const System.String BEVEL = "bevel"; //$NON-NLS-1$
		
		protected internal const System.String RECT = "Rectangle";
		protected internal const System.String RRECT = "Rounded Rectangle";
		protected internal const System.String OVAL = "Oval";
		
		protected internal int height = 30;
		protected internal int width = 40;
		protected internal int bevel = 5;
		protected internal System.String shape = RECT;
		...
		public ShapeItem(GamePieceLayout l):base(l)
		{
			InitBlock();
		}
		
		public ShapeItem(GamePieceLayout l, System.String n):this(l)
		{
			setConfigureName(n);
		}
	...
	public class ShapeConfig:StringEnum
	{
		public override System.String[] getValidValues(AutoConfigurable target)
		{
			return new System.String[]{RECT, RRECT, OVAL};
		}
	}
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
