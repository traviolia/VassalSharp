...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	/// <summary> </summary>
	public class GamePieceImage:AbstractConfigurable, Visualizable, System.ICloneable, UniqueIdManager.Identifyable
	{
		private void  InitBlock()
		{
			bgColor = ColorSwatch.getWhite();
			borderColor = ColorSwatch.getBlack();
			return instances;
			return ;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name:  ", "Background Color:  ", "Border Color:  ", ""};
			}
			
		}
		
		protected internal const System.String NAME = "name"; //$NON-NLS-1$
		protected internal const System.String PROPS = "props"; //$NON-NLS-1$
		
		public const System.String PART_SIZE = "Size"; //$NON-NLS-1$
		public const System.String PART_SYMBOL1 = "Symbol1"; //$NON-NLS-1$
		public const System.String PART_SYMBOL2 = "Symbol2"; //$NON-NLS-1$
		
		public const System.String BG_COLOR = "bgColor"; //$NON-NLS-1$
		public const System.String BORDER_COLOR = "borderColor"; //$NON-NLS-1$
		
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < ItemInstance > instances = new ArrayList < ItemInstance >();
		protected internal InstanceConfigurer defnConfig = null;
		...
		//UPGRADE_NOTE: The initialization of  'borderColor' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal ColorSwatch borderColor;
		protected internal System.String id;
		
		protected internal static UniqueIdManager idMgr = new UniqueIdManager("GamePieceImage"); //$NON-NLS-1$
		protected internal System.String nameInUse;
		protected internal System.Drawing.Image visImage = null;
		
		protected internal SourceOp srcOp;
		
		public GamePieceImage():base()
		{
			InitBlock();
			setConfigureName(""); //$NON-NLS-1$
		}
		
		public GamePieceImage(System.String s)
		{
			InitBlock();
			instances = InstanceConfigurer.StringToProperties(s, this);
		}
		
		public GamePieceImage(GamePieceLayout l):this()
		{
			setConfigureName(l.getConfigureName());
			layout = l;
		}
		
		public GamePieceImage(GamePieceImage defn):this()
		{
	...
	public class BorderColorSwatchConfig : ConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
	...
	public class DefnConfig : ConfigurerFactory
	{
		internal static GamePieceImage id;
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, BG_COLOR, BORDER_COLOR, PROPS
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
