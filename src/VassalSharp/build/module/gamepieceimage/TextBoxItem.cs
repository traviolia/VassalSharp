...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class TextBoxItem:TextItem
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return ArrayUtils.insert(base.AttributeDescriptions, 2, "Width:  ", "Height:  ", "Use HTML:  ");
			}
			
		}
		
		new public const System.String TYPE = "TextBox"; //$NON-NLS-1$
		...
		protected internal const System.String USE_HTML = "use_html"; //$NON-NLS-1$
		
		protected internal int height = 30;
		protected internal int width = 40;
		protected internal bool isHTML = false;
		
		public TextBoxItem():base()
		{
			InitBlock();
		}
		
		public TextBoxItem(GamePieceLayout l):base(l)
		{
			InitBlock();
		}
		
		public TextBoxItem(GamePieceLayout l, System.String n):this(l)
		{
			setConfigureName(n);
		}
