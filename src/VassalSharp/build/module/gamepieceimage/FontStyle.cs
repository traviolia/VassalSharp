...
/// <summary> Class tht implements a names Font Swatch</summary>
using System;
...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class FontStyle:AbstractConfigurable
	{
		...
		virtual public OutlineFont Font
		{
			get
			{
				return font;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Style Name:  ", "Font Style:  "};
			}
			
		}
		
		protected internal const System.String NAME = "name"; //$NON-NLS-1$
		protected internal const System.String STYLE = "style"; //$NON-NLS-1$
		
		protected internal OutlineFont font;
		...
		public FontStyle():base()
		{
			...
			font = new OutlineFont(FontManager.DIALOG, (int) System.Drawing.FontStyle.Regular, 12, false);
		}
		
		public FontStyle(System.String name, OutlineFont f):base()
		{
			InitBlock();
