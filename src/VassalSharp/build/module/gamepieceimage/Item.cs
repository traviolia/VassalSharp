...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	/// </summary>
	public abstract class Item:AbstractConfigurable
	{
		private void  InitBlock()
		{
			location = GamePieceLayout.CENTER;
			return ;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name:  ", "Location:  ", "Advanced Options", "X Offset:  ", "Y Offset:  ", "Rotation (Degrees):  ", "Anti-alias?"};
			}
			
		}
		
		public const System.String TYPE = ""; //$NON-NLS-1$
		
		protected internal const System.String NAME = "name"; //$NON-NLS-1$
		protected internal const System.String LOCATION = "location"; //$NON-NLS-1$
		protected internal const System.String ADVANCED = "advanced"; //$NON-NLS-1$
		protected internal const System.String ROTATION = "rotation"; //$NON-NLS-1$
		protected internal const System.String X_OFFSET = "xoffset"; //$NON-NLS-1$
		protected internal const System.String Y_OFFSET = "yoffset"; //$NON-NLS-1$
		protected internal const System.String ANTIALIAS = "antialias"; //$NON-NLS-1$
		
		//UPGRADE_NOTE: The initialization of  'location' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		internal System.String location;
		protected internal int xoffset, yoffset;
		protected internal bool advanced = false;
		protected internal int rotation = 0;
		protected internal bool antialias = true;
		...
		public Item(GamePieceLayout l):this()
		{
			layout = l;
		}
		
		public Item(System.String name):this()
		{
	...
	public class LocationConfig:StringEnum
	{
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, LOCATION, ADVANCED, X_OFFSET, Y_OFFSET, ROTATION, ANTIALIAS
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
	...
	/// <summary> Implemented by subclass to draw itself.</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	abstract
