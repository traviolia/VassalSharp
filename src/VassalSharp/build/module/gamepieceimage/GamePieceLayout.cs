...
namespace VassalSharp.build.module.gamepieceimage
{
	...
	public class GamePieceLayout:AbstractConfigurable, Visualizable
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name:  ", "Counter Width:  ", "Counter Height:  ", "Border Style:  ", ""};
			}
			
		}
		
		protected internal const System.String NAME = "name"; //$NON-NLS-1$
		protected internal const System.String WIDTH = "width"; //$NON-NLS-1$
		protected internal const System.String HEIGHT = "height"; //$NON-NLS-1$
		protected internal const System.String BORDER = "border"; //$NON-NLS-1$
		protected internal const System.String ITEMS = "layout"; //$NON-NLS-1$
		
		protected internal const System.String N = "Top";
		protected internal const System.String S = "Bottom";
		protected internal const System.String E = "Right";
		protected internal const System.String W = "Left";
		protected internal const System.String NE = "Top Right";
		protected internal const System.String NW = "Top Left";
		protected internal const System.String SE = "Bottom Right";
		protected internal const System.String SW = "Bottom Left";
		protected internal const System.String CENTER = "Center";
		
		protected internal const int POS_L = 15;
		protected internal const int POS_R = 85;
		protected internal const int POS_T = 15;
		protected internal const int POS_B = 85;
		protected internal const int POS_C = 50;
		
		protected internal const System.String BORDER_PLAIN = "Plain";
		protected internal const System.String BORDER_FANCY = "Fancy";
		protected internal const System.String BORDER_3D = "3D";
		protected internal const System.String BORDER_NONE = "None";
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'LOCATIONS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly System.String[] LOCATIONS = new System.String[]{CENTER, N, S, E, W, NE, NW, SE, SW};
		//UPGRADE_NOTE: Final was removed from the declaration of 'X_POS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] X_POS = new int[]{POS_C, POS_C, POS_C, POS_R, POS_L, POS_R, POS_L, POS_R, POS_L};
		//UPGRADE_NOTE: Final was removed from the declaration of 'Y_POS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] Y_POS = new int[]{POS_C, POS_T, POS_B, POS_C, POS_C, POS_T, POS_T, POS_B, POS_B};
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected static Map < String, String > compass = new HashMap < String, String >();
		
		public static System.String getCompassPoint(System.String location)
		{
			return compass.get_Renamed(location);
		}
		
		public virtual System.Drawing.Point getPosition(Item item)
		{
			...
			System.String s = getCompassPoint(item.getLocation());
			...
			System.Drawing.Size d = item.getSize();
			switch (s[s.Length - 1])
			{
			...
			return new System.Drawing.Point(x + item.getXoffset(), y + item.getYoffset());
		}
		
		protected internal int width = 54;
		protected internal int height = 54;
		protected internal System.String border = BORDER_3D;
		protected internal GamePieceImage imageDefn;
		protected internal System.Drawing.Image visImage;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < Item > items = new ArrayList < Item >();
		
		public GamePieceLayout():base()
		{
			InitBlock();
			name = ""; //$NON-NLS-1$
	...
	public class LayoutConfig : ConfigurerFactory
	{
		protected internal static LayoutConfigurer configurer;
	...
	public class BorderConfig:StringEnum
	{
		public override System.String[] getValidValues(AutoConfigurable target)
		{
			return new System.String[]{BORDER_PLAIN, BORDER_FANCY, BORDER_3D, BORDER_NONE};
		}
	}
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, WIDTH, HEIGHT, BORDER, ITEMS
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(GamePieceImage i: getComponentsOf(GamePieceImage.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void decodeItemList(String string)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		items.clear();
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setImageDefn(GamePieceImage d)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		imageDefn = d;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
