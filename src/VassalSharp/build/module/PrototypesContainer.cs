...
namespace VassalSharp.build.module
{
	...
	/// <summary> Container for definitions of Game Piece prototypes.
	/// Actual definition is in inner class
	/// {@link VassalSharp.build.module.PrototypeDefinition}
	/// </summary>
	public class PrototypesContainer:AbstractConfigurable
	{
	...
	{ 
		...
		.getComponentsOf(PrototypesContainer.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class)
	.iterator();
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
