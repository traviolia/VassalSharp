...
namespace VassalSharp.build.module
{
	...
	public class SpecialDieFace:AbstractConfigurable
	{
		public SpecialDieFace()
		{
			InitBlock();
		}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString("Editor.SpecialDieFace.text_value"), Resources.getString("Editor.SpecialDieFace.numeric_value"), Resources.getString("Editor.SpecialDieFace.icon")};
			}
			
		}
		
		public const System.String TEXT = "text"; //$NON-NLS-1$
		public const System.String NUMERICAL_VALUE = "value"; //$NON-NLS-1$
		public const System.String ICON = "icon"; //$NON-NLS-1$
		public const System.String IMAGE = "image"; //$NON-NLS-1$
