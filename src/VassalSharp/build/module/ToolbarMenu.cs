...
namespace VassalSharp.build.module
{
	...
	/// <summary> Takes buttons from the toolbar of a Map or the main module and places
	...
	/// 
	/// </author>
	public class ToolbarMenu:AbstractConfigurable, GameComponent
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(ToolbarMenu enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(ToolbarMenu enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private ToolbarMenu enclosingInstance;
			public ToolbarMenu Enclosing_Instance
			{
				get
				{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.DESCRIPTION), Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.BUTTON_ICON), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.ToolbarMenu.menu_entries")}; //$NON-NLS-1$
			}
			
		}
		public const System.String BUTTON_TEXT = "text"; //$NON-NLS-1$
		public const System.String BUTTON_ICON = "icon"; //$NON-NLS-1$
		public const System.String BUTTON_HOTKEY = "hotkey"; //$NON-NLS-1$
		public const System.String TOOLTIP = "tooltip"; //$NON-NLS-1$
		public const System.String MENU_ITEMS = "menuItems"; //$NON-NLS-1$
		public const System.String DESCRIPTION = "description"; //$NON-NLS-1$
		/// <summary>Buttons where this property contains a JPopupMenu will turn into sub-menus </summary>
		public const System.String MENU_PROPERTY = "ToolbarMenu.popup"; //$NON-NLS-1$
		public const System.String HIDDEN_BY_TOOLBAR = "hidden"; //$NON-NLS-1$
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		protected internal System.Windows.Forms.ContextMenu menu;
		protected internal IThreadRunnable menuBuilder;
		
		public ToolbarMenu()
		{
			InitBlock();
			launch_Renamed_Field = new LaunchButton(Resources.getString(Resources.MENU), TOOLTIP, BUTTON_TEXT, BUTTON_HOTKEY, BUTTON_ICON, new AnonymousClassActionListener(this));
			//UPGRADE_ISSUE: Class hierarchy differences between 'javax.swing.JPopupMenu' and 'System.Windows.Forms.ContextMenu' may cause compilation errors. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
			...
			launch_Renamed_Field.putClientProperty(MENU_PROPERTY, menu);
			launch_Renamed_Field.setToolTipText("Display Menu Options");
		...
		public virtual void  launch()
		{
			...
			menu.Show(launch_Renamed_Field, new System.Drawing.Point(0, 0));
		}
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(int i = 0, n = toolbar.getComponentCount();
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	i < n;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	++ i)
