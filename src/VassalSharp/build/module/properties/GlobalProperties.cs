...
namespace VassalSharp.build.module.properties
{
	...
	/// <summary> Dummy component that acts as a simple container for GlobalProperty components
	/// 
	/// </summary>
	/// <author>  rkinney
	/// 
	/// </author>
	public class GlobalProperties:AbstractConfigurable, MutablePropertiesContainer, ToolBarComponent, PropertySource
	{
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	for(GlobalProperty prop: getComponentsOf(GlobalProperty.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	*/
	...
	/// <summary> Use the identity of the owning container (i.e. Module, map or zone)</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
