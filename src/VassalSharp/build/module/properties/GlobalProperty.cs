...
namespace VassalSharp.build.module.properties
{
	...
	/// <summary> Adds a global property to a Map or Module
	/// 
	/// </summary>
	/// <author>  rkinney
	/// 
	/// </author>
	public class GlobalProperty:AbstractConfigurable, ToolBarComponent, GameComponent, CommandEncoder, PropertySource, MutableProperty
	{
		...
		{
			public AnonymousClassVisibilityCondition(GlobalProperty enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(GlobalProperty enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private GlobalProperty enclosingInstance;
			public GlobalProperty Enclosing_Instance
			{
				get
				{
		...
		{
			property = new VassalSharp.build.module.properties.Impl("", this);
			return ;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name", "Initial value:  ", "Description:  ", "Is Numeric", "Minimum value:  ", "Maximum value:  ", "Wrap around"};
			}
			
		}
		public const System.String NAME = "name";
		public const System.String INITIAL_VALUE = "initialValue";
		public const System.String DESCRIPTION = "description";
		public const System.String NUMERIC = "isNumeric";
		public const System.String MIN_VALUE = "min";
		public const System.String MAX_VALUE = "max";
		public const System.String WRAP = "wrap";
		protected internal const System.String COMMAND_PREFIX = "GlobalProperty\t";
		protected internal TemporaryToolBar tempToolbar = new TemporaryToolBar();
		protected internal System.String description;
		protected internal System.String initialValue;
		protected internal bool numeric;
		protected internal System.String minValue;
		protected internal System.String maxValue;
		protected internal bool wrap;
		protected internal VisibilityCondition numericVisibility;
		...
		protected internal MutablePropertiesContainer parentContainer;
		
		public GlobalProperty()
		{
			InitBlock();
			numericVisibility = new AnonymousClassVisibilityCondition(this);
		}
		
		public GlobalProperty(GlobalProperty p):this()
		{
	...
	/// <summary> A String that identifies this property in an encoded Command</summary>
	/// <returns>
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Command to pass a new Global property value to other players or into the logfile.</summary>
	public class SetGlobalProperty:Command
	{
		virtual public System.String TargetName
		{
			get
			{
				if (target == null)
				...
				{
					//UPGRADE_NOTE: Final was removed from the declaration of 'targetName '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
					System.String targetName = target.getPropertyId();
					return targetName == null?"":targetName;
				}
			}
			
		}
		virtual public GlobalProperty Property
		{
			get
			{
				return target;
		...
		protected internal System.String newValue;
		protected internal System.String oldValue;
		protected internal GlobalProperty target;
		protected internal System.String targetName;
		
		public SetGlobalProperty(GlobalProperty target, System.String oldV, System.String newV)
		{
			oldValue = oldV;
			newValue = newV;
			this.target = target;
