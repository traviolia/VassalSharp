...
namespace VassalSharp.build.module.properties
{
	...
	/// <summary> Provides a new value for a global property. This class is an abstraction around the act of prompting a user for the
	...
	{
		System.String getNewValue(System.String oldValue);
	}
}