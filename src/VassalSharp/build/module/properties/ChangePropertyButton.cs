...
namespace VassalSharp.build.module.properties
{
	...
	/// <summary> Adds a toolbar button that changes the value of a global property
	/// 
	/// </summary>
	/// <author>  rkinney
	/// 
	/// </author>
	public class ChangePropertyButton:AbstractConfigurable, PropertyChangerConfigurer.Constraints
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(ChangePropertyButton enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(ChangePropertyButton enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private ChangePropertyButton enclosingInstance;
			public ChangePropertyButton Enclosing_Instance
			{
				get
				{
		...
		{
			propChangeConfig = new PropertyChangerConfigurer(null, null, this);
			return ;
		...
		virtual protected internal System.String NewValue
		{
			get
			{
				System.String newValue = PropertyChanger.getNewValue(property.getPropertyValue());
		...
		virtual public PropertyChanger PropertyChanger
		{
			get
			{
				return propChangeConfig.PropertyChanger;
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Button text:  ", "Tooltip Text:  ", "Button icon:  ", "Hotkey:  ", "Report format:  ", "Options:  "};
			}
			
		}
		public const System.String BUTTON_TEXT = "text";
		public const System.String BUTTON_TOOLTIP = "tooltip";
		public const System.String BUTTON_ICON = "icon";
		public const System.String HOTKEY = "hotkey";
		public const System.String PROPERTY_CHANGER = "propChanger";
		
		public const System.String REPORT_FORMAT = "reportFormat";
		public const System.String OLD_VALUE_FORMAT = "oldValue";
		public const System.String NEW_VALUE_FORMAT = "newValue";
		public const System.String DESCRIPTION_FORMAT = "description";
		
		protected internal LaunchButton launch_Renamed_Field;
		protected internal FormattedString report = new FormattedString();
		protected internal GlobalProperty property;
		//UPGRADE_NOTE: The initialization of  'propChangeConfig' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		{
			InitBlock();
			launch_Renamed_Field = new LaunchButton("Change", BUTTON_TOOLTIP, BUTTON_TEXT, HOTKEY, BUTTON_ICON, new AnonymousClassActionListener(this));
		}
		
		public virtual void  launch()
		{
			System.String oldValue = property.getPropertyValue();
			System.String newValue = NewValue;
			if (newValue != null && !newValue.Equals(oldValue))
			{
				Command c = property.setPropertyValue(newValue);
				if (report.Format.Length > 0)
				{
	...
	public class ReportFormatConfig : TranslatableConfigurerFactory
	{
		...
		{
			return new PlayerIdFormattedStringConfigurer(key, name, new System.String[]{OLD_VALUE_FORMAT, NEW_VALUE_FORMAT, DESCRIPTION_FORMAT});
		}
	}
	
	public class PropChangerOptions : ConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
