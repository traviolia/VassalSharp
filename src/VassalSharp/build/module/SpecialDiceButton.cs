...
namespace VassalSharp.build.module
{
	...
	public class SpecialDiceButton:AbstractConfigurable, CommandEncoder, UniqueIdManager.Identifyable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(SpecialDiceButton enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SpecialDiceButton enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private SpecialDiceButton enclosingInstance;
			public SpecialDiceButton Enclosing_Instance
			{
				get
				{
		...
		{
			chatResultFormat = "** $" + NAME + "$ = [$result1$] *** <$" + GlobalOptions.PLAYER_NAME + "$>";
		...
		virtual protected internal int[] Format
		{
			set
			{
				format.setProperty(NAME, LocalizedConfigureName);
				int total = 0;
				for (int i = 0; i < dice.size(); ++i)
				{
					//UPGRADE_NOTE: Final was removed from the declaration of 'die '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
					SpecialDie die = dice.get_Renamed(i);
					format.setProperty("result" + (i + 1), die.getTextValue(value[i])); //$NON-NLS-1$
					total += die.getIntValue(value[i]);
				}
				format.setProperty(RESULT_TOTAL, System.Convert.ToString(total)); //$NON-NLS-1$
				format.Format = chatResultFormat;
			}
			
		}
		/// <summary> The Attributes of a DiceButton are:
		/// 
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, BUTTON_TEXT, TOOLTIP, ICON, HOTKEY, RESULT_CHATTER, CHAT_RESULT_FORMAT, RESULT_WINDOW, WINDOW_TITLE_RESULT_FORMAT, RESULT_BUTTON, WINDOW_X, WINDOW_Y, BACKGROUND_COLOR};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.NAME_LABEL), Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.BUTTON_ICON), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.SpecialDiceButton.report_results_text"), Resources.getString("Editor.report_format"), Resources.getString("Editor.SpecialDiceButton.result_window"), Resources.getString("Editor.SpecialDiceButton.window_title"), Resources.getString("Editor.SpecialDiceButton.result_button"), Resources.getString("Editor.SpecialDiceButton.width"), Resources.getString("Editor.SpecialDiceButton.height"), Resources.getString("Editor.SpecialDiceButton.background")};
			}
		...
		//UPGRADE_NOTE: The initialization of  'logger' was moved to static method 'VassalSharp.build.module.SpecialDiceButton'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private static readonly Logger logger;
		
		protected internal static UniqueIdManager idMgr = new UniqueIdManager("SpecialDiceButton"); //$NON-NLS-1$
		public const System.String SHOW_RESULTS_COMMAND = "SHOW_RESULTS\t"; //$NON-NLS-1$
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < SpecialDie > dice = new ArrayList < SpecialDie >();
		protected internal System.Random ran;
		protected internal bool reportResultAsText = true;
		protected internal bool reportResultInWindow = false;
		protected internal bool reportResultInButton = false;
		private LaunchButton launch;
		protected internal System.String id;
		protected internal System.String sMapName;
		protected internal System.Windows.Forms.Form dialog; // Dialog to show results graphical
		protected internal System.Windows.Forms.Label dialogLabel;
		protected internal System.Drawing.Color bgColor;
		protected internal ResultsIcon resultsIcon = new ResultsIcon();
		protected internal FormattedString format = new FormattedString();
		//UPGRADE_NOTE: The initialization of  'chatResultFormat' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal System.String chatResultFormat; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		protected internal System.String windowTitleResultFormat = "$" + NAME + "$"; //$NON-NLS-1$ //$NON-NLS-2$
		...
		protected internal VassalSharp.build.module.properties.Impl property; //$NON-NLS-1$
		...
		public const System.String RESULT_CHATTER = "resultChatter"; //$NON-NLS-1$
		public const System.String CHAT_RESULT_FORMAT = "format"; //$NON-NLS-1$
		public const System.String RESULT_N = "result#"; //$NON-NLS-1$
		public const System.String RESULT_TOTAL = "numericalTotal"; //$NON-NLS-1$
		public const System.String RESULT_WINDOW = "resultWindow"; //$NON-NLS-1$
		public const System.String WINDOW_TITLE_RESULT_FORMAT = "windowTitleResultFormat"; //$NON-NLS-1$
		public const System.String RESULT_BUTTON = "resultButton"; //$NON-NLS-1$
		public const System.String WINDOW_X = "windowX"; //$NON-NLS-1$
		public const System.String WINDOW_Y = "windowY"; //$NON-NLS-1$
		public const System.String BACKGROUND_COLOR = "backgroundColor"; //$NON-NLS-1$
		public const System.String DICE_SET = "diceSet"; //$NON-NLS-1$
		public const System.String HOTKEY = "hotkey"; //$NON-NLS-1$
		public const System.String NONE = "<none>"; //$NON-NLS-1$
		...
		public SpecialDiceButton()
		{
			...
			System.String desc = Resources.getString("Editor.SpecialDiceButton.symbols"); //$NON-NLS-1$
			setAttribute(NAME, desc);
			setAttribute(BUTTON_TEXT, desc);
			launch.setAttribute(TOOLTIP, desc);
		}
		
		/// <summary> The text reported after the results of the roll;
		/// 
		/// </summary>
		/// <deprecated>
		/// </deprecated>
		...
		/// <summary> Forwards the result of the roll to the {@link Chatter#send} method of the {@link Chatter} of the {@link GameModule}.
		...
		private Command reportResults(int[] results)
		{
			...
			if (reportResultInWindow)
			{
				...
				dialogLabel.Size = new System.Drawing.Size(resultsIcon.width, resultsIcon.height);
				...
				dialogLabel.setMinimumSize(new System.Drawing.Size(resultsIcon.width, resultsIcon.height));
				format.Format = windowTitleResultFormat;
				dialog.Text = format.getLocalizedText();
		...
		private Command reportTextResults(int[] results)
		{
			...
			format.Format = chatResultFormat;
			System.String msg = format.getLocalizedText();
			if (msg.Length > 0)
			{
				if (msg.StartsWith("*"))
				{
			...
			c.execute();
			c.append(property.setPropertyValue(System.Convert.ToString(total)));
			return c;
		}
		...
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class
		static SpecialDiceButton()
		{
			logger = LoggerFactory.getLogger(typeof(SpecialDiceButton));
		}
	}
	...
	public class ReportFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			return new PlayerIdFormattedStringConfigurer(key, name, new System.String[]{NAME, RESULT_N, RESULT_TOTAL});
		}
	}
	...
	/// <summary> Expects to be added to a SymbolDice. Adds the button to the control window's toolbar and registers itself as a
	...
	/// <summary> Get boolean value of object.
	/// 
	/// </summary>
	/// <param name="o">object as input for setAttribute()
	/// </param>
	...
	/// <summary> create String from int array
	/// 
	/// </summary>
	/// <param name="ia">int-array
	/// </param>
	...
	/// <summary> get int array from string
	/// 
	/// </summary>
	/// <param name="s">string with encoded int array
	/// </param>
	/// <returns> int array
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Command for displaying the results of a roll of the dice</summary>
	public class ShowResults:Command
	{
	...
	/// <summary>Icon class for graphical display of a dice roll </summary>
	//UPGRADE_NOTE: The access modifier for this class or class field has been changed in order to prevent compilation errors due to the visibility level. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1296'"
	public class ResultsIcon : System.Drawing.Image
	{
		private int[] Results
		{
			set
			{
				icons = new System.Drawing.Image[value.Length];
				if (value.Length > dice.size())
				{
					logger.warn("Special Die Button (" + getConfigureName() + "): more results (" + value.Length + ") requested than dice (" + dice.size() + ")");
				}
				for (int i = 0; i < value.Length; ++i)
				{
					...
					System.String imageName = dice.get_Renamed(i).getImageName(value[i]);
					...
					if (imageName.Length > 0)
					{
						...
						if (img != null)
							icons[i] = (System.Drawing.Image) img.Clone();
					}
				}
			}
		...
		private System.Drawing.Image[] icons;
		...
		public virtual void  paintIcon(System.Windows.Forms.Control c, System.Drawing.Graphics g, int x, int y)
		{
			...
			{
				g.setColor(bgColor);
				g.FillRectangle(SupportClass.GraphicsManager.manager.GetPaint(g), x, y, width, height);
			}
			int offset = 0;
			for (int i = 0; i < icons.Length; ++i)
			{
				if (icons[i] != null)
				{
					...
					g.DrawImage(icons[i], x + offset, y);
					offset += icons[i].Width;
				}
			}
		}
	}
