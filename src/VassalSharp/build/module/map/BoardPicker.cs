...
using GameSetupStep = VassalSharp.build.module.GameSetupStep;
using Map = VassalSharp.build.module.Map;
using HelpFile = VassalSharp.build.module.documentation.HelpFile;
using Board = VassalSharp.build.module.map.boardPicker.Board;
using BoardSlot = VassalSharp.build.module.map.boardPicker.BoardSlot;
...
namespace VassalSharp.build.module.map
{
	...
	/// <summary> This class is responsible for maintaining the {@link Board}s on a {@link Map}. As a {@link CommandEncoder}, it
	...
	/// </summary>
	public class BoardPicker:AbstractBuildable, GameComponent, GameSetupStep, Configurable, CommandEncoder, ValidityChecker
	{
		private void  InitBlock()
		{
			title = Resources.getString("BoardPicker.choose_boards");
			addRowButtonText = Resources.getString("BoardPicker.add_row");
			addColumnButtonText = Resources.getString("BoardPicker.add_column");
			boardPrompt = Resources.getString("BoardPicker.select_board");
			return ;
		...
		virtual public System.Drawing.Size DefaultSlotSize
		{
			get
			{
				return psize;
		...
		/// <returns> the zoom factory at which to display boards when selecting them
		/// </returns>
		virtual public double SlotScale
		{
			get
			{
				return slotScale;
		...
		private System.String DefaultSetup
		{
			get
			{
				System.String s = defaultSetup;
				if (defaultSetup == null || defaultSetup.Length == 0)
				{
					if (possibleBoards.size() == 1)
					{
						Board b = possibleBoards.get_Renamed(0);
						if (!"true".Equals(b.getAttributeValueString(Board.REVERSIBLE)))
						{
							//$NON-NLS-1$
							s = encode(new SetBoards(this, System.Collections.ArrayList.ReadOnly(new System.Collections.ArrayList(new System.Object[]{b}))));
						}
					}
				}
				return s;
		...
		virtual public System.String BoardDelimiter
		{
			get
			{
				return "bd\t"; //$NON-NLS-1$
		...
		public const System.String ID = "BoardPicker"; //$NON-NLS-1$
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < Board > possibleBoards = new ArrayList < Board >();
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < Board > currentBoards = null;
		protected internal System.Drawing.Size psize = new System.Drawing.Size(350, 125);
		protected internal double slotScale = 0.2;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		Deprecated
		protected internal System.Windows.Forms.TextBox status;
		protected internal System.Windows.Forms.Label statusLabel;
		protected internal Map map;
		protected internal System.Windows.Forms.Panel slotPanel;
		protected internal System.String version = "0.0"; //$NON-NLS-1$
		protected internal int nx = 1, ny = 1;
		protected internal System.Windows.Forms.ToolBar toolbar;
		protected internal System.Windows.Forms.Panel controls;
		protected internal System.Windows.Forms.Button addRowButton;
		protected internal System.Windows.Forms.Button addColumnButton;
		protected internal bool allowMultiple;
		protected internal int maxColumns;
		//UPGRADE_NOTE: The initialization of  'title' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal System.String title; //$NON-NLS-1$
		//UPGRADE_NOTE: The initialization of  'addRowButtonText' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal System.String addRowButtonText; //$NON-NLS-1$
		//UPGRADE_NOTE: The initialization of  'addColumnButtonText' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal System.String addColumnButtonText; //$NON-NLS-1$
		//UPGRADE_NOTE: The initialization of  'boardPrompt' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal System.String boardPrompt; //$NON-NLS-1$
		protected internal System.String defaultSetup;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < JButton > multipleButtons;
		public const System.String SCALE = "slotScale"; //$NON-NLS-1$
		public const System.String SLOT_HEIGHT = "slotHeight"; //$NON-NLS-1$
		public const System.String SLOT_WIDTH = "slotWidth"; //$NON-NLS-1$
		public const System.String SETUP = "setup"; //$NON-NLS-1$
		public const System.String DIALOG_TITLE = "title"; //$NON-NLS-1$
		public const System.String ADD_ROW_BUTTON_TEXT = "addRowText"; //$NON-NLS-1$
		public const System.String ADD_COLUMN_BUTTON_TEXT = "addColumnText"; //$NON-NLS-1$
		public const System.String BOARD_PROMPT = "boardPrompt"; //$NON-NLS-1$
		public const System.String MAX_COLUMNS = "maxColumns"; //$NON-NLS-1$
		protected internal System.Windows.Forms.Button clearButton;
		...
		protected internal System.Windows.Forms.ScrollableControl slotScroll;
		...
		protected internal virtual void  initComponents()
		{
			...
			temp_label.Text = "";
			statusLabel = temp_label; //$NON-NLS-1$
			statusLabel.setForeground(Color.BLUE);
			slotPanel = new System.Windows.Forms.Panel();
			...
			System.Windows.Forms.Panel pp = new System.Windows.Forms.Panel();
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			pp.Controls.Add(toolbar);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javalangString_javaawtComponent'"
			controls.Controls.Add(pp);
			...
			temp_scrollablecontrol.Controls.Add(slotPanel);
			slotScroll = temp_scrollablecontrol;
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javalangString_javaawtComponent'"
			controls.Controls.Add(slotScroll);
			reset();
		}
		
		public virtual void  warn(System.String s)
		{
			if (statusLabel != null)
			{
				statusLabel.Text = s;
		...
		public override void  build(System.Xml.XmlElement e)
		{
			...
			{
				System.Xml.XmlNodeList l = e.GetElementsByTagName(SETUP);
				if (l.Count > 0)
				{
					System.Xml.XmlElement setupEl = (System.Xml.XmlElement) l.Item(0);
					defaultSetup = Builder.getText(setupEl);
					System.Xml.XmlNode nextSibling = setupEl.NextSibling;
				...
				try
				{
					psize = new System.Drawing.Size(System.Int32.Parse(e.GetAttribute(SLOT_WIDTH)), System.Int32.Parse(e.GetAttribute(SLOT_HEIGHT)));
				}
				...
				try
				{
					slotScale = System.Double.Parse(e.GetAttribute(SCALE));
				}
				catch (System.FormatException ex)
				{
					// Use default values if attribute doesn't parse.
				...
				try
				{
					maxColumns = System.Int32.Parse(e.GetAttribute(MAX_COLUMNS));
				}
				catch (System.FormatException ex)
				{
					// Use default values if attribute doesn't parse.
				...
				System.String value_Renamed = e.GetAttribute(DIALOG_TITLE);
				...
				*/
				value_Renamed = e.GetAttribute(BOARD_PROMPT);
				if (value_Renamed != null && value_Renamed.Length > 0)
				{
					boardPrompt = value_Renamed;
				}
				// Record attributes for later translation
				Localization.Instance.saveTranslatableAttribute(this, BOARD_PROMPT, boardPrompt);
				Localization.Instance.saveTranslatableAttribute(this, DIALOG_TITLE, title);
			}
		}
		...
		/// <summary> Add a board to the list of those available for the user to choose from</summary>
		public override void  add(Buildable b)
		{
			...
			base.add(b); // PG-2011-09-24
		}
		
		/// <summary> Remove a board from the list of those available for the user to choose from</summary>
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setBoards(Enumeration < Board > bdEnum)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <returns> a Collection of boards that have been selected either by the user via the dialog or from reading a savefile
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> an Enumeration of boards that have been selected either by the user via the dialog or from reading a
	/// savefile
	/// </returns>
	...
	/// <returns> an array of the names of all boards from which the user may choose
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> a Board with the given name.
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> When starting a game, check to see if any boards have been specified (via an encoded {@link Command}. If not, show
	...
	/// <summary> The restore command of a BoardPicker, when executed, sets the boards of its {@link Map} to
	...
	/// <summary> Return the list of boards as specified in the current controls
	/// 
	/// </summary>
	/// <returns>
	/// </returns>
	...
	/// <returns> true if multiple boards per map window are allowed
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public class SetBoards:Command
	{
		public SetBoards()
		{
			InitBlock();
	...
	private class Config:Configurer
	{
		...
		{
			public AnonymousClassPropertyChangeListener(Config enclosingInstance)
			{
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				...
				{
					this.title = ((System.String) evt.NewValue);
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener1(Config enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Config enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				if (evt.NewValue != null)
				{
					this.boardPrompt = ((System.String) evt.NewValue);
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener2(Config enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Config enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				if (evt.NewValue != null)
				{
					slotScale = ((System.Double) evt.NewValue);
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener3(Config enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Config enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				if (evt.NewValue != null)
				{
					psize.width = ((System.Int32) evt.NewValue);
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener4(Config enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Config enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				if (evt.NewValue != null)
				{
					psize.height = ((System.Int32) evt.NewValue);
				}
			}
		}
		...
		private class AnonymousClassActionListener
		{
			...
			{
				selectBoards(event_sender is System.Windows.Forms.Control?(System.Windows.Forms.Control) event_sender:null);
			}
		}
		...
		public Config():base(null, null)
		{
			...
			title = new StringConfigurer(null, Resources.getString("Editor.BoardPicker.dialog_title"), this.title); //$NON-NLS-1$
			...
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(title.Controls);
			prompt = new StringConfigurer(null, Resources.getString("Editor.BoardPicker.board_prompt"), this.boardPrompt); //$NON-NLS-1$
			prompt.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener1(this).propertyChange);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(prompt.Controls);
			scale = new DoubleConfigurer(null, Resources.getString("Editor.BoardPicker.cell_scale_factor"), slotScale); //$NON-NLS-1$
			scale.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener2(this).propertyChange);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(scale.Controls);
			width = new IntConfigurer(null, Resources.getString("Editor.BoardPicker.cell_width"), psize.width); //$NON-NLS-1$
			width.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener3(this).propertyChange);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(width.Controls);
			height = new IntConfigurer(null, Resources.getString("Editor.BoardPicker.cell_height"), psize.height); //$NON-NLS-1$
			height.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener4(this).propertyChange);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(height.Controls);
			selectButton = SupportClass.ButtonSupport.CreateStandardButton(Resources.getString("BoardPicker.select_default")); //$NON-NLS-1$
			selectButton.Click += new System.EventHandler(new AnonymousClassActionListener(this).actionPerformed);
			SupportClass.CommandManager.CheckCommand(selectButton);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(selectButton);
		}
	...
	*/
	...
	new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ Resources.getString(Editor.BoardPicker.dialog_title), Resources.getString(Editor.BoardPicker.board_prompt) //$NON-NLS-1$ //$NON-NLS-2$
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	});
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	} 
