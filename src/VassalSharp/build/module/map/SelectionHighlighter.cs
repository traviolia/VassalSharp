...
namespace VassalSharp.build.module.map
{
	...
	public class SelectionHighlighter:AbstractConfigurable, Highlighter
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.NAME_LABEL), Resources.getString("Editor.SelectionHighlight.active_property"), Resources.getString("Editor.SelectionHighlight.use_image"), Resources.getString("Editor.SelectionHighlight.border_color"), Resources.getString("Editor.SelectionHighlight.border_thickness"), Resources.getString("Editor.SelectionHighlight.image"), Resources.getString("Editor.SelectionHighlight.offset_x"), Resources.getString("Editor.SelectionHighlight.offset_y")};
			}
			
		}
		public const System.String NAME = "name";
		public const System.String MATCH = "match";
		public const System.String COLOR = "color";
		public const System.String THICKNESS = "thickness";
		public const System.String USE_IMAGE = "useImage";
		public const System.String IMAGE = "image";
		public const System.String X_OFFSET = "xoffset";
		public const System.String Y_OFFSET = "yoffset";
		protected internal PropertyExpression matchProperties = new PropertyExpression();
		protected internal System.Drawing.Color color = Color.RED;
		protected internal int thickness = 3;
		protected internal bool useImage = false;
		...
		public virtual void  draw(GamePiece p, System.Drawing.Graphics g, int x, int y, System.Windows.Forms.Control obs, double zoom)
		{
			...
			if (accept(p))
			{
				if (useImage)
				{
					...
					int x1 = x - (int) (imagePainter.ImageSize.Width * zoom / 2);
					...
					//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
					int y1 = y - (int) (imagePainter.ImageSize.Height * zoom / 2);
					imagePainter.draw(g, x1, y1, zoom, obs);
				}
				else
				{
					if (color.IsEmpty || thickness <= 0)
					{
						return ;
					}
		...
		public virtual System.Drawing.Rectangle boundingBox(GamePiece p)
		{
			...
			if (accept(p))
			{
				if (useImage)
				{
					...
					SupportClass.RectangleSupport.AddRectangleToRectangle(ref r, ImageUtils.getBounds(ref tempAux));
				}
				else
				{
		...
		protected internal virtual bool accept(GamePiece p)
		{
			return matchProperties.Null?true:matchProperties.accept(p);
		}
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, MATCH, USE_IMAGE, COLOR, THICKNESS, IMAGE, X_OFFSET, Y_OFFSET
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
