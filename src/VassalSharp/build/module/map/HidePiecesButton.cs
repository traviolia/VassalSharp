...
namespace VassalSharp.build.module.map
{
	...
	/// <summary> This removes all game pieces from the (@link Map)
	/// therefore providing an un-cluttered view.
	/// </summary>
	[Serializable]
	public class HidePiecesButton:System.Windows.Forms.Panel, AutoConfigurable, GameComponent, Drawable
	{
		static private System.Int32 state188;
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(HidePiecesButton enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(HidePiecesButton enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private HidePiecesButton enclosingInstance;
			public HidePiecesButton Enclosing_Instance
			{
				get
				{
			...
			{
				Enclosing_Instance.PiecesVisible = !Enclosing_Instance.piecesVisible;
			}
		}
		private static void  mouseDown(System.Object event_sender, System.Windows.Forms.MouseEventArgs e)
		{
			state188 = ((int) e.Button | (int) System.Windows.Forms.Control.ModifierKeys);
		}
		...
		virtual protected internal bool PiecesVisible
		{
			set
			{
				map.PiecesVisible = value;
				launch.setAttribute(LAUNCH_ICON, value?showingIcon:hiddenIcon);
				piecesVisible = value;
				map.repaint();
			}
		...
		virtual public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{BUTTON_TEXT, TOOLTIP, HOTKEY, SHOWING_ICON, HIDDEN_ICON};
			}
		...
		virtual public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.HidePieceButton.show_icon"), Resources.getString("Editor.HidePieceButton.hide_icon")};
			}
			
		}
		private const long serialVersionUID = 1L;
		
		protected internal bool piecesVisible = false;
		protected internal Map map;
		protected internal LaunchButton launch;
		protected internal System.String showingIcon;
		protected internal System.String hiddenIcon;
		protected internal ComponentI18nData myI18nData;
		public const System.String DEFAULT_SHOWING_ICON = "/images/globe_unselected.gif";
		public const System.String DEFAULT_HIDDEN_ICON = "/images/globe_selected.gif";
		
		public const System.String HOTKEY = "hotkey";
		public const System.String HIDDEN_ICON = "hiddenIcon";
		public const System.String SHOWING_ICON = "showingIcon";
		public const System.String LAUNCH_ICON = "icon";
		...
		public HidePiecesButton()
		{
			...
			MouseDown += new System.Windows.Forms.MouseEventHandler(VassalSharp.build.module.map.HidePiecesButton.mouseDown);
		}
		...
		public virtual void  setAttribute(System.String key, System.Object value_Renamed)
		{
			...
			{
				showingIcon = ((System.String) value_Renamed);
			}
			else if (HIDDEN_ICON.Equals(key))
			{
				hiddenIcon = ((System.String) value_Renamed);
			}
			else
			{
	...
	public class ShowingIconConfig : ConfigurerFactory
	{
	...
	public class HiddenIconConfig : ConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
