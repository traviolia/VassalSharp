...
namespace VassalSharp.build.module.map
{
	...
	/// <summary> Adds a button to the toolbar to manipulate Game Piece Layers
	/// 
	/// </summary>
	/// <author>  Brent Easton
	/// 
	/// </author>
	public class LayerControl:AbstractConfigurable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(LayerControl enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(LayerControl enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private LayerControl enclosingInstance;
			public LayerControl Enclosing_Instance
			{
				get
				{
		...
		virtual public LaunchButton LaunchButton
		{
			get
			{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.BUTTON_ICON), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.LayerControl.action"), Resources.getString("Editor.LayerControl.skip_layer"), Resources.getString("Editor.LayerControl.affect_layer")};
			}
		...
		public const System.String BUTTON_ICON = "icon";
		public const System.String BUTTON_HOTKEY = "hotkey";
		public const System.String COMMAND = "command";
		public const System.String SKIP = "skip";
		public const System.String LAYERS = "layers";
		
		public const System.String CMD_ROTATE_UP = "Rotate Layer Order Up";
		public const System.String CMD_ROTATE_DN = "Rotate Layer Order Down";
		public const System.String CMD_ENABLE = "Make Layer Active";
		public const System.String CMD_DISABLE = "Make Layer Inactive";
		public const System.String CMD_TOGGLE = "Switch Layer between Active and Inactive";
		public const System.String CMD_RESET = "Reset All Layers";
		
		protected internal LaunchButton launch_Renamed_Field;
		//UPGRADE_NOTE: Final was removed from the declaration of 'COMMANDS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal static readonly System.String[] COMMANDS = new System.String[]{CMD_ROTATE_UP, CMD_ROTATE_DN, CMD_RESET, CMD_ENABLE, CMD_DISABLE, CMD_TOGGLE};
		protected internal System.String command = CMD_RESET;
		protected internal bool skip = true;
		protected internal System.String[] layers = new System.String[0];
		protected internal LayeredPieceCollection pieceLayers;
		protected internal CompoundPieceCollection pieceCollection;
		
		public LayerControl()
		{
			InitBlock();
			launch_Renamed_Field = new LaunchButton("Reset Layers", TOOLTIP, BUTTON_TEXT, BUTTON_HOTKEY, BUTTON_ICON, new AnonymousClassActionListener(this));
		}
	...
	public class CommandConfig:StringEnum
	{
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ BUTTON_TEXT, TOOLTIP, BUTTON_ICON, BUTTON_HOTKEY, COMMAND, SKIP, LAYERS
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
