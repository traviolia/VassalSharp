...
using BooleanAndPieceFilter = VassalSharp.counters.BooleanAndPieceFilter;
...
namespace VassalSharp.build.module.map
{
	...
	/// <summary> Adds a button to a map window toolbar. Hitting the button applies a particular key command to all pieces on that map
	/// with a given name.
	/// </summary>
	public class MassKeyCommand:AbstractConfigurable, RecursionLimiter.Loopable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(MassKeyCommand enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(MassKeyCommand enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private MassKeyCommand enclosingInstance;
			public MassKeyCommand Enclosing_Instance
			{
				get
				{
		...
		virtual public PropertySource PropertySource
		{
			set
			{
				...
				globalCommand.PropertySource = value;
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				if (condition == null)
				{
					return new System.String[]{Resources.getString(Resources.DESCRIPTION), Resources.getString("Editor.MassKey.key"), Resources.getString("Editor.MassKey.match"), Resources.getString("Editor.MassKey.counters"), Resources.getString("Editor.MassKey.deck_content"), Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.BUTTON_ICON), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.MassKey.suppress"), Resources.getString("Editor.report_format")};
				}
				else
				{
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, KEY_COMMAND, PROPERTIES_FILTER, SINGLE_MAP, DECK_COUNT, BUTTON_TEXT, TOOLTIP, ICON, HOTKEY, REPORT_SINGLE, REPORT_FORMAT, CONDITION, CHECK_VALUE, CHECK_PROPERTY, AFFECTED_PIECE_NAMES};
			}
			
		}
		public const System.String DEPRECATED_NAME = "text";
		...
		public const System.String HOTKEY = "buttonHotkey";
		public const System.String KEY_COMMAND = "hotkey";
		public const System.String AFFECTED_PIECE_NAMES = "names";
		public const System.String PROPERTIES_FILTER = "filter";
		public const System.String REPORT_SINGLE = "reportSingle";
		public const System.String REPORT_FORMAT = "reportFormat";
		public const System.String CONDITION = "condition";
		public const System.String DECK_COUNT = "deckCount";
		private const System.String IF_ACTIVE = "If layer is active";
		private const System.String IF_INACTIVE = "If layer is inactive";
		private const System.String ALWAYS = "Always";
		public const System.String CHECK_PROPERTY = "property";
		public const System.String CHECK_VALUE = "propValue";
		public const System.String SINGLE_MAP = "singleMap";
		protected internal LaunchButton launch;
		protected internal NamedKeyStroke stroke = new NamedKeyStroke();
		protected internal System.String[] names = new System.String[0];
		protected internal System.String condition;
		protected internal System.String checkProperty;
		protected internal System.String checkValue;
		...
		protected internal bool singleMap = true;
		...
		public override void  addTo(Buildable parent)
		{
			...
			if (parent is ToolBarComponent)
			{
				...
				((ToolBarComponent) parent).ToolBar.Buttons.Add(temp_ToolBarButton);
				if (launch.Image != null)
				{
					((ToolBarComponent) parent).ToolBar.ImageList.Images.Add(launch.Image);
					temp_ToolBarButton.ImageIndex = ((ToolBarComponent) parent).ToolBar.ImageList.Images.Count - 1;
				}
		...
		public class Prompt:StringEnum
		{
			...
			{
				return new System.String[]{VassalSharp.build.module.map.MassKeyCommand.ALWAYS, VassalSharp.build.module.map.MassKeyCommand.IF_ACTIVE, VassalSharp.build.module.map.MassKeyCommand.IF_INACTIVE};
			}
		}
	...
	public class ReportFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			return new PlayerIdFormattedStringConfigurer(key, name, new System.String[0]);
		}
	}
	public class DeckPolicyConfig:Configurer, ConfigurerFactory
	{
		...
		{
			public AnonymousClassPropertyChangeListener(DeckPolicyConfig enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(DeckPolicyConfig enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private DeckPolicyConfig enclosingInstance;
			public DeckPolicyConfig Enclosing_Instance
			{
				get
				{
					return enclosingInstance;
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				...
				SupportClass.SetPropertyAsVirtual(Enclosing_Instance.intConfig.Controls, "Visible", VassalSharp.build.module.map.DeckPolicyConfig.FIXED.Equals(Enclosing_Instance.typeConfig.ValueString));
				...
				System.Windows.Forms.Form w = (System.Windows.Forms.Form) Enclosing_Instance.intConfig.Controls.Parent;
				if (w != null)
				{
		...
		{
			public AnonymousClassPropertyChangeListener1(DeckPolicyConfig enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(DeckPolicyConfig enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs evt)
			{
				setValue(Enclosing_Instance.IntValue);
			}
		}
		...
		virtual public int IntValue
		{
			get
			{
				System.String type = typeConfig.ValueString;
				if (ALL.Equals(type))
				{
					return - 1;
				}
		...
		protected internal const System.String FIXED = "Fixed number of pieces";
		protected internal const System.String NONE = "No pieces";
		protected internal const System.String ALL = "All pieces";
		protected internal IntConfigurer intConfig;
		protected internal StringEnumConfigurer typeConfig;
		protected internal System.Windows.Forms.Label prompt;
		//UPGRADE_ISSUE: Class 'javax.swing.Box' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBox'"
		protected internal Box controls;
		
		public DeckPolicyConfig():base(null, "")
		{
			typeConfig = new StringEnumConfigurer(null, "", new System.String[]{ALL, NONE, FIXED});
			...
			temp_label.Text = "Within a Deck, apply to:  ";
			prompt = temp_label;
			...
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(intConfig.Controls);
			...
			//UPGRADE_TODO: Interface 'java.beans.PropertyChangeListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
			PropertyChangeListener l2 = new AnonymousClassPropertyChangeListener1(this);
			typeConfig.PropertyChange += new SupportClass.PropertyChangeEventHandler(l.propertyChange);
			typeConfig.PropertyChange += new SupportClass.PropertyChangeEventHandler(l2.propertyChange);
			intConfig.PropertyChange += new SupportClass.PropertyChangeEventHandler(l2.propertyChange);
		}
		...
		public override void  setValue(System.Object o)
		{
			if (typeConfig != null)
			{
				typeConfig.Frozen = true;
				intConfig.Frozen = true;
				if (o is System.Int32)
				{
					...
					switch ((i))
					{
						...
						default: 
							...
							intConfig.setValue((System.Object) i);
							break;
					...
					//UPGRADE_TODO: 'System.Windows.Forms.Application.Run' must be called to start a main form. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1135'"
					//UPGRADE_NOTE: Since the declaration of the following entity is not virtual in .NET the modifier new was added. References to it may have been changed to InvokeMethodAsVirtual, GetPropertyAsVirtual or SetPropertyAsVirtual. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1195'"
					SupportClass.SetPropertyAsVirtual(intConfig.Controls, "Visible", FIXED.Equals(typeConfig.ValueString));
				}
			}
			base.setValue(o);
			if (typeConfig != null)
			{
				typeConfig.Frozen = false;
				intConfig.Frozen = false;
			}
		}
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setLaunchButton(LaunchButton launch)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		this.launch = launch;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
