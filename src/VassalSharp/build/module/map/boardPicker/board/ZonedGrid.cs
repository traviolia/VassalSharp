...
using ZoneHighlight = VassalSharp.build.module.map.boardPicker.board.mapgrid.ZoneHighlight;
using ZonedGridHighlighter = VassalSharp.build.module.map.boardPicker.board.mapgrid.ZonedGridHighlighter;
using Configurer = VassalSharp.configure.Configurer;
using Resources = VassalSharp.i18n.Resources;
namespace VassalSharp.build.module.map.boardPicker.board
{
	
	/// <summary> Map Grid that contains any number of {@link VassalSharp.build.module.map.boardPicker.board.mapgrid.Zone}s against a background {@link MapGrid}</summary>
	public class ZonedGrid:AbstractConfigurable, GeometricGrid, GridContainer
	{
		public ZonedGrid()
		{
			InitBlock();
		...
		virtual public GridContainer Container
		{
			get
			{
				return container;
		...
		virtual public Map Map
		{
			get
			{
				return getBoard() == null?null:getBoard().Map;
			}
			
		}
		virtual public MapGrid Grid
		{
			set
			{
				background = value;
		...
		protected internal MapGrid background;
		protected internal GridContainer container;
		protected internal ZonedGridHighlighter zoneHighlighters;
		...
		public virtual bool contains(ref System.Drawing.Point p)
		{
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			return container.contains(ref p);
		}
		
		public virtual void  removeGrid(MapGrid grid)
		{
			if (background == grid)
			{
				background = null;
	...
	*/
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setBackgroundGrid(MapGrid background)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	{ 
		super.build(e);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	if(getComponentsOf(ZonedGridHighlighter.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class).isEmpty())
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setZoneHighlighter(ZonedGridHighlighter zh)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		zoneHighlighters = zh;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
