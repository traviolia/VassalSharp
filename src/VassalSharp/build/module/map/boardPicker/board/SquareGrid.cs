...
namespace VassalSharp.build.module.map.boardPicker.board
{
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.AutoConfigurable;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.module.map.boardPicker.board.mapgrid.SquareGridNumbering;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.StringEnum;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.VisibilityCondition;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.i18n.Resources;
	
	public class SquareGrid:AbstractConfigurable, GeometricGrid, GridEditor.EditableGrid
	{
		public SquareGrid()
		{
			InitBlock();
		...
		virtual public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{X0, Y0, DX, DY, RANGE, SNAP_TO, EDGES, CORNERS, VISIBLE, DOTS_VISIBLE, COLOR};
			}
		...
		virtual public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString("Editor.Grid.x_offset"), Resources.getString("Editor.Grid.y_offset"), Resources.getString("Editor.RectangleGrid.width"), Resources.getString("Editor.RectangleGrid.height"), Resources.getString("Editor.RectangleGrid.range_method"), Resources.getString("Editor.Grid.snap"), Resources.getString("Editor.Grid.edges"), Resources.getString("Editor.RectangleGrid.corners"), Resources.getString("Editor.Grid.show_grid"), Resources.getString("Editor.Grid.center_dots"), Resources.getString(Resources.COLOR_LABEL)};
			}
			
		}
		protected internal double dx = 48.0;
		protected internal double dy = 48.0;
		protected internal int snapScale = 0;
		protected internal Point origin = new Point(24, 24);
		...
		protected internal SquareGridEditor gridEditor;
		protected internal System.String rangeOption = RANGE_METRIC;
		...
		public virtual void  setOrigin(Point p)
		{
			origin.x = p.x;
			origin.y = p.y;
		}
		
		public virtual GridContainer getContainer()
		{
			return container;
		}
		...
		public const System.String RANGE = "range"; //$NON-NLS-1$
		public const System.String RANGE_MANHATTAN = "Manhattan"; //$NON-NLS-1$
		public const System.String RANGE_METRIC = "Metric"; //$NON-NLS-1$
		public const System.String SNAP_TO = "snapTo"; //$NON-NLS-1$
		
		public class RangeOptions:StringEnum
		{
			public virtual System.String[] getValidValues(AutoConfigurable target)
			{
				return new System.String[]{VassalSharp.build.module.map.boardPicker.board.SquareGrid.RANGE_METRIC, VassalSharp.build.module.map.boardPicker.board.SquareGrid.RANGE_MANHATTAN};
			}
		}
	...
	/// <summary> Return the Shape of a single grid square</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void reverse(Point p, Rectangle bounds)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary>Draw the grid, if visible, and accompanying numbering, if set </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary>Draw the grid even if not marked visible </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void forceDraw(Graphics g, Rectangle bounds, Rectangle visibleRect, double scale, boolean reversed)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	[Serializable]
	public class SquareGridEditor:GridEditor
	{
		private const long serialVersionUID = 1L;
		
		public SquareGridEditor(GridEditor.EditableGrid grid):base(grid)
		{
		}
		...
		*/
		public override void  calculate()
		{
			...
			if ((isPerpendicular(ref hp1, ref hp2) && isPerpendicular(ref hp1, ref hp3) && !isPerpendicular(ref hp2, ref hp3)) || (isPerpendicular(ref hp2, ref hp1) && isPerpendicular(ref hp2, ref hp3) && !isPerpendicular(ref hp1, ref hp3)) || (isPerpendicular(ref hp3, ref hp1) && isPerpendicular(ref hp3, ref hp2) && !isPerpendicular(ref hp1, ref hp2)))
			{
