...
namespace VassalSharp.build.module.map.boardPicker.board.mapgrid
{
	...
	/// <summary> Abstract base class for grid numbering classes for hexagonal and rectangular grids</summary>
	public abstract class RegularGridNumbering:AbstractConfigurable, GridNumbering
	{
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{FIRST, SEP, H_TYPE, H_LEADING, H_OFF, H_DESCEND, V_TYPE, V_LEADING, V_OFF, V_DESCEND, LOCATION_FORMAT, VISIBLE, FONT_SIZE, COLOR, ROTATE_TEXT, H_DRAW_OFF, V_DRAW_OFF};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Order:  ", "Separator:  ", "Horizontal numbering:  ", "Leading zeros in horizontal:  ", "Starting number in horizontal:  ", "Horizontal numbering descending?", "Vertical numbering:  ", "Leading zeros in vertical:  ", "Starting number in vertical:  ", "Vertical numbering descending?", "Location format:  ", "Draw Numbering?", "Font size:  ", "Color:  ", "Rotate text (Degrees):  ", "Text X offset:  ", "Text Y offset:  "};
			}
		...
		protected internal char first = 'H';
		protected internal System.String sep = "";
		protected internal char hType = 'N';
		protected internal char vType = 'N';
		protected internal int hLeading = 1;
		protected internal int vLeading = 1;
		protected internal int hOff = 1;
		protected internal int vOff = 1;
		protected internal bool hDescending = false;
		protected internal bool vDescending = false;
		...
		protected internal int rotateTextDegrees = 0;
		protected internal int hDrawOff = 0;
		protected internal int vDrawOff = 0;
		protected internal System.Windows.Forms.Control visualizer;
		protected internal System.String locationFormat = "$" + GRID_LOCATION + "$";
		protected internal FormattedString format = new FormattedString();
		
		public const System.String FIRST = "first";
		public const System.String SEP = "sep";
		public const System.String H_TYPE = "hType";
		public const System.String V_TYPE = "vType";
		public const System.String H_LEADING = "hLeading";
		public const System.String V_LEADING = "vLeading";
		public const System.String H_OFF = "hOff";
		public const System.String V_OFF = "vOff";
		public const System.String V_DESCEND = "vDescend";
		public const System.String H_DESCEND = "hDescend";
		public const System.String FONT_SIZE = "fontSize";
		public const System.String COLOR = "color";
		public const System.String VISIBLE = "visible";
		public const System.String ROTATE_TEXT = "rotateText";
		public const System.String H_DRAW_OFF = "hDrawOff";
		public const System.String V_DRAW_OFF = "vDrawOff";
		public const System.String LOCATION_FORMAT = "locationFormat";
		public const System.String GRID_LOCATION = "gridLocation";
		public const System.String ROW = "row";
		public const System.String COLUMN = "column";
		
		public override System.String getAttributeValueString(System.String key)
		{
			if (FIRST.Equals(key))
			{
				return System.Convert.ToString(first);
			}
			...
			{
				return System.Convert.ToString(hType);
			}
			else if (V_TYPE.Equals(key))
			{
				return System.Convert.ToString(vType);
			}
			else if (H_LEADING.Equals(key))
			{
				return System.Convert.ToString(hLeading);
			}
			else if (V_LEADING.Equals(key))
			{
				return System.Convert.ToString(vLeading);
			}
			else if (H_OFF.Equals(key))
			{
				return System.Convert.ToString(hOff);
			}
			else if (V_OFF.Equals(key))
			{
				return System.Convert.ToString(vOff);
			}
			else if (H_DESCEND.Equals(key))
			{
				return System.Convert.ToString(hDescending);
			}
			else if (V_DESCEND.Equals(key))
			{
				return System.Convert.ToString(vDescending);
			}
			else if (FONT_SIZE.Equals(key))
			{
				return System.Convert.ToString(fontSize);
			}
			else if (COLOR.Equals(key))
			{
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				return ColorConfigurer.colorToString(ref color);
			}
			else if (VISIBLE.Equals(key))
			{
				return System.Convert.ToString(visible);
			}
			...
			{
				return System.Convert.ToString(rotateTextDegrees);
			}
			else if (H_DRAW_OFF.Equals(key))
			{
				return System.Convert.ToString(hDrawOff);
			}
			else if (V_DRAW_OFF.Equals(key))
			{
				return System.Convert.ToString(vDrawOff);
			}
			else
			{
				return null;
		...
		public override void  setAttribute(System.String key, System.Object value_Renamed)
		{
			if (FIRST.Equals(key))
			{
				first = ((System.String) value_Renamed)[0];
			}
			else if (SEP.Equals(key))
			{
				sep = ((System.String) value_Renamed);
			}
			else if (H_TYPE.Equals(key))
			{
				hType = ((System.String) value_Renamed)[0];
			}
			else if (V_TYPE.Equals(key))
			{
				vType = ((System.String) value_Renamed)[0];
			}
			else if (H_LEADING.Equals(key))
			{
				...
				hLeading = ((System.Int32) value_Renamed);
			}
			else if (V_LEADING.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				vLeading = ((System.Int32) value_Renamed);
			}
			else if (H_OFF.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				hOff = ((System.Int32) value_Renamed);
			}
			else if (V_OFF.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				vOff = ((System.Int32) value_Renamed);
			}
			else if (H_DESCEND.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				hDescending = ((System.Boolean) value_Renamed);
			}
			else if (V_DESCEND.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				vDescending = ((System.Boolean) value_Renamed);
			}
			else if (FONT_SIZE.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				fontSize = ((System.Int32) value_Renamed);
			}
			else if (COLOR.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				color = (System.Drawing.Color) value_Renamed;
			}
			else if (VISIBLE.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				visible = ((System.Boolean) value_Renamed);
			}
			else if (LOCATION_FORMAT.Equals(key))
			{
				locationFormat = ((System.String) value_Renamed);
			}
			else if (ROTATE_TEXT.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				rotateTextDegrees = ((System.Int32) value_Renamed);
			}
			else if (H_DRAW_OFF.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				hDrawOff = ((System.Int32) value_Renamed);
			}
			else if (V_DRAW_OFF.Equals(key))
			{
				if (value_Renamed is System.String)
				...
				vDrawOff = ((System.Int32) value_Renamed);
			}
		}
		
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public abstract int getRow(ref System.Drawing.Point p);
		
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public abstract int getColumn(ref System.Drawing.Point p);
		...
		public class F:StringEnum
		{
			public override System.String[] getValidValues(AutoConfigurable target)
			{
				return new System.String[]{"Horizontal first", "Vertical first"};
			}
		}
		
		public class T:StringEnum
		{
			public override System.String[] getValidValues(AutoConfigurable target)
			{
				return new System.String[]{"Numerical", "Alphabetic"};
			}
		}
		
		public class LocationFormatConfig : ConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
				return new FormattedStringConfigurer(key, name, new System.String[]{VassalSharp.build.module.map.boardPicker.board.mapgrid.RegularGridNumbering.GRID_LOCATION, VassalSharp.build.module.map.boardPicker.board.mapgrid.RegularGridNumbering.ROW, VassalSharp.build.module.map.boardPicker.board.mapgrid.RegularGridNumbering.COLUMN});
			}
		}
		
		public class R:StringEnum
		{
			public override System.String[] getValidValues(AutoConfigurable target)
			{
				return new System.String[]{"0", "90", "180", "270"};
			}
		}
		...
		class
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public abstract void  draw(System.Drawing.Graphics param1, ref System.Drawing.Rectangle param2, ref System.Drawing.Rectangle param3, double param4, bool param5);
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public abstract System.String locationName(ref System.Drawing.Point param1);
		public abstract System.Drawing.Point getLocation(System.String param1);
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public abstract System.String localizedLocationName(ref System.Drawing.Point param1);
	}
	
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
	
	/// <summary> Return a component that shows how the grid will draw itself</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	abstract JComponent getGridVisualizer();
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	abstract Point getCenterPoint(int col, int row);
