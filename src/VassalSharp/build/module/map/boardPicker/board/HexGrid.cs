...
namespace VassalSharp.build.module.map.boardPicker.board
{
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.AbstractConfigurable;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.Buildable;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.module.documentation.HelpFile;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.module.map.boardPicker.board.mapgrid.GridContainer;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.module.map.boardPicker.board.mapgrid.GridNumbering;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.build.module.map.boardPicker.board.mapgrid.HexGridNumbering;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.AutoConfigurer;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.ColorConfigurer;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.Configurer;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.configure.VisibilityCondition;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.i18n.Resources;
	
	/// <summary> A Hexgrid is a map grid composed of hexes.</summary>
	public class HexGrid:AbstractConfigurable, GeometricGrid, GridEditor.EditableGrid
	{
		public HexGrid()
		{
			InitBlock();
		...
		virtual public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{SIDEWAYS, X0, Y0, DY, DX, SNAP_TO, EDGES, CORNERS, VISIBLE, DOTS_VISIBLE, COLOR};
			}
		...
		virtual public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString("Editor.HexGrid.sideways"), Resources.getString("Editor.Grid.x_offset"), Resources.getString("Editor.Grid.y_offset"), Resources.getString("Editor.HexGrid.hex_height"), Resources.getString("Editor.HexGrid.hex_width"), Resources.getString("Editor.Grid.snap"), Resources.getString("Editor.Grid.edges"), Resources.getString("Editor.HexGrid.vertices"), Resources.getString("Editor.Grid.show_grid"), Resources.getString("Editor.Grid.center_dots"), Resources.getString(Resources.COLOR_LABEL)};
			}
			
		}
		protected internal Point origin = new Point(0, 32);
		
		protected internal double dx;
		protected internal double dy;
		protected internal int snapScale = 0;
		
		protected internal GridContainer container;
		
		protected internal GridNumbering numbering;
		
		protected internal bool visible = false;
		protected internal bool dotsVisible = false;
		protected internal bool edgesLegal = false;
		protected internal bool cornersLegal = false;
		protected internal Color color = Color.black;
		protected internal bool sideways = false;
		protected internal bool snapTo = true;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected Map < Integer, Area > shapeCache = new HashMap < Integer, Area >();
		protected internal HexGridEditor gridEditor;
		
		public const System.String X0 = "x0"; //$NON-NLS-1$
		public const System.String Y0 = "y0"; //$NON-NLS-1$
		public const System.String DY = "dy"; //$NON-NLS-1$
		public const System.String DX = "dx"; //$NON-NLS-1$
		public const System.String VISIBLE = "visible"; //$NON-NLS-1$
		public const System.String DOTS_VISIBLE = "dotsVisible"; //$NON-NLS-1$
		public const System.String CORNERS = "cornersLegal"; //$NON-NLS-1$
		public const System.String EDGES = "edgesLegal"; //$NON-NLS-1$
		public const System.String SIDEWAYS = "sideways"; //$NON-NLS-1$
		public const System.String COLOR = "color"; //$NON-NLS-1$
		public const System.String SNAP_SCALE = "snapscale"; //$NON-NLS-1$
		public const System.String SNAP_TO = "snapTo"; //$NON-NLS-1$
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'sqrt3_2 '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal static readonly double sqrt3_2 = sqrt(3) / 2.0;
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setEdgesLegal(boolean legal)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		edgesLegal = legal;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setCornersLegal(boolean legal)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		cornersLegal = legal;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the nearest hex center
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the nearest hex center or hexside
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the nearest hex center or vertex
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Return the Shape of a single hex</summary>
	/// <param name="centerX">X co-ord of hex centre
	/// </param>
	/// <param name="centerY">Y co-ord of hex centre
	/// </param>
	/// <returns> Hex Shape
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary>Draw the grid, if visible, and the accompanying numbering </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void draw(Graphics g, Rectangle bounds, Rectangle visibleRect, double zoom, boolean reversed)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(visible)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary>Draw the grid even if set to be not visible </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void forceDraw(Graphics g, Rectangle bounds, Rectangle visibleRect, double zoom, boolean reversed)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setGridNumbering(GridNumbering numbering)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	[Serializable]
	public class HexGridEditor:GridEditor
	{
		private const long serialVersionUID = 1L;
		
		public HexGridEditor(GridEditor.EditableGrid grid):base(grid)
		{
		}
		...
		*/
		public override void  calculate()
		{
			...
			*/
			...
			if (isPerpendicular(ref hp1, ref hp2))
			{
			...
			{
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				if (isPerpendicular(ref hp1, ref hp3))
				{
				...
				{
					//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
					if (isPerpendicular(ref hp2, ref hp3))
					{
		...
		*/
		protected internal virtual void  calculate_step2(Point p1, Point p2, Point p3)
		{
		...
		protected internal virtual Point reverse(Point p)
		{
			return new Point(p.y, p.x);
		}
		
		protected internal virtual void  check(bool sideways, Point p1, Point p2, Point p3)
		{
		...
		protected internal virtual void  checkEnd(bool sideways, Point p1, Point p2, Point p3)
		{
		...
		protected internal virtual void  setMetrics(int width, int height, int xoff, int yoff, bool b)
		{
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setSnapScale(int snapScale)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
