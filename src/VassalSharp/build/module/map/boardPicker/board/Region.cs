...
namespace VassalSharp.build.module.map.boardPicker.board
{
	...
	public class Region:AbstractConfigurable
	{
		...
		virtual public System.Drawing.Point Origin
		{
			get
			{
				return origin;
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, X, Y};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.NAME_LABEL), Resources.getString("Editor.Region.x_coord"), Resources.getString("Editor.Region.y_coord")};
			}
		...
		private System.Drawing.Rectangle selectionRect = new System.Drawing.Rectangle();
		...
		public Region(ref System.Drawing.Point p):this()
		{
			origin = p;
		}
		...
		{
			InitBlock();
			setConfigureName(r.Name);
			origin.X = r.Origin.X;
			origin.Y = r.Origin.Y;
			myGrid = r.myGrid;
		}
		
		public virtual void  moveOrigin(int dx, int dy)
		{
			origin.Offset(dx, dy);
		}
		
		public const System.String NAME = "name"; //$NON-NLS-1$
		public const System.String X = "originx"; //$NON-NLS-1$
		public const System.String Y = "originy"; //$NON-NLS-1$
	...
	*/
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void move(int dx, int dy, JComponent c)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	*/
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void draw(Graphics g, Rectangle bounds, Rectangle visibleRect, double scale, boolean reversed, int xOffset, int yOffset)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
