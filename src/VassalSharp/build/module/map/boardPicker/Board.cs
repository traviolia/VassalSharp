...
using Repainter = VassalSharp.tools.imageop.Repainter;
...
namespace VassalSharp.build.module.map.boardPicker
{
	...
	public class Board:AbstractConfigurable, GridContainer
	{
		...
		/// <returns> this <code>Board</code>'s {@link Map}.
		...
		virtual public System.String LocalizedName
		{
			get
			{
				...
				System.String s = LocalizedConfigureName;
				return s != null?s:"";
			}
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, IMAGE, REVERSIBLE, WIDTH, HEIGHT, COLOR};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.NAME_LABEL), Resources.getString("Editor.Board.image"), Resources.getString("Editor.Board.reverse"), Resources.getString("Editor.Board.width"), Resources.getString("Editor.Board.height"), Resources.getString(Resources.COLOR_LABEL)};
			}
		...
		/// <summary> A Board is a piece of a Map.
		...
		protected internal System.Drawing.Rectangle boundaries = new System.Drawing.Rectangle(0, 0, 500, 500);
		protected internal System.String imageFile;
		protected internal bool reversible = false;
		protected internal bool reversed = false;
		protected internal bool fixedBoundaries = false;
		...
		protected internal double magnification = 1.0;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		Deprecated
		protected internal System.String boardName = "Board 1";
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		Deprecated
		protected internal System.Drawing.Image boardImage;
		
		protected internal SourceOp boardImageOp;
		protected internal ScaleOp scaledImageOp;
		...
		{
			validator = new SingleChildInstance(this, typeof(MapGrid));
		}
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void draw(Graphics g, int x, int y, double zoom, Component obs)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		drawRegion(g, 
		new Point(x, y), 
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawTile(Graphics g, Future < BufferedImage > fim, 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawRegion(final Graphics g, 
	...
	/// <summary> If this board is reversed, return the location in un-reversed coordinates</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> If this board is reversed, return the location in reversed coordinates</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> Position of this board relative to the other boards (0,0) is the upper left, (0,1) is to the right, etc.
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> The (read-only) boundaries of this Board within the overall Map
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Translate the location of the board by the given number of pixels
	/// 
	/// </summary>
	/// <seealso cref="bounds()">
	/// </seealso>
	...
	/// <summary> Set the location of this board
	/// 
	/// </summary>
	/// <seealso cref="bounds()">
	/// </seealso>
	...
	/// <summary> Removes board images from the {@link VassalSharp.tools.DataArchive} cache</summary>
	...
	/// <summary> Cleans up {@link Board}s (by invoking {@link Board#cleanUp}) when a
	/// game is closed
	/// </summary>
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	Deprecated
	public class Cleanup : GameComponent
	{
		...
		/// <summary> Mark this board as needing to be cleaned up when the game is closed
		/// 
		/// </summary>
		/// <param name="b">
		/// </param>
