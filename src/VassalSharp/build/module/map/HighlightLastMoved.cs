...
namespace VassalSharp.build.module.map
{
	...
	public class HighlightLastMoved:AbstractConfigurable, Drawable, GameComponent
	{
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString("Editor.HighlightLastMoved.enabled"), Resources.getString(Resources.COLOR_LABEL), Resources.getString("Editor.HighlightLastMoved.thickness")};
			}
			
		}
		public const System.String ENABLED = "enabled";
		public const System.String COLOR = "color";
		public const System.String THICKNESS = "thickness";
		
		protected internal ColoredBorder highlighter;
		protected internal GamePiece lastMoved;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		protected internal bool currentlyEnabled;
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setLastMovedPiece(GamePiece p)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(currentlyEnabled)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
