...
//UPGRADE_TODO: The type 'javax.imageio.ImageWriter' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using ImageWriter = javax.imageio.ImageWriter;
//UPGRADE_TODO: The type 'javax.imageio.event_Renamed.IIOWriteProgressListener' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using IIOWriteProgressListener = javax.imageio.event_Renamed.IIOWriteProgressListener;
//UPGRADE_TODO: The type 'javax.imageio.stream.ImageOutputStream' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
...
using PNGFileFilter = VassalSharp.tools.filechooser.PNGFileFilter;
using IOUtils = VassalSharp.tools.io.IOUtils;
using ProgressDialog = VassalSharp.tools.swing.ProgressDialog;
namespace VassalSharp.build.module.map
{
	
	// FIXME: Replace this in 3.2 with tiling code.
	
	/// <summary> This allows the user to capture a snapshot of the entire map into
	/// a PNG file.
	/// </summary>
	public class ImageSaver:AbstractConfigurable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(ImageSaver enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(ImageSaver enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private ImageSaver enclosingInstance;
			public ImageSaver Enclosing_Instance
			{
				get
				{
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{BUTTON_TEXT, TOOLTIP, ICON_NAME, HOTKEY};
			}
		...
		//UPGRADE_NOTE: The initialization of  'logger' was moved to static method 'VassalSharp.build.module.map.ImageSaver'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private static readonly Logger logger;
		
		protected internal LaunchButton launch;
		protected internal Map map;
		protected internal bool promptToSplit = false;
		protected internal const System.String DEFAULT_ICON = "/images/camera.gif";
		
		protected internal static ProgressDialog dialog;
		...
		public ImageSaver(Map m):base()
		{
			InitBlock();
			map = m;
		}
		
		/// <summary> Expects to be added to a {@link Map}. Adds a button to the map window
		...
		static ImageSaver()
		{
			logger = LoggerFactory.getLogger(typeof(ImageSaver));
		}
	}
	...
	/// <summary> Write a PNG-encoded snapshot of the map.</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void writeMapAsImage()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	final Frame frame =
	(Frame) SwingUtilities.getAncestorOfClass(Frame.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class, map.getView());
	...
	/// <summary> Helper method for writing images.
	/// 
	/// </summary>
	/// <param name="file">the file to write
	/// </param>
	/// <param name="x">the left edge of the map area to write
	/// </param>
	/// <param name="y">the top edge of the map area to write
	/// </param>
	/// <param name="w">the width of the map area to write
	/// </param>
	/// <param name="h">the height of the map area to write
	/// </param>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void writeMapRectAsImage(File file, int x, int y, int w, int h)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	private class SnapshotTask:SwingWorker
	{
		...
		{
			public AnonymousClassRunnable(System.IO.FileInfo f, SnapshotTask enclosingInstance)
			{
				InitBlock(f, enclosingInstance);
			}
			private void  InitBlock(System.IO.FileInfo f, SnapshotTask enclosingInstance)
			{
				this.f = f;
				this.enclosingInstance = enclosingInstance;
			}
			//UPGRADE_NOTE: Final variable f was copied into class AnonymousClassRunnable. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1023'"
			private System.IO.FileInfo f;
			private SnapshotTask enclosingInstance;
			public SnapshotTask Enclosing_Instance
			{
				get
				{
					return enclosingInstance;
			...
			{
				dialog.setLabel("Saving map image as " + f.Name + ":");
				dialog.setIndeterminate(true);
			}
		}
		...
		{
			public AnonymousClassRunnable1(SnapshotTask enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SnapshotTask enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private SnapshotTask enclosingInstance;
		...
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassIIOWriteProgressListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassIIOWriteProgressListener : IIOWriteProgressListener
		{
			public AnonymousClassIIOWriteProgressListener(SnapshotTask enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SnapshotTask enclosingInstance)
			...
			public virtual void  imageComplete(ImageWriter source)
			{
			}
			
			public virtual void  imageProgress(ImageWriter source, float percentageDone)
			{
				...
				setProgress((int) System.Math.Round((double) ((100 * Enclosing_Instance.tilesDone + percentageDone) / Enclosing_Instance.tiles)));
			}
			
			public virtual void  imageStarted(ImageWriter source, int imageIndex)
			{
			}
			
			public virtual void  thumbnailComplete(ImageWriter source)
			{
			}
			
			public virtual void  thumbnailProgress(ImageWriter source, float percentageDone)
			{
			}
			
			public virtual void  thumbnailStarted(ImageWriter source, int imageIndex, int thumbnailIndex)
			{
			}
			
			public virtual void  writeAborted(ImageWriter source)
			{
			}
		}
		private void  InitBlock()
		{
			bg = ColorConfigurer.stringToColor(map.getAttributeValueString(Map.BACKGROUND_COLOR));
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		< Void, Void >
		private int tiles;
		...
		//UPGRADE_NOTE: The initialization of  'bg' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public SnapshotTask(System.IO.FileInfo file, int x, int y, int w, int h)
		{
			InitBlock();
			this.file = file;
			this.x = x;
		...
		private void  writeImage(System.IO.FileInfo f, System.Drawing.Bitmap img, ref System.Drawing.Rectangle r)
		{
			...
			if (tmpBool)
			{
				if (!SupportClass.FileCanWrite(f))
				{
					throw new System.IO.IOException("Cannot write to the file \"" + f.FullName + "\"");
				}
			}
			else
			{
				...
				System.IO.FileInfo p = new System.IO.FileInfo(f.DirectoryName);
				if (System.IO.Directory.Exists(p.FullName) && !SupportClass.FileCanWrite(p))
				{
					throw new System.IO.IOException("Cannot write to the directory \"" + p.FullName + "\"");
				}
			}
			...
			SwingUtilities.invokeLater(new AnonymousClassRunnable(f, this));
			...
			//UPGRADE_NOTE: Final was removed from the declaration of 'oc '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			System.Drawing.Color oc = SupportClass.GraphicsManager.manager.GetColor(g);
			SupportClass.GraphicsManager.manager.SetColor(g, bg);
			g.FillRectangle(SupportClass.GraphicsManager.manager.GetPaint(g), 0, 0, img.Width, img.Height);
			SupportClass.GraphicsManager.manager.SetColor(g, oc);
			
			g.TranslateTransform((System.Single) (- r.X), (System.Single) (- r.Y));
			...
			//UPGRADE_NOTE: Final was removed from the declaration of 'iw '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			ImageWriter iw = ImageIO.getImageWritersByFormatName("png").next();
			iw.addIIOWriteProgressListener(new AnonymousClassIIOWriteProgressListener(this));
			...
			try
			{
				...
				if (os == null)
				{
					throw new System.IO.IOException("Failed to write file " + f.FullName);
				}
		...
		public virtual System.Void doInBackground()
		{
			...
			while ((long) tw * (long) th > System.Int32.MaxValue / 4)
			{
				if (tw > th)
				{
					//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
					tw = (int) System.Math.Ceiling(tw / 2.0);
				}
				else
				{
					//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
					th = (int) System.Math.Ceiling(th / 2.0);
				}
			}
			...
			while (img == null)
			{
				try
				{
					img = new System.Drawing.Bitmap(tw, th, (System.Drawing.Imaging.PixelFormat) System.Drawing.Imaging.PixelFormat.Format32bppArgb);
				}
			...
			if (tw == w && th == h)
			{
				...
				tiles = 1;
				System.Drawing.Rectangle tempAux = new System.Drawing.Rectangle(0, 0, w, h);
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				writeImage(file, img, ref tempAux);
			}
			else
			{
				...
				if (s.EndsWith(".png"))
				{
					base_Renamed = s.Substring(0, (s.LastIndexOf('.')) - (0));
					suffix = ".png";
				}
				else
				{
				...
				//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
				int tcols = (int) System.Math.Ceiling((double) w / tw);
				...
				//UPGRADE_WARNING: Data types in Visual C# might be different.  Verify the accuracy of narrowing conversions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
				int trows = (int) System.Math.Ceiling((double) h / th);
				...
				for (int tx = 0; tx < tcols; ++tx)
				{
					for (int ty = 0; ty < trows; ++ty)
					{
						...
						System.IO.FileInfo f = new System.IO.FileInfo(file.DirectoryName + "\\" + base_Renamed + "." + tx + "." + ty + suffix);
						...
						System.Drawing.Rectangle r = new System.Drawing.Rectangle(tw * tx, th * ty, System.Math.Min(tw, w - tw * tx), System.Math.Min(th, h - th * ty));
						
						//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
						writeImage(f, img, ref r);
						++tilesDone;
					}
				}
			}
		...
		protected internal virtual void  done()
		{
			...
			catch (ExecutionException e)
			{
				...
				{
					WriteErrorDialog.error(e, (System.IO.IOException) c, files.get_Renamed(files.size() - 1));
				}
				else
				{
					ErrorDialog.bug(e);
	...
	/// <summary> Write a PNG-encoded snapshot of the map to the given OutputStreams,
