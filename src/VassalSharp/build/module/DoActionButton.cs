...
namespace VassalSharp.build.module
{
	...
	/// </summary>
	public class DoActionButton:AbstractConfigurable, RecursionLimiter.Loopable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(DoActionButton enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(DoActionButton enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private DoActionButton enclosingInstance;
			public DoActionButton Enclosing_Instance
			{
				get
				{
		...
		{
			reportFormat = new FormattedString(GameModule.getGameModule());
			loopType = LoopControl.LOOP_COUNTED;
			preLoopKey = NamedKeyStroke.NULL_KEYSTROKE;
			postLoopKey = NamedKeyStroke.NULL_KEYSTROKE;
			loopIndexProperty = new VassalSharp.build.module.properties.Impl("", this);
			return ;
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{NAME, BUTTON_TEXT, TOOLTIP, ICON, HOTKEY, DO_REPORT, REPORT_FORMAT, DO_SOUND, SOUND_CLIP, DO_HOTKEY, HOTKEYS, DO_LOOP, LOOP_TYPE, LOOP_COUNT, WHILE_EXPRESSION, UNTIL_EXPRESSION, PRE_LOOP_HOTKEY, POST_LOOP_HOTKEY, INDEX, INDEX_PROPERTY, INDEX_START, INDEX_STEP};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.DESCRIPTION), Resources.getString(Resources.BUTTON_TEXT), Resources.getString(Resources.TOOLTIP_TEXT), Resources.getString(Resources.BUTTON_ICON), Resources.getString(Resources.HOTKEY_LABEL), Resources.getString("Editor.DoAction.display_message"), Resources.getString("Editor.report_format"), Resources.getString("Editor.DoAction.play_sound"), Resources.getString("Editor.DoAction.sound_clip"), Resources.getString("Editor.DoAction.send_hotkeys"), Resources.getString("Editor.DoAction.hotkeys"), Resources.getString("Editor.DoAction.repeat_actions"), Resources.getString("Editor.LoopControl.type_of_loop"), Resources.getString("Editor.LoopControl.loop_how_many"), Resources.getString("Editor.LoopControl.looping_continues"), Resources.getString("Editor.LoopControl.looping_ends"), Resources.getString("Editor.DoAction.perform_before"), Resources.getString("Editor.DoAction.perform_after"), Resources.getString("Editor.LoopControl.loop_index"), Resources.getString("Editor.LoopControl.index_name"), Resources.getString("Editor.LoopControl.index_start"), Resources.getString("Editor.LoopControl.index_step")};
			}
		...
		public const System.String DO_REPORT = "doReport"; //$NON-NLS-1$
		public const System.String REPORT_FORMAT = "reportFormat"; //$NON-NLS-1$
		public const System.String DO_SOUND = "doSound"; //$NON-NLS-1$
		public const System.String SOUND_CLIP = "soundClip"; //$NON-NLS-1$
		public const System.String DO_HOTKEY = "doHotkey"; //$NON-NLS-1$
		public const System.String HOTKEYS = "hotkeys"; //$NON-NLS-1$
		public const System.String DO_LOOP = "doLoop"; //$NON-NLS-1$
		public const System.String LOOP_TYPE = "loopType"; //$NON-NLS-1$
		public const System.String LOOP_COUNT = "loopCount"; //$NON-NLS-1$
		public const System.String WHILE_EXPRESSION = "whileExpression"; //$NON-NLS-1$
		public const System.String UNTIL_EXPRESSION = "untilExpression"; //$NON-NLS-1$
		public const System.String PRE_LOOP_HOTKEY = "preLoopKey"; //$NON-NLS-1$
		public const System.String POST_LOOP_HOTKEY = "postLoopKey"; //$NON-NLS-1$
		public const System.String INDEX = "index"; //$NON-NLS-1$
		public const System.String INDEX_PROPERTY = "indexProperty"; //$NON-NLS-1$
		public const System.String INDEX_START = "indexStart"; //$NON-NLS-1$
		public const System.String INDEX_STEP = "indexStep"; //$NON-NLS-1$
		
		protected internal LaunchButton launch;
		protected internal bool doReport = false;
		...
		protected internal FormattedString reportFormat;
		protected internal bool doSound = false;
		protected internal System.String soundClip = ""; //$NON-NLS-1$
		protected internal bool doHotkey = false;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected List < NamedKeyStroke > hotkeys = new ArrayList < NamedKeyStroke >();
		protected internal bool doLoop = false;
		...
		protected internal bool hasIndex = false;
		protected internal System.String indexProperty = ""; //$NON-NLS-1$
		protected internal int indexStart = 1;
		protected internal int indexStep = 1;
		protected internal int indexValue;
		
		//UPGRADE_NOTE: The initialization of  'loopIndexProperty' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal VassalSharp.build.module.properties.Impl loopIndexProperty;
		protected internal bool loopPropertyRegistered = false;
		...
		public DoActionButton()
		{
			...
			//UPGRADE_NOTE: Final was removed from the declaration of 'description '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			System.String description = Resources.getString("Editor.DoAction.component_type"); //$NON-NLS-1$
		...
		public class SoundConfig : ConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
		...
		public class ReportFormatConfig : TranslatableConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
				return new PlayerIdFormattedStringConfigurer(key, name, new System.String[]{});
			}
		}
		
		public class HotkeyConfig : ConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
		...
		public class NamedHotkeyListConfigurer:ListConfigurer
		{
			public NamedHotkeyListConfigurer()
			{
				InitBlock();
			}
			private void  InitBlock()
		...
		public class LoopConfig : ConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
		...
		public class LoopTypeConfig:StringEnumConfigurer
		{
			override public System.String ValueString
			{
				get
				{
					return LoopControl.loopDescToType(base.ValueString);
				}
				
			}
			public LoopTypeConfig(System.String key, System.String name, System.String loopType):base(key, name, LoopControl.LOOP_TYPE_DESCS)
			{
				setValue(LoopControl.loopTypeToDesc(loopType));
			}
			
			public virtual System.String[] getValidValues(AutoConfigurable target)
			{
				return LoopControl.LOOP_TYPE_DESCS;
			}
		}
		
		public class LoopCountConfig : ConfigurerFactory
		{
			public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
			{
	...
	/// <summary> Register/Deregister the Global Property exposing the index property. It
	/// is only visible if looping is turned on and an Index Property is specified
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void updateLoopPropertyRegistration()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void doActions() throws RecursionLimitException
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Execute the set of actions that make up this button and
	/// return the set of Commands generated.
	/// 
	/// </summary>
	/// <param name="command">
	/// </param>
	/// <throws>  RecursionLimitException </throws>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void executeActions(Command command) throws RecursionLimitException
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		final GameModule mod = GameModule.getGameModule();
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void doHotKey(Command c, NamedKeyStroke key)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(!key.isNull())
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Implement PropertyNameSource - Expose loop index property if looping turned on</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
