...
namespace VassalSharp.build.module
{
	...
	public class SpecialDie:AbstractConfigurable
	{
		public SpecialDie()
		{
			InitBlock();
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{Resources.getString(Resources.NAME_LABEL), Resources.getString("Editor.SpecialDie.result_format")};
			}
		...
		//UPGRADE_NOTE: The initialization of  'logger' was moved to static method 'VassalSharp.build.module.SpecialDie'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public const System.String FORMAT = "format"; //$NON-NLS-1$
		public const System.String RESULT = "result"; //$NON-NLS-1$
		public const System.String NUMERICAL_VALUE = "numericalValue"; //$NON-NLS-1$
		
		
		public virtual void  addFace(SpecialDieFace f)
		{
			dieFaceList.add(f);
		}
		
		public virtual void  removeFace(SpecialDieFace f)
		{
		...
		static SpecialDie()
		{
			logger = LoggerFactory.getLogger(typeof(SpecialDie));
		}
	}
	...
	public class ResultFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			return new FormattedStringConfigurer(key, name, new System.String[]{NAME, RESULT, NUMERICAL_VALUE});
		}
	}
	...
	/// <summary>Return the number of faces on this die </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
