...
namespace VassalSharp.build.module
{
	...
	/// <summary> A window from which players can create new {@link GamePiece}s by
	...
	/// </summary>
	public class PieceWindow:Widget, UniqueIdManager.Identifyable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(PieceWindow enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(PieceWindow enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private PieceWindow enclosingInstance;
			public PieceWindow Enclosing_Instance
			{
				get
				{
			...
			{
				Enclosing_Instance.launchButtonPressed();
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener(System.Windows.Forms.Form d, PieceWindow enclosingInstance)
			{
				InitBlock(d, enclosingInstance);
			}
			private void  InitBlock(System.Windows.Forms.Form d, PieceWindow enclosingInstance)
			{
				this.d = d;
				this.enclosingInstance = enclosingInstance;
			}
			//UPGRADE_NOTE: Final variable d was copied into class AnonymousClassPropertyChangeListener. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1023'"
			...
			{
				if (VassalSharp.build.Configurable_Fields.NAME_PROPERTY.Equals(e.PropertyName))
				{
					d.Text = (System.String) e.NewValue;
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener1(System.Windows.Forms.Form d, PieceWindow enclosingInstance)
			{
				InitBlock(d, enclosingInstance);
			}
			private void  InitBlock(System.Windows.Forms.Form d, PieceWindow enclosingInstance)
			...
			//UPGRADE_NOTE: Final variable d was copied into class AnonymousClassPropertyChangeListener1. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1023'"
			private System.Windows.Forms.Form d;
			private PieceWindow enclosingInstance;
			public PieceWindow Enclosing_Instance
			{
		...
		public const System.String DEPRECATED_NAME = "entryName"; //$NON-NLS-1$
		...
		public const System.String HIDDEN = "hidden"; //$NON-NLS-1$
		protected internal static UniqueIdManager idMgr = new UniqueIdManager("PieceWindow"); //$NON-NLS-1$
		...
		private System.Windows.Forms.Form initFrame()
		{
			if (GlobalOptions.Instance.UseSingleWindow)
			{
				...
				System.Windows.Forms.Form d = new JDialog(GameModule.getGameModule().getFrame());
				//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
				d.Controls.Add(root);
				d.Closing += new System.ComponentModel.CancelEventHandler(this.PieceWindow_Closing_HIDE_ON_CLOSE);
				d.Text = getConfigureName();
				this.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener(d, this).propertyChange);
				return d;
			}
			else
			{
				...
				d.Closing += new System.ComponentModel.CancelEventHandler(this.PieceWindow_Closing_HIDE_ON_CLOSE);
				d.Text = getConfigureName();
				d.Menu = MenuManager.Instance.getMenuBarFor(d);
				
				this.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener1(d, this).propertyChange);
				
				return d;
			}
		}
		
		public virtual void  launchButtonPressed()
		{
			...
			else
			{
				...
				SupportClass.SetPropertyAsVirtual(root.getTopLevelAncestor(), "Visible", !root.getTopLevelAncestor().Visible);
			}
		}
		...
		/// <summary> A PieceWindow may contain a {@link TabWidget}, a {@link
		...
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class
		private void  PieceWindow_Closing_HIDE_ON_CLOSE(System.Object sender, System.ComponentModel.CancelEventArgs  e)
		{
			e.Cancel = true;
	...
	/// <summary> Each instanceof PieceWindow has a unique String identifier
	/// 
	/// </summary>
	/// <returns> the identifier for this PieceWindow
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public String getId()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Each instanceof PieceWindow has a unique String identifier</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setId(String s)
	...
	/// <summary> Expects to be added to a {@link GameModule}.  When added, sets
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, HIDDEN, BUTTON_TEXT, TOOLTIP, ICON, HOTKEY
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
