...
using IconButton = VassalSharp.tools.IconButton;
...
namespace VassalSharp.build.module.turn
{
	...
	/// <summary> Generic Turn Counter</summary>
	public class TurnTracker:TurnComponent, CommandEncoder, GameComponent, UniqueIdManager.Identifyable
	{
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private TurnTracker enclosingInstance;
			public TurnTracker Enclosing_Instance
			{
				get
				{
			...
			{
				if (!Enclosing_Instance.Docked)
				{
					Enclosing_Instance.turnWindow.setControls();
					//UPGRADE_TODO: Method 'java.awt.Component.setVisible' was converted to 'System.Windows.Forms.Control.Visible' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtComponentsetVisible_boolean'"
					//UPGRADE_TODO: 'System.Windows.Forms.Application.Run' must be called to start a main form. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1135'"
					Enclosing_Instance.turnWindow.Visible = !Enclosing_Instance.turnWindow.Visible;
					Enclosing_Instance.turnWindow.setFocusable(true);
				}
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
			...
			{
				Enclosing_Instance.setDisplayFont();
			}
		}
		...
		{
			public AnonymousClassPropertyChangeListener1(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
		...
		{
			public AnonymousClassPropertyChangeListener2(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
			...
			public virtual void  propertyChange(System.Object event_sender, SupportClass.PropertyChangingEventArgs e)
			{
				Enclosing_Instance.Docked = Enclosing_Instance.Docked;
			}
		}
		...
		{
			public AnonymousClassActionListener1(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				Enclosing_Instance.turnWidget.doNext();
			}
		}
		...
		{
			public AnonymousClassActionListener2(TurnTracker enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnTracker enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				Enclosing_Instance.turnWidget.doPrev();
			}
		}
		private void  InitBlock()
		{
			reportFormat = new FormattedString("* <$" + GlobalOptions.PLAYER_ID + "$> Turn Updated from $" + OLD_TURN + "$ to $" + NEW_TURN + "$");
			lastCommand = new VassalSharp.build.module.properties.Impl(SET, this);
			lastTurn = new VassalSharp.build.module.properties.Impl("", this);
			return ;
		...
		virtual public System.String State
		{
			...
			set
			{
				...
				while (i.hasNext())
				{
					//UPGRADE_NOTE: Final was removed from the declaration of 'level '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
					TurnLevel level = i.next();
					level.State = sd.nextToken(""); //$NON-NLS-1$
				}
		...
		override public System.String[] AttributeNames
		{
			...
			*/
			...
			get
			{
				return new System.String[]{NAME, BUTTON_TEXT, ICON, BUTTON_TOOLTIP, HOT_KEY, NEXT_HOT_KEY, PREV_HOT_KEY, TURN_FORMAT, REPORT_FORMAT, TOOLTIP, LENGTH_STYLE, LENGTH};
			}
			
		}
		/// <summary> Calculate the maximum width for the turnWidget to display
		/// any item.
		/// 
		...
		/// </returns>
		virtual protected internal int MaximumWidth
		{
			get
			{
				System.String maxString = getMaximumTurnString();
				int max = turnWidget.getWidth(maxString);
				return max + 2;
			}
			
		}
		virtual protected internal int FontStyle
		{
			get
			{
				return ((System.Boolean) GameModule.getGameModule().getPrefs().getValue(FONT_BOLD))?1:0;
			}
			
		}
		virtual protected internal bool Docked
		{
			get
			{
				return ((System.Boolean) GameModule.getGameModule().getPrefs().getValue(DOCKED));
			}
			...
			set
			{
				...
				g.getPrefs().setValue(DOCKED, Boolean.valueOf(value));
				launch.Visible = !value && (getAttributeValueString(BUTTON_TEXT).Length > 0 || getAttributeValueString(ICON).Length > 0);
				if (value)
				{
					turnWindow.Widget = null;
					//UPGRADE_TODO: Method 'java.awt.Component.setVisible' was converted to 'System.Windows.Forms.Control.Visible' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtComponentsetVisible_boolean'"
					//UPGRADE_TODO: 'System.Windows.Forms.Application.Run' must be called to start a main form. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1135'"
					turnWindow.Visible = false;
					//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent_javalangObject'"
					launchWidget.Controls.Add(turnWidget);
					turnWidget.Dock = System.Windows.Forms.DockStyle.Fill;
					turnWidget.BringToFront();
					launchWidget.setVisible(g.getGameState().isGameStarted());
				}
				else
				{
					launchWidget.Visible = false;
					launchWidget.Controls.Remove(turnWidget);
					turnWindow.Widget = turnWidget;
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Name:  ", "Button text:  ", "Button Icon:  ", "Button Tooltip:  ", "Show/hide Hotkey:  ", "Next Turn Hotkey:  ", "Previous Turn Hotkey:  ", "Turn Name Format:  ", "Report Format:  ", "Turn Label Tooltip Text:  ", "Turn Label Length:  ", "Turn label Display length:  "};
			}
			
		}
		
		protected internal static UniqueIdManager idMgr = new UniqueIdManager("TurnTracker"); //$NON-NLS-1$
		
		protected internal const System.String COMMAND_PREFIX = "TURN"; //$NON-NLS-1$
		
		public const System.String NAME = "name"; //$NON-NLS-1$
		public const System.String HOT_KEY = "hotkey"; //$NON-NLS-1$
		public const System.String NEXT_HOT_KEY = "nexthotkey"; //$NON-NLS-1$
		public const System.String PREV_HOT_KEY = "prevhotkey"; //$NON-NLS-1$
		public const System.String ICON = "icon"; //$NON-NLS-1$
		public const System.String BUTTON_TEXT = "buttonText"; //$NON-NLS-1$
		public const System.String BUTTON_TOOLTIP = "buttonTooltip"; //$NON-NLS-1$
		public const System.String TURN_FORMAT = "turnFormat"; //$NON-NLS-1$
		public const System.String REPORT_FORMAT = "reportFormat"; //$NON-NLS-1$
		public const System.String TOOLTIP = "tooltip"; //$NON-NLS-1$
		public const System.String LENGTH = "length"; //$NON-NLS-1$
		public const System.String LENGTH_STYLE = "lengthStyle"; //$NON-NLS-1$
		
		protected internal const System.String FONT_SIZE = "turnFontSize"; //$NON-NLS-1$
		protected internal const System.String FONT_BOLD = "turnFontBold"; //$NON-NLS-1$
		protected internal const System.String DOCKED = "turnDocked"; //$NON-NLS-1$
		
		/// <summary>Variable name for reporting format </summary>
		protected internal const System.String OLD_TURN = "oldTurn"; //$NON-NLS-1$
		protected internal const System.String NEW_TURN = "newTurn"; //$NON-NLS-1$
		protected internal const System.String LEVEL = "level"; //$NON-NLS-1$
		
		protected internal const System.String TURN_FONT = "Dialog";
		protected internal static System.String SET_COMMAND;
		protected internal static System.String DOCK_COMMAND;
		protected internal static System.String UNDOCK_COMMAND;
		
		protected internal const System.String NEXT = "Next";
		protected internal const System.String PREV = "Prev";
		protected internal const System.String SET = "Set";
		
		protected internal const System.String PROP_VALUE = "_value"; //$NON-NLS-1$
		protected internal const System.String PROP_COMMAND = "_command"; //$NON-NLS-1$
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'FONT_FAMILYS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal static readonly System.String[] FONT_FAMILYS = new System.String[]{"Dialog", "DialogInput", "Monospaced", "SanSerif", "Serif"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
		
		protected internal const System.String LENGTH_VARIABLE = "Variable";
		protected internal const System.String LENGTH_MAXIMUM = "Maximum";
		protected internal const System.String LENGTH_FIXED = "Fixed";
		
		protected internal FormattedString turnFormat = new FormattedString("$" + LEVEL + "1$ $" + LEVEL + "2$ $" + LEVEL + "3$ $" + LEVEL + "4$"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
		...
		protected internal FormattedString reportFormat; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		
		protected internal TurnWindow turnWindow;
		protected internal TurnWidget turnWidget;
		protected internal System.Windows.Forms.Panel launchWidget;
		protected internal SetDialog setDialog;
		protected internal LaunchButton launch;
		protected internal NamedKeyStrokeListener nextListener;
		protected internal NamedKeyStrokeListener prevListener;
		
		protected internal System.String savedState = ""; //$NON-NLS-1$
		protected internal System.String savedSetState = ""; //$NON-NLS-1$
		protected internal System.String savedTurn = ""; //$NON-NLS-1$
		...
		protected internal int currentLevel = 0;
		protected internal System.String id;
		protected internal int width = - 1;
		protected internal System.String lengthStyle = LENGTH_MAXIMUM;
		
		//UPGRADE_NOTE: The initialization of  'lastCommand' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal VassalSharp.build.module.properties.Impl lastCommand;
		//UPGRADE_NOTE: The initialization of  'lastTurn' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal VassalSharp.build.module.properties.Impl lastTurn;
		...
		public TurnTracker()
		{
			...
			IntConfigurer size = new IntConfigurer(FONT_SIZE, Resources.getString("TurnTracker.size_pref"), 14); //$NON-NLS-1$
			//UPGRADE_NOTE: Final was removed from the declaration of 'bold '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			System.Boolean tempAux = false;
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			BooleanConfigurer bold = new BooleanConfigurer(FONT_BOLD, Resources.getString("TurnTracker.bold_pref"), ref tempAux); //$NON-NLS-1$
			//UPGRADE_NOTE: Final was removed from the declaration of 'docked '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			System.Boolean tempAux2 = false;
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			BooleanConfigurer docked = new BooleanConfigurer(DOCKED, Resources.getString("TurnTracker.docked_pref"), ref tempAux2); //$NON-NLS-1$
			
			System.String prefTab = Resources.getString("TurnTracker.turn_counter"); //$NON-NLS-1$
			...
			size.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener(this).propertyChange);
			
			bold.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener1(this).propertyChange);
			
			docked.PropertyChange += new SupportClass.PropertyChangeEventHandler(new AnonymousClassPropertyChangeListener2(this).propertyChange);
			
			// Set up listeners for prev/next hotkeys
			nextListener = new NamedKeyStrokeListener(new AnonymousClassActionListener1(this));
			GameModule.getGameModule().addKeyStrokeListener(nextListener);
			
			prevListener = new NamedKeyStrokeListener(new AnonymousClassActionListener2(this));
		...
		protected internal virtual void  setLaunchToolTip()
		{
		...
		public override void  setAttribute(System.String key, System.Object value_Renamed)
		{
			...
			{
				turnFormat.Format = ((System.String) value_Renamed);
			}
			else if (TOOLTIP.Equals(key))
			{
				turnWidget.LabelToolTipText = ((System.String) value_Renamed);
			}
			else if (LENGTH.Equals(key))
			{
				...
				width = ((System.Int32) value_Renamed);
			}
			else if (LENGTH_STYLE.Equals(key))
			{
				lengthStyle = ((System.String) value_Renamed);
			...
			else if (NEXT_HOT_KEY.Equals(key))
			{
				...
				nextListener.setKeyStroke((NamedKeyStroke) value_Renamed);
				turnWidget.NextStroke = (NamedKeyStroke) value_Renamed;
			}
			else if (PREV_HOT_KEY.Equals(key))
			{
				...
				prevListener.setKeyStroke((NamedKeyStroke) value_Renamed);
				turnWidget.PrevStroke = (NamedKeyStroke) value_Renamed;
			}
			else
			{
		...
		protected internal virtual void  setWidgetWidth()
		{
			...
			{
				turnWidget.setWidth(MaximumWidth);
			}
			else
			{
		...
		protected internal virtual void  setDisplayFont()
		{
			turnWidget.LabelFont = getDisplayFont();
			if (!Docked && turnWindow != null)
			{
		...
		protected internal virtual System.Drawing.Font getDisplayFont()
		{
			int style = FontStyle;
			...
			return new System.Drawing.Font(TURN_FONT, size, (System.Drawing.FontStyle) style);
		}
		
		protected internal virtual void  setFontSize()
		{
			setDisplayFont();
		}
		
		protected internal virtual int getFontSize()
		{
			return ((System.Int32) GameModule.getGameModule().getPrefs().getValue(FONT_SIZE));
		}
		...
		public override System.String getAttributeValueString(System.String key)
		{
			...
			{
				return turnFormat.Format;
			}
			else if (TOOLTIP.Equals(key))
			{
				return turnWidget.LabelToolTipText;
			}
			else if (LENGTH.Equals(key))
			{
				return System.Convert.ToString(width);
			}
			else if (LENGTH_STYLE.Equals(key))
			{
				return lengthStyle;
			...
			{
				return NamedHotKeyConfigurer.encode(nextListener.NamedKeyStroke);
			}
			else if (PREV_HOT_KEY.Equals(key))
			{
				return NamedHotKeyConfigurer.encode(prevListener.NamedKeyStroke);
			}
			else
			{
	...
	public class TurnFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			...
			System.String[] s = new System.String[t.getLevelCount()];
	...
	public class ReportFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, System.String key, System.String name)
		{
			return new PlayerIdFormattedStringConfigurer(key, name, new System.String[]{OLD_TURN, NEW_TURN});
		}
	}
	
	public class LengthStyleConfig:StringEnum
	{
		public override System.String[] getValidValues(AutoConfigurable target)
		{
			return new System.String[]{LENGTH_VARIABLE, LENGTH_FIXED, LENGTH_MAXIMUM};
		}
	}
	...
	/// <summary> Calculate the maximum sized turn string that can be generated
	/// by any turn combination.
	/// 
	/// </summary>
	/// <returns> maximum turn string
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Build the turn string to be displayed from the currently
	...
	/// <summary> A list of all active TurnLevels within the TurnTracker</summary>
	/// <returns>
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(TurnGlobalHotkey key: getComponentsOf(TurnGlobalHotkey.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void updateTurnDisplay(String command)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void replace(StringBuilder s, String from, String to)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void replace(StringBuffer s, String from, String to)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		int i = s.indexOf(from);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	[Serializable]
	protected internal class TurnWindow:System.Windows.Forms.Form
	{
		virtual protected internal TurnWidget Widget
		{
			set
			{
				if (value == null)
		...
		protected internal TurnWidget widget;
		
		protected internal TurnWindow():base(GameModule.getGameModule().getFrame())
		{
		...
		protected internal virtual void  setControls()
		{
			if (widget != null)
			{
				widget.setControls();
	...
	[Serializable]
	protected internal class TurnWidget:System.Windows.Forms.Panel
	{
		static private System.Int32 state304;
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(TurnWidget enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnWidget enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private TurnWidget enclosingInstance;
			public TurnWidget Enclosing_Instance
			{
				get
				{
					return enclosingInstance;
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				Enclosing_Instance.doNext();
			}
		}
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassActionListener1' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		private class AnonymousClassActionListener1
		{
			public AnonymousClassActionListener1(TurnWidget enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(TurnWidget enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				Enclosing_Instance.doPrev();
			}
		}
		private static void  mouseDown(System.Object event_sender, System.Windows.Forms.MouseEventArgs e)
		{
			state304 = ((int) e.Button | (int) System.Windows.Forms.Control.ModifierKeys);
		}
		virtual public System.Drawing.Font LabelFont
		{
			set
			{
				turnLabel.Font = value;
			}
			
		}
		virtual public System.String LabelToolTipText
		{
			get
			{
				return SupportClass.ToolTipSupport.getToolTipText(turnLabel);
			}
			
			set
			{
				SupportClass.ToolTipSupport.setToolTipText(turnLabel, value);
			}
		...
		virtual public System.Drawing.Color Color
		{
			get
			{
				return turnLabel.BackColor;
			}
			
		}
		virtual public NamedKeyStroke NextStroke
		{
			set
			{
				//UPGRADE_NOTE: Final was removed from the declaration of 'tooltip '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
				System.String tooltip = Resources.getString("TurnTracker.next_turn") + (value == null?"":" " + NamedHotKeyConfigurer.getFancyString(value));
				SupportClass.ToolTipSupport.setToolTipText(nextButton, tooltip);
			}
			
		}
		virtual public NamedKeyStroke PrevStroke
		{
			set
			{
				//UPGRADE_NOTE: Final was removed from the declaration of 'tooltip '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
				System.String tooltip = Resources.getString("TurnTracker.prev_turn") + (value == null?"":" " + NamedHotKeyConfigurer.getFancyString(value)); //$NON-NLS-1$ //$NON-NLS-2$
				SupportClass.ToolTipSupport.setToolTipText(prevButton, tooltip);
			}
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'BUTTON_SIZE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal int BUTTON_SIZE = 22;
		
		protected internal System.Windows.Forms.Label turnLabel = new System.Windows.Forms.Label();
		
		protected internal TurnWidget():base()
		{
			initComponents();
		}
		
		public virtual void  setWidth(int length)
		{
			if (length > 0)
			{
				...
				turnLabel.setMinimumSize(new System.Drawing.Size(length, BUTTON_SIZE));
				...
				turnLabel.Size = new System.Drawing.Size(length, BUTTON_SIZE);
			}
			else
			{
				//UPGRADE_ISSUE: Method 'javax.swing.JComponent.setMinimumSize' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingJComponentsetMinimumSize_javaawtDimension'"
				System.Drawing.Size tempAux = System.Drawing.Size.Empty;
				turnLabel.setMinimumSize(tempAux);
				//UPGRADE_TODO: Method 'javax.swing.JComponent.setPreferredSize' was converted to 'System.Windows.Forms.Control.Size' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073'"
				System.Drawing.Size tempAux2 = System.Drawing.Size.Empty;
				turnLabel.Size = tempAux2;
			}
		}
		
		public virtual int getWidth(System.String text)
		{
			...
			return SupportClass.GraphicsManager.manager.GetFont(turnLabel.CreateGraphics()).stringWidth(text);
		}
		...
		protected internal virtual void  doPrev()
		{
			captureState();
			prev();
			save();
		...
		protected internal virtual void  initComponents()
		{
			...
			NextStroke = nextListener.getNamedKeyStroke();
			...
			//UPGRADE_ISSUE: Field 'java.awt.Component.TOP_ALIGNMENT' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtComponentTOP_ALIGNMENT_f'"
			nextButton.setAlignmentY(Component.TOP_ALIGNMENT);
			nextButton.Click += new System.EventHandler(new AnonymousClassActionListener(this).actionPerformed);
			SupportClass.CommandManager.CheckCommand(nextButton);
			
			prevButton = new IconButton(IconButton.MINUS_ICON, BUTTON_SIZE);
			PrevStroke = prevListener.getNamedKeyStroke();
			//UPGRADE_ISSUE: Method 'javax.swing.JComponent.setAlignmentY' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingJComponentsetAlignmentY_float'"
			//UPGRADE_ISSUE: Field 'java.awt.Component.TOP_ALIGNMENT' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtComponentTOP_ALIGNMENT_f'"
			prevButton.setAlignmentY(Component.TOP_ALIGNMENT);
			prevButton.Click += new System.EventHandler(new AnonymousClassActionListener1(this).actionPerformed);
			SupportClass.CommandManager.CheckCommand(prevButton);
			...
			turnLabel.ImageAlign = System.Drawing.ContentAlignment.MiddleCenter;
			turnLabel.MouseDown += new System.Windows.Forms.MouseEventHandler(VassalSharp.build.module.turn.TurnWidget.mouseDown);
			turnLabel.Click += new System.EventHandler(this.mouseClicked);
			turnLabel.MouseEnter += new System.EventHandler(this.mouseEntered);
			turnLabel.MouseLeave += new System.EventHandler(this.mouseExited);
			turnLabel.MouseDown += new System.Windows.Forms.MouseEventHandler(this.mousePressed);
			turnLabel.MouseUp += new System.Windows.Forms.MouseEventHandler(this.mouseReleased);
			turnLabel.setBackground(Color.WHITE);
			SupportClass.ToolTipSupport.setToolTipText(turnLabel, Resources.getString("TurnTracker.click_to_configure")); //$NON-NLS-1$
			
			
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent_javalangObject'"
			Controls.Add(prevButton);
			prevButton.Dock = new System.Windows.Forms.DockStyle();
			prevButton.BringToFront();
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent_javalangObject'"
			Controls.Add(turnLabel);
			turnLabel.Dock = System.Windows.Forms.DockStyle.Fill;
			turnLabel.BringToFront();
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent_javalangObject'"
			Controls.Add(nextButton);
			nextButton.Dock = new System.Windows.Forms.DockStyle();
			nextButton.BringToFront();
			
			MouseDown += new System.Windows.Forms.MouseEventHandler(VassalSharp.build.module.turn.TurnWidget.mouseDown);
		...
		{
			System.String s = updateString(getTurnString(), new System.String[]{"\\n", "\\t"}, new System.String[]{"\n", "    "}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
			turnLabel.Text = s;
		}
		...
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public virtual void  doPopup(ref System.Drawing.Point p)
		{
			buildPopup();
			if (Visible)
			{
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void addItem(JMenu menu, String command)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	[Serializable]
	protected internal class SetDialog:System.Windows.Forms.Form
	{
		...
		{
			public AnonymousClassWindowAdapter(SetDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SetDialog enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private SetDialog enclosingInstance;
			public SetDialog Enclosing_Instance
			{
				get
				{
					return enclosingInstance;
		...
		private class AnonymousClassActionListener
		{
			public AnonymousClassActionListener(SetDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SetDialog enclosingInstance)
		...
		private class AnonymousClassActionListener1
		{
			public AnonymousClassActionListener1(SetDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SetDialog enclosingInstance)
		...
		private class AnonymousClassPropertyChangeListener
		{
			public AnonymousClassPropertyChangeListener(SetDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(SetDialog enclosingInstance)
		...
		protected internal System.Windows.Forms.Panel controls = null;
		protected internal System.Windows.Forms.Panel levelControls = null;
		protected internal System.Windows.Forms.Control childControls = null;
		protected internal TurnTracker turn;
		protected internal System.Windows.Forms.Form me;
		
		protected internal SetDialog():base(GameModule.getGameModule().getFrame())
		{
			initComponents();
			//UPGRADE_TODO: Method 'java.awt.Component.setLocation' was converted to 'System.Windows.Forms.Control.Location' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtComponentsetLocation_int_int'"
			Location = new System.Drawing.Point(100, 100);
		...
		protected internal virtual void  initComponents()
		{
			...
			Closing += new System.ComponentModel.CancelEventHandler(this.SetDialog_Closing_DO_NOTHING_ON_CLOSE);
		...
		public virtual void  setControls(TurnTracker turn)
		{
			...
			levelControls = new System.Windows.Forms.Panel();
			//UPGRADE_ISSUE: Method 'java.awt.Container.setLayout' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtContainersetLayout_javaawtLayoutManager'"
			//UPGRADE_ISSUE: Constructor 'javax.swing.BoxLayout.BoxLayout' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBoxLayout'"
			//UPGRADE_ISSUE: Field 'javax.swing.BoxLayout.Y_AXIS' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingBoxLayout'"
			...
			if (getTurnLevelCount() > 1)
			{
				...
				System.String[] s = new System.String[getTurnLevelCount()];
				for (int i = 0; i < s.Length; i++)
				{
			...
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			controls.Controls.Add(levelControls);
		...
		protected internal virtual void  addChildControls()
		{
			...
			{
				levelControls.Controls.Remove(childControls);
			}
			childControls = getTurnLevel(currentLevel).getSetControls(me, turn);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
			levelControls.Controls.Add(childControls);
			//UPGRADE_ISSUE: Method 'java.awt.Window.pack' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtWindowpack'"
			pack();
		}
		private void  SetDialog_Closing_DO_NOTHING_ON_CLOSE(System.Object sender, System.ComponentModel.CancelEventArgs  e)
		{
			e.Cancel = true;
	...
	{
		virtual public TurnTracker Turn
		{
			get
			{
				return turn;
		...
		private System.String newState;
		private TurnTracker turn;
		
		public SetTurn(System.String newState, TurnTracker t)
		{
		...
		public SetTurn(TurnTracker t, System.String oldState)
		{
			newState = t.State;
