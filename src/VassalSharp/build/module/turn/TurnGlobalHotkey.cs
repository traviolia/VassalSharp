...
namespace VassalSharp.build.module.turn
{
	...
	public class TurnGlobalHotkey:AbstractConfigurable
	{
		public TurnGlobalHotkey()
		{
			InitBlock();
		}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"Description:  ", "Global Hotkey:  ", "Match Properties:  ", "Report Format:  "};
			}
		...
		public const System.String MATCH = "match"; //$NON-NLS-1$
		public const System.String REPORT_FORMAT = "reportFormat"; //$NON-NLS-1$
		
		protected internal PropertyExpression match = new PropertyExpression();
		protected internal NamedKeyStroke hotkey;
		protected internal FormattedString format = new FormattedString();
		protected internal BasicPiece checkPiece = new BasicPiece();
	...
	{ 
		return new String []
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ NAME, HOTKEY, MATCH, REPORT_FORMAT
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	};
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	}
