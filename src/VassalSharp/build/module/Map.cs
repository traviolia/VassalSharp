...
//UPGRADE_TODO: The type 'org.jdesktop.animation.timing.Animator' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using Animator = org.jdesktop.animation.timing.Animator;
//UPGRADE_TODO: The type 'org.jdesktop.animation.timing.TimingTargetAdapter' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using TimingTargetAdapter = org.jdesktop.animation.timing.TimingTargetAdapter;
...
using DefaultPieceCollection = VassalSharp.build.module.map.DefaultPieceCollection;
using DrawPile = VassalSharp.build.module.map.DrawPile;
using Drawable = VassalSharp.build.module.map.Drawable;
using ForwardToChatter = VassalSharp.build.module.map.ForwardToChatter;
using ForwardToKeyBuffer = VassalSharp.build.module.map.ForwardToKeyBuffer;
using GlobalMap = VassalSharp.build.module.map.GlobalMap;
using HidePiecesButton = VassalSharp.build.module.map.HidePiecesButton;
using HighlightLastMoved = VassalSharp.build.module.map.HighlightLastMoved;
using ImageSaver = VassalSharp.build.module.map.ImageSaver;
using KeyBufferer = VassalSharp.build.module.map.KeyBufferer;
...
using MapCenterer = VassalSharp.build.module.map.MapCenterer;
...
using PieceRecenterer = VassalSharp.build.module.map.PieceRecenterer;
using Scroller = VassalSharp.build.module.map.Scroller;
using SelectionHighlighters = VassalSharp.build.module.map.SelectionHighlighters;
...
using TextSaver = VassalSharp.build.module.map.TextSaver;
...
using RegionGrid = VassalSharp.build.module.map.boardPicker.board.RegionGrid;
...
namespace VassalSharp.build.module
{
    ...
    /// <summary> The Map is the main component for displaying and containing {@link GamePiece}s during play. Pieces are displayed on
    ...
    /// contained in the <code>VassalSharp.build.module.map</code> package
    /// </summary>
    public class Map : AbstractConfigurable, GameComponent, Configurable, UniqueIdManager.Identifyable, ToolBarComponent, MutablePropertiesContainer, PropertySource, PlayerRoster.SideChangeListener
    {
#if NEVER_DEFINED
		static private System.Int32 state235;
		...
		{
			public AnonymousClassPropertyChangeListener(Map enclosingInstance)
			{
		...
		{
			public AnonymousClassActionListener(Map enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Map enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				...
				if (Enclosing_Instance.mainWindowDock == null && Enclosing_Instance.launchButton.Enabled && Enclosing_Instance.theMap.getTopLevelAncestor() != null)
				{
					//UPGRADE_ISSUE: Method 'javax.swing.JComponent.getTopLevelAncestor' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingJComponentgetTopLevelAncestor'"
					...
					SupportClass.SetPropertyAsVirtual(Enclosing_Instance.theMap.getTopLevelAncestor(), "Visible", !Enclosing_Instance.theMap.getTopLevelAncestor().Visible);
				}
			}
		}
		...
		{
			public AnonymousClassDragGestureListener(Map enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Map enclosingInstance)
			...
			{
				if (mouseListenerStack.isEmpty() && Enclosing_Instance.dragGestureListener != null)
				{
					//UPGRADE_TODO: Method 'java.awt.dnd.DragGestureListener.dragGestureRecognized' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
					Enclosing_Instance.dragGestureListener.dragGestureRecognized(dge);
				}
			}
		}
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'AnonymousClassHierarchyListener' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		//UPGRADE_ISSUE: Interface 'java.awt.event.HierarchyListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawteventHierarchyListener'"
		private class AnonymousClassHierarchyListener : HierarchyListener
		{
			public AnonymousClassHierarchyListener(Map enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(Map enclosingInstance)
			...
			//UPGRADE_ISSUE: Class 'java.awt.event.HierarchyEvent' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawteventHierarchyEvent'"
			public virtual void  hierarchyChanged(HierarchyEvent e)
			{
				System.Windows.Forms.Form w;
				...
				if ((w = (System.Windows.Forms.Form) Enclosing_Instance.toolBar.Parent) != null)
				{
					w.Invalidate();
				}
				if (Enclosing_Instance.toolBar.Size.Width > 0)
				{
					//UPGRADE_ISSUE: Method 'java.awt.Component.removeHierarchyListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtComponentremoveHierarchyListener_javaawteventHierarchyListener'"
					Enclosing_Instance.toolBar.removeHierarchyListener(this);
				}
			}
		}
		private static void  mouseDown(System.Object event_sender, System.Windows.Forms.MouseEventArgs e)
		{
			state235 = ((int) e.Button | (int) System.Windows.Forms.Control.ModifierKeys);
		}
		private void  InitBlock()
		{
			...
			markMovedOption = GlobalOptions.ALWAYS;
			markUnmovedTooltip = Resources.getString("Map.mark_unmoved");
			pieces = new DefaultPieceCollection(this);
		...
		public static bool ChangeReportingEnabled
		{
			get
			{
			...
			set
			{
				changeReportingEnabled = value;
			}
			
		}
		//UPGRADE_NOTE: Respective javadoc comments were merged.  It should be changed in order to comply with .NET documentation conventions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1199'"
		/// <summary> Every map must include a {@link BoardPicker} as one of its build components
		/// 
		/// </summary>
		/// <returns> the BoardPicker for this map
		/// </returns>
		/// <summary> Every map must include a {@link BoardPicker} as one of its build components</summary>
		virtual public BoardPicker BoardPicker
		{
			get
			{
				if (picker == null)
				{
					picker = new BoardPicker(this);
					picker.build(null);
					add(picker);
					picker.addTo(this);
				}
			...
			set
			{
				if (this.picker != null)
				{
					GameModule.getGameModule().removeCommandEncoder(value);
					GameModule.getGameModule().getGameState().addGameComponent(value);
				}
				this.picker = value;
				if (value != null)
				{
					value.setAllowMultiple(allowMultiple);
					GameModule.getGameModule().addCommandEncoder(value);
					GameModule.getGameModule().getGameState().addGameComponent(value);
				}
			}
		...
		//UPGRADE_NOTE: Respective javadoc comments were merged.  It should be changed in order to comply with .NET documentation conventions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1199'"
		/// <summary> A map may include a {@link Zoomer} as one of its build components
		/// 
		/// </summary>
		/// <returns> the Zoomer for this map
		/// </returns>
		/// <summary> A map may include a {@link Zoomer} as one of its build components</summary>
		virtual public Zoomer Zoomer
		{
			get
			{
				return zoom;
		...
		//UPGRADE_NOTE: Respective javadoc comments were merged.  It should be changed in order to comply with .NET documentation conventions. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1199'"
		/// <summary> Every map must include a {@link StackMetrics} as one of its build
		/// components, which governs the stacking behavior of GamePieces on the map
		/// 
		/// </summary>
		/// <returns> the StackMetrics for this map
		/// </returns>
		/// <summary> Every map must include a {@link StackMetrics} as one of its build components, which governs the stacking behavior
		/// of GamePieces on the map
		/// </summary>
		virtual public StackMetrics StackMetrics
		{
			get
			{
				if (metrics == null)
				{
					metrics = new StackMetrics(this);
					metrics.build(null);
					add(metrics);
					metrics.addTo(this);
				}
		...
		/// <returns> the current zoom factor for the map
		/// </returns>
		...
		/// <returns> the toolbar for this map's window
		/// </returns>
		...
		virtual public PieceMover PieceMover
		{
			set
			{
				pieceMover = value;
		...
		protected internal static bool changeReportingEnabled = true;
		protected internal string mapID = ""; //$NON-NLS-1$
		protected internal string mapName = ""; //$NON-NLS-1$
		protected internal const string MAIN_WINDOW_HEIGHT = "mainWindowHeight"; //$NON-NLS-1$
		protected internal static UniqueIdManager idMgr = new UniqueIdManager("Map"); //$NON-NLS-1$
		protected internal System.Windows.Forms.Panel theMap;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		//UPGRADE_TODO: Constructor 'javax.swing.JLayeredPane.JLayeredPane' was converted to 'System.Windows.Forms.Panel.Panel' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaxswingJLayeredPaneJLayeredPane'"
		protected internal System.Windows.Forms.Panel layeredPane = new System.Windows.Forms.Panel();
		...
		protected internal ComponentSplitter.SplitPane mainWindowDock;
		...
		protected internal Zoomer zoom;
		protected internal StackMetrics metrics;
		protected internal System.Drawing.Size edgeBuffer = new System.Drawing.Size(0, 0);
		protected internal System.Drawing.Color bgColor = System.Drawing.Color.White;
		protected internal LaunchButton launchButton;
		protected internal bool useLaunchButton = false;
		protected internal bool useLaunchButtonEdit = false;
		//UPGRADE_NOTE: The initialization of  'markMovedOption' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal string markMovedOption;
		protected internal string markUnmovedIcon = "/images/unmoved.gif"; //$NON-NLS-1$
		protected internal string markUnmovedText = ""; //$NON-NLS-1$
		//UPGRADE_NOTE: The initialization of  'markUnmovedTooltip' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal string markUnmovedTooltip; //$NON-NLS-1$
		...
		protected internal MouseListener multicaster = null;
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		protected internal int[][] boardWidths; // Cache of board widths by row/column
		protected internal int[][] boardHeights; // Cache of board heights by row/column
		//UPGRADE_NOTE: The initialization of  'pieces' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		protected internal PieceCollection pieces;
		protected internal Highlighter highlighter = new ColoredBorder();
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		protected ArrayList < Highlighter > highlighters = new ArrayList < Highlighter >();
		protected internal bool clearFirst = false; // Whether to clear the display before
		// drawing the map
		protected internal bool hideCounters = false; // Option to hide counters to see
		// map
		protected internal float pieceOpacity = 1.0f;
		protected internal bool allowMultiple = false;
		protected internal VisibilityCondition visibilityCondition;
		...
		protected internal string moveWithinFormat;
		protected internal string moveToFormat;
		protected internal string createFormat;
		protected internal string changeFormat = "$" + MESSAGE + "$"; //$NON-NLS-1$ //$NON-NLS-2$
		protected internal NamedKeyStroke moveKey;
		...
		protected internal PropertyChangeListener globalPropertyListener;
		protected internal string tooltip = ""; //$NON-NLS-1$
		protected internal MutablePropertiesContainer propsContainer = new VassalSharp.build.module.properties.Impl();
		//UPGRADE_TODO: Interface 'java.beans.PropertyChangeListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
		...
		protected internal PropertyChangeListener repaintOnPropertyChange;
		protected internal PieceMover pieceMover;
		//UPGRADE_TODO: Interface 'java.awt.event.KeyListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
		protected internal KeyListener[] saveKeyListeners = null;
		
		public Map()
		{
			InitBlock();
			getView();
			theMap.MouseDown += new System.Windows.Forms.MouseEventHandler(VassalSharp.build.module.Map.mouseDown);
		...
		public const string NAME = "mapName"; //$NON-NLS-1$
		public const string MARK_MOVED = "markMoved"; //$NON-NLS-1$
		public const string MARK_UNMOVED_ICON = "markUnmovedIcon"; //$NON-NLS-1$
		public const string MARK_UNMOVED_TEXT = "markUnmovedText"; //$NON-NLS-1$
		public const string MARK_UNMOVED_TOOLTIP = "markUnmovedTooltip"; //$NON-NLS-1$
		public const string EDGE_WIDTH = "edgeWidth"; //$NON-NLS-1$
		public const string EDGE_HEIGHT = "edgeHeight"; //$NON-NLS-1$
		public const string BACKGROUND_COLOR = "backgroundcolor";
		public const string HIGHLIGHT_COLOR = "color"; //$NON-NLS-1$
		public const string HIGHLIGHT_THICKNESS = "thickness"; //$NON-NLS-1$
		public const string ALLOW_MULTIPLE = "allowMultiple"; //$NON-NLS-1$
		public const string USE_LAUNCH_BUTTON = "launch"; //$NON-NLS-1$
		public const string BUTTON_NAME = "buttonName"; //$NON-NLS-1$
		public const string TOOLTIP = "tooltip"; //$NON-NLS-1$
		public const string ICON = "icon"; //$NON-NLS-1$
		public const string HOTKEY = "hotkey"; //$NON-NLS-1$
		public const string SUPPRESS_AUTO = "suppressAuto"; //$NON-NLS-1$
		public const string MOVE_WITHIN_FORMAT = "moveWithinFormat"; //$NON-NLS-1$
		public const string MOVE_TO_FORMAT = "moveToFormat"; //$NON-NLS-1$
		public const string CREATE_FORMAT = "createFormat"; //$NON-NLS-1$
		public const string CHANGE_FORMAT = "changeFormat"; //$NON-NLS-1$
		public const string MOVE_KEY = "moveKey"; //$NON-NLS-1$
		public const string MOVING_STACKS_PICKUP_UNITS = "movingStacksPickupUnits"; //$NON-NLS-1$
		...
		public override void  setAttribute(string key, System.Object value_Renamed)
		{
			if (NAME.Equals(key))
			{
				setMapName((string) value_Renamed);
			}
			else if (MARK_MOVED.Equals(key))
			{
				markMovedOption = ((string) value_Renamed);
			}
			else if (MARK_UNMOVED_ICON.Equals(key))
			{
				markUnmovedIcon = ((string) value_Renamed);
				if (pieceMover != null)
				{
					pieceMover.setAttribute(key, value_Renamed);
				}
			}
			else if (MARK_UNMOVED_TEXT.Equals(key))
			{
				markUnmovedText = ((string) value_Renamed);
				if (pieceMover != null)
				{
					pieceMover.setAttribute(key, value_Renamed);
				}
			...
			{
				markUnmovedTooltip = ((string) value_Renamed);
			}
			else if ("edge".Equals(key))
			{
				// Backward-compatible //$NON-NLS-1$
				string s = (string) value_Renamed;
				int i = s.IndexOf(','); //$NON-NLS-1$
				if (i > 0)
				{
					edgeBuffer = new System.Drawing.Size(System.Int32.Parse(s.Substring(0, (i) - (0))), System.Int32.Parse(s.Substring(i + 1)));
				}
			}
			else if (EDGE_WIDTH.Equals(key))
			{
				...
				{
					value_Renamed = System.Int32.Parse((string) value_Renamed);
				}
				try
				{
					edgeBuffer = new System.Drawing.Size(((System.Int32) value_Renamed), edgeBuffer.Height);
				}
			...
			else if (EDGE_HEIGHT.Equals(key))
			{
				...
				try
				{
					edgeBuffer = new System.Drawing.Size(edgeBuffer.Width, ((System.Int32) value_Renamed));
				}
				catch (System.FormatException ex)
				{
					throw new IllegalBuildException(ex);
			...
			else if (BACKGROUND_COLOR.Equals(key))
			{
				if (value_Renamed is string)
				{
					value_Renamed = ColorConfigurer.stringToColor((string) value_Renamed);
				}
				bgColor = (System.Drawing.Color) value_Renamed;
			}
			else if (ALLOW_MULTIPLE.Equals(key))
			{
				if (value_Renamed is string)
				{
					...
					value_Renamed = System.Boolean.Parse((string) value_Renamed);
				}
				allowMultiple = ((System.Boolean) value_Renamed);
				if (picker != null)
				{
			...
			else if (HIGHLIGHT_COLOR.Equals(key))
			{
				...
				{
					((ColoredBorder) highlighter).Color = (System.Drawing.Color) value_Renamed;
				}
			}
			else if (HIGHLIGHT_THICKNESS.Equals(key))
			{
				...
				if (highlighter is ColoredBorder)
				{
					((ColoredBorder) highlighter).Thickness = ((System.Int32) value_Renamed);
				}
			}
			else if (USE_LAUNCH_BUTTON.Equals(key))
			{
				...
				useLaunchButtonEdit = ((System.Boolean) value_Renamed);
				launchButton.Visible = useLaunchButton;
			}
			...
			{
				moveWithinFormat = ((string) value_Renamed);
			}
			else if (MOVE_TO_FORMAT.Equals(key))
			{
				moveToFormat = ((string) value_Renamed);
			}
			else if (CREATE_FORMAT.Equals(key))
			{
				createFormat = ((string) value_Renamed);
			}
			else if (CHANGE_FORMAT.Equals(key))
			{
				changeFormat = ((string) value_Renamed);
			}
			else if (MOVE_KEY.Equals(key))
			{
				if (value_Renamed is string)
				{
					value_Renamed = NamedHotKeyConfigurer.decode((string) value_Renamed);
				}
				moveKey = (NamedKeyStroke) value_Renamed;
			}
			else if (TOOLTIP.Equals(key))
			{
				tooltip = ((string) value_Renamed);
				launchButton.setAttribute(key, value_Renamed);
			}
			else
			{
				launchButton.setAttribute(key, value_Renamed);
		...
		public override string getAttributeValueString(string key)
		{
			...
			{
				return System.Convert.ToString(edgeBuffer.Width); //$NON-NLS-1$
			}
			else if (EDGE_HEIGHT.Equals(key))
			{
				return System.Convert.ToString(edgeBuffer.Height); //$NON-NLS-1$
			}
			else if (BACKGROUND_COLOR.Equals(key))
			{
				//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
				return ColorConfigurer.colorToString(ref bgColor);
			}
			else if (ALLOW_MULTIPLE.Equals(key))
			{
				return System.Convert.ToString(picker.isAllowMultiple()); //$NON-NLS-1$
			}
			else if (HIGHLIGHT_COLOR.Equals(key))
			{
				if (highlighter is ColoredBorder)
				{
					System.Drawing.Color tempAux = ((ColoredBorder) highlighter).Color;
					//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
					return ColorConfigurer.colorToString(ref tempAux);
				}
				else
				{
					return null;
			...
			else if (HIGHLIGHT_THICKNESS.Equals(key))
			{
				if (highlighter is ColoredBorder)
				{
					return System.Convert.ToString(((ColoredBorder) highlighter).Thickness); //$NON-NLS-1$
				}
				else
				{
					return null;
			...
			{
				return System.Convert.ToString(useLaunchButtonEdit);
			}
			else if (MOVE_WITHIN_FORMAT.Equals(key))
			{
		...
		public override void  build(System.Xml.XmlElement e)
		{
			...
			{
				base.build(e);
				VassalSharp.build.module.map.BoardPicker generatedAux = BoardPicker;
				VassalSharp.build.module.map.StackMetrics generatedAux2 = StackMetrics;
			}
			else
			{
				VassalSharp.build.module.map.BoardPicker generatedAux3 = BoardPicker;
				VassalSharp.build.module.map.StackMetrics generatedAux4 = StackMetrics;
				addChild(new ForwardToKeyBuffer(this));
				addChild(new Scroller(this));
				addChild(new ForwardToChatter(this));
				addChild(new MenuDisplayer(this));
				addChild(new MapCenterer(this));
				addChild(new StackExpander(this));
				addChild(new PieceMover(this));
				addChild(new KeyBufferer(this));
				addChild(new ImageSaver(this));
				addChild(new CounterDetailViewer(this));
				setMapName("Main Map");
			}
			if (getComponentsOf(typeof(GlobalProperties)).isEmpty())
			{
				addChild(new GlobalProperties());
			}
			if (getComponentsOf(typeof(SelectionHighlighters)).isEmpty())
			{
				addChild(new SelectionHighlighters(this));
			}
			if (getComponentsOf(typeof(HighlightLastMoved)).isEmpty())
			{
				addChild(new HighlightLastMoved(this));
			}
			setup(false);
		}
		...
		/// <summary> Add a {@link Drawable} component to this map
		/// 
		/// </summary>
		/// <seealso cref="paint">
		/// </seealso>
		public virtual void  addDrawComponent(Drawable theComponent)
		{
			drawComponents.add(theComponent);
		}
		
		/// <summary> Remove a {@link Drawable} component from this map
		/// 
		/// </summary>
		/// <seealso cref="paint">
		/// </seealso>
		public virtual void  removeDrawComponent(Drawable theComponent)
		{
			drawComponents.remove(theComponent);
		}
		
		/// <summary> Expects to be added to a {@link GameModule}. Determines a unique id for
		...
		public override void  addTo(Buildable b)
		{
			...
			validator = new CompoundValidityChecker(new MandatoryComponent(this, typeof(BoardPicker)), new MandatoryComponent(this, typeof(StackMetrics))).append(idMgr);
			
			//UPGRADE_NOTE: Final was removed from the declaration of 'dgl '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			//UPGRADE_TODO: Interface 'java.awt.dnd.DragGestureListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1095'"
			DragGestureListener dgl = new AnonymousClassDragGestureListener(this);
			...
			theMap.MouseDown += new System.Windows.Forms.MouseEventHandler(dgl.dragGestureRecognized);
			...
			theMap.setDropTarget(PieceMover.DragHandler.makeDropTarget(theMap, (int) System.Windows.Forms.DragDropEffects.Move, this));
			g.getGameState().addGameComponent(this);
			System.Windows.Forms.ToolBarButton temp_ToolBarButton;
			temp_ToolBarButton = new System.Windows.Forms.ToolBarButton(launchButton.Text);
			temp_ToolBarButton.ToolTipText = SupportClass.ToolTipSupport.getToolTipText(launchButton);
			g.ToolBar.Buttons.Add(temp_ToolBarButton);
			if (launchButton.Image != null)
			{
				g.ToolBar.ImageList.Images.Add(launchButton.Image);
				temp_ToolBarButton.ImageIndex = g.ToolBar.ImageList.Images.Count - 1;
			}
			temp_ToolBarButton.Tag = launchButton;
			launchButton.Tag = temp_ToolBarButton;
			...
			if (shouldDockIntoMainWindow())
			{
				...
				IntConfigurer config = new IntConfigurer(MAIN_WINDOW_HEIGHT, null, - 1);
				Prefs.GlobalPrefs.addOption(null, config);
				//UPGRADE_NOTE: Final was removed from the declaration of 'splitter '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
				...
				mainWindowDock = splitter.splitBottom(splitter.getSplitAncestor(g.getControlPanel(), - 1), layeredPane, true);
				
				g.addKeyStrokeSource(new KeyStrokeSource(theMap, 0));
			}
			else
			{
				g.addKeyStrokeSource(new KeyStrokeSource(theMap, 2));
			}
			// Fix for bug 1630993: toolbar buttons not appearing
			//UPGRADE_ISSUE: Method 'java.awt.Component.addHierarchyListener' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaawtComponentaddHierarchyListener_javaawteventHierarchyListener'"
			toolBar.addHierarchyListener(new AnonymousClassHierarchyListener(this));
			
			PlayerRoster.addSideChangeListener(this);
			g.getPrefs().addOption(Resources.getString("Prefs.general_tab"), new IntConfigurer(PREFERRED_EDGE_DELAY, Resources.getString("Map.scroll_delay_preference"), PREFERRED_EDGE_SCROLL_DELAY));
			
			System.Boolean tempAux = false;
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			g.getPrefs().addOption(Resources.getString("Prefs.general_tab"), new BooleanConfigurer(MOVING_STACKS_PICKUP_UNITS, Resources.getString("Map.moving_stacks_preference"), ref tempAux));
		}
		...
		public override void  removeFrom(Buildable b)
		{
			...
			//UPGRADE_TODO: Method 'javax.swing.SwingUtilities.getWindowAncestor' was converted to 'System.Windows.Forms.Control.Parent' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaxswingSwingUtilitiesgetWindowAncestor_javaawtComponent'"
			System.Windows.Forms.Form w = (System.Windows.Forms.Form) theMap.Parent;
			if (w != null)
			{
				w.Dispose();
			}
			GameModule.getGameModule().ToolBar.remove(launchButton);
			idMgr.remove(this);
			if (picker != null)
			{
		...
		public virtual void  sideChanged(string oldSide, string newSide)
		{
			repaint();
		}
		
		/// <summary> Set the boards for this map. Each map may contain more than one
		/// {@link Board}.
		/// </summary>
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		public synchronized
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		void setBoards(Collection < Board > c)
		...
		public synchronized
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		void setBoards(Enumeration < Board > boardList)
		
		/// <returns> the {@link Board} on this map containing the argument point
		/// </returns>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public virtual Board findBoard(ref System.Drawing.Point p)
		{
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			for(Board b: boards)
			{
		...
		/// <summary> </summary>
		/// <returns> the {@link Zone} on this map containing the argument point
		/// </returns>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public virtual Zone findZone(ref System.Drawing.Point p)
		{
			//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
			Board b = findBoard(ref p);
			if (b != null)
			{
				MapGrid grid = b.getGrid();
				if (grid != null && grid is ZonedGrid)
				{
					System.Drawing.Rectangle r = b.bounds();
					p.Offset(- r.X, - r.Y); // Translate to Board co-ords
		...
		/// <summary> Search on all boards for a Zone with the given name</summary>
		/// <param name="Zone">name
		/// </param>
		/// <returns> Located zone
		/// </returns>
		public virtual Zone findZone(string name)
		{
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			for(Board b: boards)
			{
				//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
				for(ZonedGrid zg: b.getAllDescendantComponentsOf(ZonedGrid.
			}
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class))
	...
	/// <summary> Search on all boards for a Region with the given name</summary>
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(RegionGrid rg: b.getAllDescendantComponentsOf(RegionGrid.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Return the board with the given name
	/// 
	/// </summary>
	/// <param name="name">
	/// </param>
	/// <returns> null if no such board found
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the size of the map in pixels at 100% zoom,
	...
	/// <returns> true if the given point may not be a legal location. I.e., if this grid will attempt to snap it to the
	...
	/// <returns> the nearest allowable point according to the {@link VassalSharp.build.module.map.boardPicker.board.MapGrid} on
	/// the {@link Board} at this point
	/// 
	/// </returns>
	/// <seealso cref="Board.snapTo">
	/// </seealso>
	/// <seealso cref="VassalSharp.build.module.map.boardPicker.board.MapGrid.snapTo">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> The buffer of empty space around the boards in the Map window,
	...
	/// <summary> Translate a point from component coordinates (i.e., x,y position on
	/// the JPanel) to map coordinates (i.e., accounting for zoom factor).
	/// 
	/// </summary>
	/// <seealso cref="componentCoordinates">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Translate a point from map coordinates to component coordinates
	/// 
	/// </summary>
	/// <seealso cref="mapCoordinates">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> a String name for the given location on the map
	/// 
	/// </returns>
	/// <seealso cref="Board.locationName">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> a String name for the given location on the map. Include Map name if requested. Report deck name instead of
	...
	/// <summary> Is this map visible to all players</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Return the name of the deck whose bounding box contains p</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(DrawPile d: getComponentsOf(DrawPile.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Return the name of the deck whose position is p
	/// 
	/// </summary>
	/// <param name="p">
	/// </param>
	...
	/// <summary> Because MouseEvents are received in component coordinates, it is inconvenient for MouseListeners on the map to have
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void addLocalMouseListener(MouseListener l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void addLocalMouseListenerFirst(MouseListener l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void removeLocalMouseListener(MouseListener l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> MouseListeners on a map may be pushed and popped onto a stack.
	/// Only the top listener on the stack receives mouse events.
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void pushMouseListener(MouseListener l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> MouseListeners on a map may be pushed and popped onto a stack. Only the top listener on the stack receives mouse
	/// events
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	...
	/// <summary> Mouse events are first translated into map coordinates. Then the event is forwarded to the top MouseListener in the
	/// stack, if any, otherwise forwarded to all LocalMouseListeners
	/// 
	/// </summary>
	/// <seealso cref="pushMouseListener">
	/// </seealso>
	/// <seealso cref="popMouseListener">
	/// </seealso>
	/// <seealso cref="addLocalMouseListener">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Mouse events are first translated into map coordinates.
	...
	/// <summary> Save all current Key Listeners and remove them from the
	...
	/// <summary> Restore the previously disabled KeyListeners</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void disableKeyListeners()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(saveKeyListeners != null) return;
	...
	/// <summary> This listener will be notified when a drag event is initiated, assuming that no MouseListeners are on the stack.
	/// 
	/// </summary>
	/// <seealso cref="pushMouseListener">
	/// </seealso>
	/// <param name="dragGestureListener">
	/// </param>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setDragGestureListener(DragGestureListener dragGestureListener)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	*/
	...
	/// <summary> Mouse motion events are not forwarded to LocalMouseListeners or to listeners on the stack</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Mouse motion events are not forwarded to LocalMouseListeners or to
	...
	*/
	...
	/// <summary>The width of the hot zone for triggering autoscrolling. </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public static final int SCROLL_ZONE = 30;
	
	/// <summary>The horizontal component of the autoscrolling vector, -1, 0, or 1. </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected int sx;
	/// <summary>The vertical component of the autoscrolling vector, -1, 0, or 1. </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	protected int sy;
	...
	/// <summary> Begin autoscrolling the map if the given point is within the given
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void scrollAtEdge(Point evtPt, int dist)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary>The animator which controls autoscrolling. </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Painting the map is done in three steps: 1) draw each of the {@link Board}s on the map. 2) draw all of the
	/// counters on the map. 3) draw all of the {@link Drawable} components on the map
	/// 
	/// </summary>
	/// <seealso cref="addDrawComponent">
	/// </seealso>
	/// <seealso cref="setBoards">
	/// </seealso>
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void paintRegion(Graphics g, Rectangle visibleRect)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void paintRegion(Graphics g, Rectangle visibleRect, Component c)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawBoardsInRegion(Graphics g, 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawBoardsInRegion(Graphics g, Rectangle visibleRect)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawPiecesInRegion(Graphics g, 
	Rectangle visibleRect, 
	Component c)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawPiecesInRegion(Graphics g, Rectangle visibleRect)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawPieces(Graphics g, int xOffset, int yOffset)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(!hideCounters)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawDrawable(Graphics g, boolean aboveCounters)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Paint the map at the given offset, i.e. such that (xOffset, yOffset) is in the upper left corner</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void paint(Graphics g, int xOffset, int yOffset)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void addHighlighter(Highlighter h)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		highlighters.add(h);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void removeHighlighter(Highlighter h)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <returns> a Collection of all {@link Board}s on the Map
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> an Enumeration of all {@link Board}s on the map
	/// </returns>
	...
	/// <summary> Returns the boundingBox of a GamePiece accounting for the offset of a piece within its parent stack. Return null if
	/// this piece is not on the map
	/// 
	/// </summary>
	/// <seealso cref="GamePiece.boundingBox">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	for(Iterator < Highlighter > i = getHighlighters();
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	i.hasNext();
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	)
	...
	/// <summary> Returns the selection bounding box of a GamePiece accounting for the offset of a piece within a stack
	/// 
	/// </summary>
	...
	/// <summary> Returns the position of a GamePiece accounting for the offset within a parent stack, if any</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> an array of all GamePieces on the map. This is a read-only copy.
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setPieceCollection(PieceCollection pieces)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		this.pieces = pieces;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void clearMapBorder(Graphics g)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Adjusts the bounds() rectangle to account for the Board's relative
	...
	/// <summary> Draw the boards of the map at the given point and zoom factor onto
	/// the given Graphics object
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void drawBoards(Graphics g, int xoffset, int yoffset, double zoom, Component obs)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(Board b: boards)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Repaint the given area, specified in map coordinates</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <param name="show">if true, enable drawing of GamePiece. If false, don't draw GamePiece when painting the map
	/// </param>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void setPieceOpacity(float pieceOpacity)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Return the auto-move key. It may be named, so just return
	/// the allocated KeyStroke.
	/// </summary>
	/// <returns> auto move keystroke
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the top-level window containing this map
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> When a game is started, create a top-level window, if none exists.
	...
	/// <summary> Use the provided {@link PieceFinder} instance to locate a visible piece at the given location</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Use the provided {@link PieceFinder} instance to locate any piece at the given location, regardless of whether it
	/// is visible or not
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Place a piece at the destination point. If necessary, remove the piece from its parent Stack or Map
	/// 
	/// </summary>
	/// <returns> a {@link Command} that reproduces this action
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Apply the provided {@link PieceVisitorDispatcher} to all pieces on this map. Returns the first non-null
	...
	/// <summary> Move a piece to the destination point. If a piece is at the point (i.e. has a location exactly equal to it), merge
	/// with the piece by forwarding to {@link StackMetrics#merge}. Otherwise, place by forwarding to placeAt()
	/// 
	/// </summary>
	/// <seealso cref="StackMetrics.merge">
	/// </seealso>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Adds a GamePiece to this map. Removes the piece from its parent Stack and from its current map, if different from
	/// this map
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	...
	/// <summary> Reorder the argument GamePiece to the new index. When painting the map, pieces are drawn in order of index
	/// 
	/// </summary>
	...
	/// <summary> Returns the index of a piece. When painting the map, pieces are drawn in order of index Return -1 if the piece is
	/// not on this map
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Removes a piece from the map</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Center the map at given map coordinates within its JScrollPane container</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void centerAt(Point p)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		centerAt(p, 0, 0);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Center the map at the given map coordinates, if the point is not
	/// already within (dx,dy) of the center.
	/// </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void centerAt(Point p, int dx, int dy)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		if(scroll != null)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary>Ensure that the given region (in map coordinates) is visible </summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Scrolls the map in the containing JScrollPane.
	/// 
	/// </summary>
	/// <param name="dx">number of pixels to scroll horizontally
	/// </param>
	/// <param name="dy">number of pixels to scroll vertically
	/// </param>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
			return new IconConfigurer(key, name, "/images/map.gif"); //$NON-NLS-1$
		}
	}
	public class UnmovedIconConfig : ConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
	...
	public class MoveWithinFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
	...
	public class MoveToFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
	...
	public class CreateFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
	...
	public class ChangeFormatConfig : TranslatableConfigurerFactory
	{
		public virtual Configurer getConfigurer(AutoConfigurable c, string key, string name)
		{
			return new PlayerIdFormattedStringConfigurer(key, name, new string[]{MESSAGE, ReportState.COMMAND_NAME, ReportState.OLD_UNIT_NAME, ReportState.NEW_UNIT_NAME, ReportState.MAP_NAME, ReportState.LOCATION_NAME});
		}
	}
	...
	/// <summary> Each Map must have a unique String id</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Utility method to return a {@link List} of all map components in the
	/// module.
	/// 
	/// </summary>
	/// <returns> the list of <code>Map</code>s
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	final List < Map > l = g.getComponentsOf(Map.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class);
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	for(ChartWindow cw: g.getComponentsOf(ChartWindow.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
		for(MapWidget mw: cw.getAllDescendantComponentsOf(MapWidget.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class))
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Utility method to return a list of all map components in the module
	/// 
	/// </summary>
	/// <returns> Iterator over all maps
	/// </returns>
	...
	/// <summary> Find a contained Global Variable by name</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Each Map must have a unique String id
	/// 
	/// </summary>
	/// <returns> the id for this map
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public String getId()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Make a best gues for a unique identifier for the target. Use
	/// {@link VassalSharp.tools.UniqueIdManager.Identifyable#getConfigureName} if non-null, otherwise use
	/// {@link VassalSharp.tools.UniqueIdManager.Identifyable#getId}
	/// 
	/// </summary>
	/// <returns>
	/// </returns>
	...
	/// <returns> the Swing component representing the map 
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <returns> the JLayeredPane holding map insets 
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> The Layout responsible for arranging insets which overlay the Map
	/// InsetLayout currently is responsible for keeping the {@link GlobalMap}
	/// in the upper-left corner of the {@link Map.View}.
	/// </summary>
	//UPGRADE_ISSUE: Class 'javax.swing.OverlayLayout' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingOverlayLayout'"
	[Serializable]
	public class InsetLayout:OverlayLayout
	{
		...
		//UPGRADE_TODO: Class 'javax.swing.JScrollPane' was converted to 'System.Windows.Forms.ScrollableControl' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073'"
		private System.Windows.Forms.ScrollableControl base_Renamed;
		...
		//UPGRADE_TODO: Class 'javax.swing.JScrollPane' was converted to 'System.Windows.Forms.ScrollableControl' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073'"
		public InsetLayout(System.Windows.Forms.Control target, System.Windows.Forms.ScrollableControl base_Renamed):base(target)
		{
		...
		{
			//UPGRADE_ISSUE: Method 'javax.swing.OverlayLayout.layoutContainer' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javaxswingOverlayLayout'"
			...
			base_Renamed.getLayout().layoutContainer(base_Renamed);
			...
			System.Drawing.Size viewSize = base_Renamed.getViewport().Size;
			//UPGRADE_NOTE: Final was removed from the declaration of 'insets '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
			System.Int32[] insets = SupportClass.GetInsets(base_Renamed);
			viewSize.Width += insets[1];
			viewSize.Height += insets[0];
			...
			int n = (int) target.Controls.Count;
			for (int i = 0; i < n; ++i)
			{
				System.Windows.Forms.Control c = target.Controls[i];
				//UPGRADE_TODO: Method 'java.awt.Component.isVisible' was converted to 'System.Windows.Forms.Control.Visible' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtComponentisVisible'"
				if (c != base_Renamed && c.Visible)
				{
					...
					System.Drawing.Rectangle b = c.Bounds;
					b.Width = System.Math.Min(b.Width, viewSize.Width);
					b.Height = System.Math.Min(b.Height, viewSize.Height);
					...
					//UPGRADE_NOTE: Since the declaration of the following entity is not virtual in .NET the modifier new was added. References to it may have been changed to InvokeMethodAsVirtual, GetPropertyAsVirtual or SetPropertyAsVirtual. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1195'"
					SupportClass.SetPropertyAsVirtual(c, "Bounds", b);
				}
			}
		}
	}
	
	/// <summary> Implements default logic for merging pieces at a given location within
	...
	/// </summary>
	public class Merger : DeckVisitor
	{
		...
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public Merger(Map map, ref System.Drawing.Point pt, GamePiece p)
		{
			this.map = map;
			this.pt = pt;
			this.p = p;
		...
		{
			if (s.Position.Equals(pt) && map.StackMetrics.StackingEnabled && !true.Equals(p.getProperty(VassalSharp.counters.Properties_Fields.NO_STACK)) && s.topPiece() != null && map.getPieceCollection().canMerge(s, p))
			{
		...
		{
			if (piece.Position.Equals(pt) && map.StackMetrics.StackingEnabled && !true.Equals(p.getProperty(VassalSharp.counters.Properties_Fields.NO_STACK)) && !true.Equals(piece.getProperty(VassalSharp.counters.Properties_Fields.INVISIBLE_TO_ME)) && !true.Equals(piece.getProperty(VassalSharp.counters.Properties_Fields.NO_STACK)) && map.getPieceCollection().canMerge(piece, p))
			{
	...
	/// <summary> The component that represents the map itself</summary>
	public class View:JPanel
	{
		virtual public Dimension PreferredSize
		{
			get
			{
				return map.PreferredSize;
			}
