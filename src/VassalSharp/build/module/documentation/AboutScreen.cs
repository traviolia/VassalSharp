...
namespace VassalSharp.build.module.documentation
{
	...
	/// </summary>
	public class AboutScreen:AbstractConfigurable
	{
		...
		{
			public AnonymousClassAbstractAction(AboutScreen enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AboutScreen enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private AboutScreen enclosingInstance;
			public AboutScreen Enclosing_Instance
			{
				get
				{
		...
		private void  InitBlock()
		{
			...
			w = new AboutWindow(g.getFrame(), op.getImage(), sb.toString());
		}
		protected internal ImageOp op;
		protected internal System.Drawing.Image image;
		protected internal System.String title;
		...
		public AboutScreen(ImageOp op):this()
		{
			if (op == null)
		...
		Deprecated
		public AboutScreen(System.Drawing.Image i):this()
		{
		...
		public virtual void  launch()
		{
			...
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			for(ModuleExtension ext: g.getComponentsOf(ModuleExtension.
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class))
	...
	/// <summary> The attributes of an AboutScreen are:
	/// 
	...
	/// <summary> Expects to be added to a {@link Documentation}.  Adds an entry
