...
{
#if NEVER_DEFINED
	/// <summary> A Window that displays HTML content, with navigation</summary>
	public class HelpWindow : System.Windows.Forms.Form
	{
		...
		public HelpWindow(System.String title, System.Uri contents):base()
		{
			this.Text = title;
			Closing += new System.ComponentModel.CancelEventHandler(this.HelpWindow_Closing_HIDE_ON_CLOSE);
		...
		private void  HelpWindow_Closing_HIDE_ON_CLOSE(System.Object sender, System.ComponentModel.CancelEventArgs  e)
		{
			e.Cancel = true;
