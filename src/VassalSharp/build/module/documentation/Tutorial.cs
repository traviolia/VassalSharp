...
namespace VassalSharp.build.module.documentation
{
	...
	/// <summary> Provides tutorial functionality by reading in a logfile</summary>
	public class Tutorial:AbstractConfigurable
	{
		...
		{
			private void  InitBlock(Tutorial enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private Tutorial enclosingInstance;
			public Tutorial Enclosing_Instance
			{
				get
				{
			...
			internal AnonymousClassAbstractAction(Tutorial enclosingInstance, System.String Param1):base(Param1)
			{
		...
		{
			welcomeMessage = Resources.getString("Tutorial.instructions");
			promptMessage = Resources.getString("Tutorial.load_tutorial");
		}
		...
		//UPGRADE_NOTE: The initialization of  'logger' was moved to static method 'VassalSharp.build.module.documentation.Tutorial'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private static readonly Logger logger;
		
		public const System.String FILE_NAME = "logfile"; //$NON-NLS-1$
		public const System.String NAME = "name"; //$NON-NLS-1$
		public const System.String LAUNCH_ON_STARTUP = "launchOnStartup"; //$NON-NLS-1$
		public const System.String PROMPT_MESSAGE = "promptMessage"; //$NON-NLS-1$
		public const System.String WELCOME_MESSAGE = "welcomeMessage"; //$NON-NLS-1$
		private System.String fileName;
		private SupportClass.ActionSupport launch_Renamed_Field;
		private bool launchOnFirstStartup;
		//UPGRADE_NOTE: The initialization of  'welcomeMessage' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private System.String welcomeMessage; //$NON-NLS-1$
		//UPGRADE_NOTE: The initialization of  'promptMessage' was moved to method 'InitBlock'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private System.String promptMessage; //$NON-NLS-1$
		protected internal BooleanConfigurer hasViewedTutorial;
		
		public Tutorial()
		{
			InitBlock();
			launch_Renamed_Field = new AnonymousClassAbstractAction(this, Resources.getString("Tutorial.tutorial"));
		}
		...
		protected internal virtual void  done()
		{
			...
			{
				logger.error("", e);
				System.String msg = Resources.getString("Tutorial.unable_to_launch", name); //$NON-NLS-1$
		...
		static Tutorial()
		{
			logger = LoggerFactory.getLogger(typeof(Tutorial));
		}
	}
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	.execute();
	...
	/// <summary> Get the Command representing this tutorial logfile.  Executing the command loads the tutorial</summary>
	/// <returns>
	/// </returns>
	...
	/// <summary> Mark this tutorial as having been viewed</summary>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void markAsViewed()
