...
namespace VassalSharp.configure
{
	...
	/// <summary> General-purpose "Save As" action</summary>
	[Serializable]
	public abstract class SaveAsAction:SupportClass.ActionSupport
	{
		...
		public SaveAsAction()
		{
			...
			System.Uri iconURL = new System.Uri(System.IO.Path.GetFullPath("/images/SaveAs16.gif"));
			if (iconURL != null)
			{
