...
namespace VassalSharp.script
{
	...
	/// 
	/// </summary>
	public class ActionScript:AbstractScript, UniqueIdManager.Identifyable, ValidityChecker
	{
		...
		internal class ScriptConfigurer:Configurer
		{
			...
			private void  InitBlock(ActionScript enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private ActionScript enclosingInstance;
			virtual public ActionScript Script
			{
				get
				{
					return script;
			...
			public ActionScript Enclosing_Instance
			{
				get
				{
					return enclosingInstance;
			...
			protected internal ActionScript script;
			...
			public ScriptConfigurer(ActionScript enclosingInstance, ActionScript s):base(null, s.getConfigureName())
			{
				InitBlock(enclosingInstance);
				script = s;
				setValue(script);
