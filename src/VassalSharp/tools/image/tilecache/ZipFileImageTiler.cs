...
namespace VassalSharp.tools.image.tilecache
{
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.ArrayUtils;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.concurrent.DaemonThreadFactory;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.image.FallbackImageTypeConverter;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.image.ImageIOImageLoader;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.image.ImageLoader;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.image.ImageTypeConverter;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.io.FileArchive;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.io.IOUtils;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.io.TemporaryFileFactory;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.io.ZipArchive;
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	import VassalSharp.tools.lang.Callback;
	...
	{
		public ZipFileImageTiler()
		{
			InitBlock();
		}
		private class AnonymousClassUncaughtExceptionHandler : Thread.UncaughtExceptionHandler
		{
			...
			{
				VassalSharp.tools.image.tilecache.ZipFileImageTiler.logger.error(thread.Name, thrown);
			}
		}
		...
		internal class AnonymousClassTemporaryFileFactory : TemporaryFileFactory
		{
			public AnonymousClassTemporaryFileFactory(ZipFileImageTiler enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(ZipFileImageTiler enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private ZipFileImageTiler enclosingInstance;
			public ZipFileImageTiler Enclosing_Instance
			{
				get
				{
		...
		private void  InitBlock()
		{
			...
			if (portProp != null)
			{
				...
				int port = System.Int32.Parse(portProp);
			...
			{
				dout = new DataOutputStream(System.Console.Error);
			}
			...
			DataOutputStream out_Renamed = dout;
		...
		//UPGRADE_NOTE: The initialization of  'logger' was moved to static method 'VassalSharp.tools.image.tilecache.ZipFileImageTiler'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		...
		public static void  Main(System.String[] args)
		{
			try
			{
				...
				Thread.setDefaultUncaughtExceptionHandler(new AnonymousClassUncaughtExceptionHandler());
				
				// Parse the arguments
				//UPGRADE_NOTE: Final was removed from the declaration of 'zpath '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
				System.String zpath = args[0];
				...
				try
				{
					stdin = new BufferedReader(new InputStreamReader(System.Console.In));
					System.String s;
				...
				//UPGRADE_NOTE: Final was removed from the declaration of 'ipaths '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
				System.String[] ipaths = pl.toArray(new System.String[pl.size()]);
				...
				new DaemonThreadFactory(ZipFileImageTiler.
			}
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class.getSimpleName())
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'slicer '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		internal TileSlicer slicer = new TileSlicerImpl();
		...
		internal FileArchiveImageTiler tiler = new FileArchiveImageTiler();
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'portProp '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		//UPGRADE_ISSUE: Method 'java.lang.System.getProperty' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javalangSystem'"
		internal System.String portProp = System_Renamed.getProperty("VassalSharp.port");
		
		internal Socket sock = null;
		internal DataOutputStream dout = null;
		
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		try
		public virtual void  receive(System.String ipath)
		{
			out_Renamed.writeByte(STARTING_IMAGE);
			out_Renamed.writeUTF(ipath);
			out_Renamed.flush();
		}
		static ZipFileImageTiler()
		{
			logger = LoggerFactory.getLogger(typeof(ZipFileImageTiler));
		}
	}
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void receive(Void obj) throws IOException
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
