...
////UPGRADE_TODO: The type 'java.util.concurrent.atomic.AtomicLong' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
//using AtomicLong = java.util.concurrent.atomic.AtomicLong;

using DefaultMultiEventListenerSupport = VassalSharp.tools.concurrent.listener.DefaultMultiEventListenerSupport;
...
//UPGRADE_TODO: The type 'com.google.common.util.concurrent.ValueFuture' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using ValueFuture = com.google.common.util.concurrent.ValueFuture;
...
namespace VassalSharp.tools.ipc
{
	...
	{
		protected internal long next_id = 0L;

		protected IDictionary<long, Task<IPCMessage>> waiting = new ConcurrentDictionary<long, Task<IPCMessage>>();

		protected BlockingCollection<IPCMessage> outqueue = new BlockingCollection<IPCMessage>();
		...
		public IPCMessenger(System.IO.Stream in_Renamed, System.IO.Stream out_Renamed, MultiEventListenerSupport lsup)
		{
			if (in_Renamed == null)
				throw new System.ArgumentException("in == null");
			if (out_Renamed == null)
				throw new System.ArgumentException("out == null");
			if (lsup == null)
			...
			this.out_Renamed = new System.IO.BinaryWriter(out_Renamed);
		...
		public IPCMessenger(System.Net.Sockets.TcpClient sock) : this(sock.GetStream(), sock.GetStream())
		{
		}
		
		public IPCMessenger(System.IO.Stream in_Renamed, System.IO.Stream out_Renamed)
		{
			if (in_Renamed == null)
				throw new System.ArgumentException("in == null");
			if (out_Renamed == null)
			...
			lsup.addEventListener(IPCMessage.
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		class, new EventListener < IPCMessage >()
		public virtual void  receive(System.Object src, IPCMessage msg)
		{
			if (msg.Reply)
			{
				//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
				...
				if (f == null)
				{
					...
					throw new System.SystemException(msg.ToString());
				}
				f.set_Renamed(msg);
			}
		}
	...
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	lsup.addEventListener(Halt.
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	class, new EventListener < Halt >()
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void receive(Object src, Halt halt)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	try
	...
	public < T >
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void addEventListener(Class < T > c, EventListener < ? super T > l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public < T >
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void removeEventListener(Class < T > c, EventListener < ? super T > l)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
