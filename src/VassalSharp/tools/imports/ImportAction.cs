...
using EditModuleAction = VassalSharp.launch.EditModuleAction;
using ModuleEditorWindow = VassalSharp.launch.ModuleEditorWindow;
...
using FileFilter = VassalSharp.tools.filechooser.FileFilter;
using ADC2Module = VassalSharp.tools.imports.adc2.ADC2Module;
using ADC2Utils = VassalSharp.tools.imports.adc2.ADC2Utils;
using MapBoard = VassalSharp.tools.imports.adc2.MapBoard;
using SymbolSet = VassalSharp.tools.imports.adc2.SymbolSet;
namespace VassalSharp.tools.imports
{
	
	/// <summary> Action for importing foreign modules into VassalSharp.
	/// 
	/// </summary>
	...
	*/
	...
	[Serializable]
	public sealed class ImportAction:EditModuleAction
	{
		...
		public ImportAction(System.Windows.Forms.Control comp):base(comp)
		{
			InitBlock();
		...
		*/
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'EXTENSIONS '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		//UPGRADE_NOTE: The initialization of  'EXTENSIONS' was moved to static method 'VassalSharp.tools.imports.ImportAction'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private static readonly System.String[] EXTENSIONS;
		...
		//UPGRADE_NOTE: The initialization of  'DESCRIPTIONS' was moved to static method 'VassalSharp.tools.imports.ImportAction'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
		private static readonly System.String[] DESCRIPTIONS;
		...
		*/
		...
		static ImportAction()
		{
			EXTENSIONS = new System.String[]{ADC2Utils.MODULE_EXTENSION, ADC2Utils.MAP_EXTENSION, ADC2Utils.SET_EXTENSION};
			DESCRIPTIONS = new System.String[]{ADC2Utils.MODULE_DESCRIPTION, ADC2Utils.MAP_DESCRIPTION, ADC2Utils.SET_DESCRIPTION};
		}
	}
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void performAction(ActionEvent e) throws IOException
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void loadModule(File f) throws IOException
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
	...
	/// <summary> Find case-insensitive, cross-platform match for a given Windows file. Will
	...
	/// <summary> Find case-insensitive, cross-platform match for a given Windows file. If unable
	...
	/// 
	/// </summary>
	/// <param name="f">   File to match with a Windows-specific file-name format.
	/// </param>
	/// <param name="base">Another file whose directory to search for a match if unable to find otherwise.
	/// </param>
	/// <returns>     Local match
	/// </returns>
	...
	/// <param name="f">     File to match with a Windows-specific file-name format.
	/// </param>
	/// <param name="base">  Another file whose directory to search for a match.
	/// </param>
	/// <param name="filter"><code>FileFilter</code> to use when asking the user to locate the match.
	/// </param>
	/// <returns>       Local match
	/// </returns>
	...
	/// <summary> Find case-insensitive, cross-platform match for a given Windows file.
	...
	/// <summary> Find case-insensitive, cross-platform match for a given file specified for a Windows directory structure.
	/// 
	/// </summary>
	/// <param name="f">               File to search for formatted for Windows. E.g., "C:Dir\File.txt". The method will first
	/// check to see if the file exists as formatted.  It will then search the path that this
	/// file is in if that exists.
	/// </param>
	/// <param name="base">            If unable to find the file, will look in the directory of <code>base</code> which
	...
	/// </param>
	/// <param name="queryIfNotFound"> If the file still cannot be found, after searching <code>f</code> and <code>base</code>,
	/// should we ask the user to find it for us.
	/// </param>
	/// <param name="filter">          The <code>FileFilter</code> that the file dialog can use to locate the file. If this is <code>null</code>,
	/// then no filter is used.
	/// </param>
	/// <returns>                 If it exists, the file itself, otherwise null.
	/// </returns>
	/*
