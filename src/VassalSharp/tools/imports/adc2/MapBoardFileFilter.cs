...
namespace VassalSharp.tools.imports.adc2
{
	...
	/// <summary> A {@link FileFilter} for ADC2 map boards. Used by file choosers to filter
	...
	/// <since> 3.1.0
	/// </since>
	public class MapBoardFileFilter:ExtensionFileFilter
	{
		...
		public static readonly System.String[] types = new System.String[]{".map"};
		
		public MapBoardFileFilter():base("ADC2 Map Boards", types)
		{
		}
	}
}