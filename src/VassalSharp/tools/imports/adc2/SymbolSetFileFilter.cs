...
namespace VassalSharp.tools.imports.adc2
{
	...
	/// <summary> A {@link FileFilter} for ADC2 symbol sets. Used by file choosers to filter
	...
	/// <since> 3.1.0
	/// </since>
	public class SymbolSetFileFilter:ExtensionFileFilter
	{
		...
		public static readonly System.String[] types = new System.String[]{".set"};
		
		public SymbolSetFileFilter():base("ADC2 Symbol Sets", types)
		{
		}
	}
}