...
namespace VassalSharp.tools.menu
{
	...
	/// <since> 3.1.0
	/// </since>
	public class CheckBoxMenuItemProxy:AbstractProxy
	{
		...
		public CheckBoxMenuItemProxy():this(null, false)
		{
		}
		
		public CheckBoxMenuItemProxy(SupportClass.ActionSupport action):this(action, false)
		{
		}
		
		public CheckBoxMenuItemProxy(SupportClass.ActionSupport action, bool state)
		{
			this.action = action;
			this.state = state;
		}
		public virtual void  apply(System.Windows.Forms.MenuItem item)
		{
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void apply(JCheckBoxMenuItem item)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
