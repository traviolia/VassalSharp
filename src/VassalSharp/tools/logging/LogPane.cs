...
using Tailer = VassalSharp.tools.io.Tailer;
namespace VassalSharp.tools.logging
{
	
	[Serializable]
	public class LogPane:System.Windows.Forms.TextBox
	{
		private const long serialVersionUID = 1L;
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'tailer '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		protected internal Tailer tailer;
		
		public LogPane(System.IO.FileInfo file)
		{
			this.Multiline = true;
			this.WordWrap = false;
			...
			Font = new System.Drawing.Font("Monospaced", (int) Font.Size, System.Drawing.FontStyle.Regular);
