...
*/
using System;
//UPGRADE_TODO: The type 'java.util.concurrent.AbstractExecutorService' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
...
//UPGRADE_TODO: The type 'java.util.concurrent.RejectedExecutionException' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
...
//UPGRADE_TODO: The type 'java.util.concurrent.atomic.AtomicBoolean' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using AtomicBoolean = java.util.concurrent.atomic.AtomicBoolean;
//UPGRADE_TODO: The type 'java.util.concurrent.locks.ReentrantLock' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using ReentrantLock = java.util.concurrent.locks.ReentrantLock;
//UPGRADE_TODO: The type 'VassalSharp.tools.concurrent.RunnableFuture' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
using RunnableFuture = VassalSharp.tools.concurrent.RunnableFuture;
namespace VassalSharp.tools.swing
{
	...
	/// </seealso>
	public class EDTExecutorService:AbstractExecutorService
	{
		...
		private void  InitBlock()
		{
			...
			new EDTRunnableFuture < T >()
			{
			}
		}
		/// <summary>{@inheritDoc} </summary>
		virtual public bool Shutdown
		{
			get
			{
				return shutdown_Renamed_Field.get_Renamed();
			}
			
		}
		/// <summary>{@inheritDoc} </summary>
		virtual public bool Terminated
		{
			get
			{
				return shutdown_Renamed_Field.get_Renamed() && poison_pill.isDone();
			}
			
		}
		//UPGRADE_NOTE: Final was removed from the declaration of 'shutdown '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		private AtomicBoolean shutdown_Renamed_Field = new AtomicBoolean(false);
		...
		private ReentrantLock lock_Renamed = new ReentrantLock();
		
		/// <summary>{@inheritDoc} </summary>
		public virtual bool awaitTermination(long timeout, TimeUnit unit)
		{
			// Wait for the poison pill to finish.
			lock_Renamed.lock_Renamed();
			try
			{
				if (Terminated)
					return true;
				poison_pill.get_Renamed(timeout, unit);
				return true;
			}
		...
		public virtual void  shutdown()
		{
			...
			try
			{
				if (shutdown_Renamed_Field.get_Renamed())
					return ;
				
				submit(poison_pill);
				shutdown_Renamed_Field.set_Renamed(true);
			}
			finally
			{
				lock_Renamed.unlock();
		...
		protected internal virtual void  runOnEDT()
		{
			result = cable.call();
		}
	}
	...
	/// <summary> Submits a {@code EDTRunnableFuture} task for execution and returns it.
	/// 
	/// </summary>
	/// <param name="task">the task to submit
	/// </param>
	/// <returns> the task which was submitted
	/// </returns>
	/// <throws>  RejectedExecutionException if the task cannot be scheduled for </throws>
	/// <summary>   execution
	/// </summary>
	/// <throws>  NullPointerException if the task is {@code null} </throws>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
