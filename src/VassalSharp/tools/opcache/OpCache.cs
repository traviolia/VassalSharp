...
using ConcurrentSoftHashMap = VassalSharp.tools.concurrent.ConcurrentSoftHashMap;
namespace VassalSharp.tools.opcache
{
	
	/// <summary> A memory-sensitive cache for {@link Op}s and their results.
	/// 
	/// </summary>
	/// <since> 3.1.0
	/// </since>
	...
	public class OpCache
	{
		...
		/// <summary> A cache key for <code>OpCache</code>.</summary>
		public class Key
		{
			public Key()
			{
			...
			/// <summary> Creates a new key for the given <code>Op</code> and version.
			/// 
			/// </summary>
			/// <param name="op">the <code>Op</code> for which this is a key
			/// </param>
			/// <param name="version">the current version of this key
			/// </param>
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			...
			{
				return this.GetType().FullName + "[op=" + op + ",version=" + version + "]";
			}
		}
		...
		/// <summary> A request for execution of an {@link Op} which will be completed
		...
		private sealed class Result
		{
			...
			//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
			< V > implements Future < V >
			private const long serialVersionUID = 1L;
			
			private V value_Renamed = null;
			...
			public void  set_Renamed(V value_Renamed)
			{
			...
			public V get_Renamed(long timeout, TimeUnit unit)
			{
		...
		/// <summary> The {@link Future} which is cached on failure of an {@link Op}.</summary>
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		public virtual System.Void get_Renamed()
		{
			throw new ExecutionException(new OpFailedException());
		}
		
		public virtual System.Void get_Renamed(long timeout, TimeUnit unit)
		{
			throw new ExecutionException(new OpFailedException());
		}
	}
	...
	/// <summary> A request for execution of an {@link Op}, to be queued.</summary>
	private class Request
	{
		...
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		Override
		protected internal virtual V doInBackground()
		{
			return key.op.eval();
		}
		//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		protected internal virtual void  done()
		{
			try
			{
				...
				V val = get_Renamed();
				if (obs != null)
					obs.succeeded(key.op, val);
			}
			catch (CancellationException e)
			{
				cache.remove(key, this);
				if (obs != null)
					obs.cancelled(key.op, e);
			}
			catch (System.Threading.ThreadInterruptedException e)
			{
				cache.remove(key, this);
				if (obs != null)
					obs.interrupted(key.op, e);
			}
	...
	/// <summary> Gets a value from the cache.
	/// 
	/// </summary>
	/// <param name="key">the <code>Key</code> for which to retrieve a value
	/// </param>
	...
	/// <summary> Gets a value from the cache, possibly asynchronously.
	/// 
	/// </summary>
	/// <param name="key">the <code>Key</code> for which to retrieve a value
	/// </param>
	/// <param name="obs">the <code>OpObserver</code> to notify when the value is
	/// available
	/// </param>
	/// <returns> the value associated with <code>key</code>
	/// 
	/// </returns>
	/// <throws>  CancellationException if the request is cancelled </throws>
	/// <throws>  InterruptedException if the request is interrupted </throws>
	/// <throws>  ExecutionException if the request fails </throws>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Gets a {@link Future} from the cache. If <code>obs == null</code>, then
	/// the {@link Op} associated with <code>key</code> will be executed
	/// synchronously, and asynchronously otherwise.
	/// 
	/// </summary>
	/// <param name="key">the <code>Key</code> for which to retrieve a
	/// <code>Future</code>
	/// </param>
	/// <param name="obs">the <code>OpObserver</code> to notify when the value is
	/// available
	/// </param>
	/// <returns> the <code>Future</code> associated with <code>key</code>
	/// 
	/// </returns>
	/// <throws>  ExecutionException if the request is synchronous and fails </throws>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	private class Ex:ThreadPoolExecutor
	{
		public Ex()
		{
			InitBlock();
	...
	/// <summary> Gets a value from the cache, if it is already calculated.
	/// 
	/// </summary>
	/// <param name="key">the <code>Key</code> for which to retrieve a value
	/// </param>
	/// <returns> the value associated with <code>key</code>, or <code>null</code>
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	SuppressWarnings(unchecked)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
