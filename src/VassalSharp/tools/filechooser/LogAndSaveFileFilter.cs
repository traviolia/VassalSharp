...
namespace VassalSharp.tools.filechooser
{
	...
	/// <summary> A {@link FileFilter} for VASSAL logs and saved games. Used by file
	...
	/// <since> 3.1.0
	/// </since>
	public class LogAndSaveFileFilter:ExtensionFileFilter
	{
		...
		public static readonly System.String[] types = new System.String[]{".vlog", ".vsav"};
		
		public LogAndSaveFileFilter():base("VASSAL Logs and Saved Games", types)
		{
		}
	}
}