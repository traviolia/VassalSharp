...
namespace VassalSharp.tools.filechooser
{
	...
	/// <summary> A FileFilter for AIFF, AU, and WAV files. Used by file choosers to
	/// filter out files which aren't audio files.
	/// 
	/// </summary>
	/// <author>  Joel Uckelman
	/// </author>
	public class AudioFileFilter:ExtensionFileFilter
	{
		...
		public static readonly System.String[] types = new System.String[]{".aiff", ".au", ".wav"};
		
		public AudioFileFilter():base("Audio files", types)
		{
		}
	}
}