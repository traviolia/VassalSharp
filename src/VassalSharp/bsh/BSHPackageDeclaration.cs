...
namespace bsh
{
	...
	[Serializable]
	public class BSHPackageDeclaration:SimpleNode
	{
		
		public BSHPackageDeclaration(int id):base(id)
		{
		}
		...
		public override System.Object eval(CallStack callstack, Interpreter interpreter)
		{
			...
			namespace_Renamed.Package = name.text;
			// import the package we're in by default...
			namespace_Renamed.importPackage(name.text);
