...
namespace bsh
{
	...
	[Serializable]
	class BSHThrowStatement:SimpleNode
	{
		internal BSHThrowStatement(int id):base(id)
		{
		}
		
		public override System.Object eval(CallStack callstack, Interpreter interpreter)
		{
			System.Object obj = ((SimpleNode) jjtGetChild(0)).eval(callstack, interpreter);
			...
			throw new TargetError((System.Exception) obj, this, callstack);
		}
	}
}