...
namespace bsh
{
	...
	/// <summary>UtilEvalError is an error corresponding to an EvalError but thrown by a 
	...
	/// </summary>
	/// <seealso cref="UtilTargetError">
	/// </seealso>
	[Serializable]
	public class UtilEvalError:System.Exception
	{
		protected internal UtilEvalError()
		{
		}
		
		public UtilEvalError(System.String s):base(s)
		{
		}
		
		/// <summary>Re-throw as an eval error, prefixing msg to the message and specifying
		/// the node.  If a node already exists the addNode is ignored.
		/// </summary>
		/// <seealso cref="setNode( bsh.SimpleNode )">
		/// <p>
		/// </seealso>
		/// <param name="msg">may be null for no additional message.
		/// </param>
		public virtual EvalError toEvalError(System.String msg, SimpleNode node, CallStack callstack)
		{
			...
			return new EvalError(msg + Message, node, callstack);
		}
		
		public virtual EvalError toEvalError(SimpleNode node, CallStack callstack)
		{
