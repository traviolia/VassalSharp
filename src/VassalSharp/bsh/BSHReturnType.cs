...
namespace bsh
{
	...
	[Serializable]
	class BSHReturnType:SimpleNode
	{
		virtual internal BSHType TypeNode
		{
			get
			{
		...
		internal BSHReturnType(int id):base(id)
		{
		}
		...
		public virtual System.Type evalReturnType(CallStack callstack, Interpreter interpreter)
		{
			if (isVoid)
			{
