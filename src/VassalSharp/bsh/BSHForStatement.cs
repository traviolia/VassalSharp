...
namespace bsh
{
	...
	/// <summary>Implementation of the for(;;) statement.</summary>
	[Serializable]
	class BSHForStatement:SimpleNode, ParserConstants
	{
		public bool hasForInit;
		...
		internal BSHForStatement(int id):base(id)
		{
		}
		...
		public override System.Object eval(CallStack callstack, Interpreter interpreter)
		{
			...
			*/
			...
			while (true)
			{
				if (hasExpression)
				{
					bool cond = BSHIfStatement.evaluateCondition(expression, callstack, interpreter);
