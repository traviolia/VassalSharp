...
namespace bsh.util
{
	...
	[Serializable]
	public class JRemoteApplet:System.Windows.Forms.UserControl
	{
		...
		{
			this.Load += new System.EventHandler(this.JRemoteApplet_StartEventHandler);
			this.Disposed += new System.EventHandler(this.JRemoteApplet_StopEventHandler);
		}
		...
		public void  init()
		{
			...
			catch (System.IO.IOException e)
			{
				...
				((System.Windows.Forms.ContainerControl) this).Controls.Add(temp_Control);
				return ;
			}
			
			System.Windows.Forms.Control console = new JConsole(in_Renamed, out_Renamed);
			//UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javalangString_javaawtComponent'"
		...
		private void  JRemoteApplet_StartEventHandler(System.Object sender, System.EventArgs e)
		{
			init();
			start();
		}
		private void  JRemoteApplet_StopEventHandler(System.Object sender, System.EventArgs e)
		{
			stop();
		}
