...
namespace bsh.util
{
	...
	/// <summary>Additional capabilities of an interactive console for BeanShell.
	...
	/// </summary>
	public interface GUIConsoleInterface:ConsoleInterface
	{
		...
		/// <summary>e.g. the wait cursor </summary>
		bool WaitFeedback
		{
			set;
		...
		void  print(System.Object o, ref System.Drawing.Color color);
	}
}