...
namespace bsh.util
{
	...
	/// <summary>The interface for name completion.</summary>
	public interface NameCompletion
	{
		/// <summary>Return an array containing a string element of the maximum 
		...
		/// </summary>
		System.String[] completeName(System.String part);
	}
}