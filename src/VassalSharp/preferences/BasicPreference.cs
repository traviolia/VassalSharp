...
namespace VassalSharp.preferences
{
	...
	/// <summary> Base class for a Module Preference. Module preferences are defined within
	...
	/// </summary>
	public abstract class BasicPreference:AbstractConfigurable
	{
		...
		override public System.String[] AttributeNames
		{
			get
			{
				return new System.String[]{"note", TAB, DESC, NAME, DEFAULT};
			}
		...
		override public System.String[] AttributeDescriptions
		{
			get
			{
				return new System.String[]{"", "Preference Tab Name:  ", "Preference Description:  ", "Global Variable Name:  ", "Default Value:  "};
			}
			
		}
		
		public const System.String NAME = "name";
		public const System.String TAB = "tab";
		public const System.String DESC = "desc";
		public const System.String DEFAULT = "default";
		
		protected internal System.String tabName = "";
		protected internal System.String variableName = "";
	...
	public class NoteConfig : ConfigurerFactory
	{
		...
		{
			private void  InitBlock(NoteConfig enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private NoteConfig enclosingInstance;
			...
			override public System.Windows.Forms.Control Controls
			{
				get
				{
					...
					temp_label.Text = "Note:  The Preferences window will only be updated after you save and reload the module.";
					return temp_label;
				}
				
			}
			public NoteConfig Enclosing_Instance
			{
				get
				{
			...
			internal AnonymousClassConfigurer(NoteConfig enclosingInstance, System.String Param1, System.String Param2):base(Param1, Param2)
			{
		...
		{
			return new AnonymousClassConfigurer(this, null, "note");
		}
	}
	...
	public
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	abstract Configurer getPreferenceConfigurer();
	...
	protected
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	void updateGlobalProperty(String newValue)
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	{ 
