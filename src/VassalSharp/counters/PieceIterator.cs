...
*/
using System;
using IterableEnumeration = VassalSharp.tools.IterableEnumeration;
namespace VassalSharp.counters
{
	
	/// <summary> An iterator for GamePieces.  Takes an optional PieceFilter to
	...
	public class PieceIterator
	{
		...
		{
			pi = i; //UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
		...
		public virtual bool hasNext()
		{
			...
			while (i.hasNext())
			{
				next_Renamed_Field = i.next();
				if (filter == null || filter.accept(next_Renamed_Field))
					return true;
			}
