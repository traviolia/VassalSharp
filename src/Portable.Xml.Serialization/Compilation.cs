...
namespace Portable.Xml.Serialization
{
    ...
    using System.Linq;
    using Portable.Xml.Serialization;
    ...
    internal class TempAssembly
    {
        ...
        {
            _assembly = GenerateAssembly(xmlMappings, types, defaultNamespace, XmlSerializerCompilerParameters.Create(location), null, _assemblies);
#if DEBUG
        ...
        internal static Assembly LoadGeneratedAssembly(Type type, string defaultNamespace, out XmlSerializerImplementation contract)
        {
            ...
            object[] attrs = type.GetCustomAttributes(typeof(Portable.Xml.Serialization.XmlSerializerAssemblyAttribute), false);
            if (attrs.Length == 0)
            {
            ...
            {
                Portable.Xml.Serialization.XmlSerializerAssemblyAttribute assemblyAttribute = (Portable.Xml.Serialization.XmlSerializerAssemblyAttribute)attrs[0];
...
#pragma warning restore 618
        ...
        internal static Assembly GenerateAssembly(XmlMapping[] xmlMappings, Type[] types, string defaultNamespace, XmlSerializerCompilerParameters parameters, Assembly assembly, Hashtable assemblies)
        {
            ...
            try
            {
                ...
                compiler.AddImport(typeof(Portable.Xml.Serialization.XmlSerializer).Assembly);
                ...
                return compiler.Compile(assembly, defaultNamespace, parameters);
            }
            finally
            {
                compiler.Close();
