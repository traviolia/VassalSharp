...
namespace Portable.Xml.Serialization
{
    ...
    internal class XmlSerializationCodeGen
    {
        ...
        internal string GenerateBaseSerializer(string baseSerializer, string readerClass, string writerClass, CodeIdentifiers classes)
        {
            ...
            _writer.Write(" : ");
            _writer.Write(typeof(Portable.Xml.Serialization.XmlSerializer).FullName);
            _writer.WriteLine(" {");
            _writer.Indent++;

            _writer.Write("protected override ");
            _writer.Write(typeof(Portable.Xml.Serialization.XmlSerializationReader).FullName);
            ...
            _writer.Write("protected override ");
            _writer.Write(typeof(Portable.Xml.Serialization.XmlSerializationWriter).FullName);
        ...
        internal void GenerateSerializerContract(string className, XmlMapping[] xmlMappings, Type[] types, string readerType, string[] readMethods, string writerType, string[] writerMethods, Hashtable serializers)
        {
            ...
            _writer.Write(typeof(Portable.Xml.Serialization.XmlSerializerImplementation).FullName);
            _writer.WriteLine(" {");
            _writer.Indent++;
