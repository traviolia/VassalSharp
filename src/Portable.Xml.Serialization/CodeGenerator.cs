...
namespace Portable.Xml.Serialization
{
    ...
    internal class CodeGenerator
    {
        ...
        internal static AssemblyBuilder CreateAssemblyBuilder(string name)
        {
            ...
            if (DiagnosticsSwitches.KeepTempFiles.Enabled)
                return AssemblyBuilder.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.RunAndSave, ConfigurationStrings.TempFilesLocation);
            else
